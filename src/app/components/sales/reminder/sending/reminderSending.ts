...
export class ReminderSending implements OnInit {
    ...
    public updateReminderList(reminders: CustomReminder[]) {
    ...
    public getSelected(): CustomReminder[] {
    ...
    public getSelectedEmail(): CustomReminder[] {
        const tables = this.tables.toArray();
        return tables[0] && tables[0].getSelectedRows() || [];
    }

    public getSelectedPrint(): CustomReminder[] {
        const tables = this.tables.toArray();
