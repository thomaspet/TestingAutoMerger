...
import { OTPExportWageTypeService } from '@app/components/salary/otp-export/shared/service/otp-export-wagetype.service';
...
export class OTPPeriodWagetypeModalComponent implements OnInit {
  ...
  constructor(
    ...
    private otpexportwagetypesService: OTPExportWageTypeService,
