...
import { ISupplementLine, SalaryTransactionSupplementListService } from '@app/components/salary/salary-transaction-supplement/shared/service/salary-transaction-supplement-list.service';
