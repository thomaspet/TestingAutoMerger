...
export class TravelComponent implements OnInit {
    ...
    private getTravels() {
        this.travelService
            ...
            // .map((travels) => [...travels, ...this.mockTravels()])
    ...
    private mockTravels(): any[] {
        return [
            {
                ID: 1,
                TravelIdentificator: '1',
                Name: 'Kjøretur1',
                SourceSystem: 'TravelText',
                Description: 'ut på tur aldri sur',
                Email: 'sondre_vik@hotmail.com',
                TravelLines: [
                    {
                        travelType: {
                            ID: 1,
                        ...
                        Amount: 47,
                        Rate: 3.5,
                        LineState: linestate.Received,
                        Description: 'Kjøring',
                        From: new Date(2018, 1, 1, 12, 0, 0),
                        To: new Date(2018, 1, 1, 13, 0, 0),
                ...
                TravelLines: [
                    {
                        ...
                        Amount: 57,
                        Rate: 3.5,
                        LineState: linestate.Processed,
                        Description: 'Kjøring1',
                        From: new Date(2018, 1, 1, 12, 0, 0),
                        To: new Date(2018, 1, 1, 13, 0, 0),
                        CostType: costtype.Travel,
                    },
                    {
                        ID: 3,
                        travelType: {
                        ...
                        Rate: 3.5,
                        LineState: linestate.Received,
                        Description: 'Kjøring2',
                        From: new Date(2018, 1, 1, 12, 0, 0),
                        To: new Date(2018, 1, 1, 13, 0, 0),
                        CostType: costtype.Travel,
                    }
                ],
                State: state.PartlyProcessed
            },
            {
                ID: 3,
                TravelIdentificator: '3',
                Name: 'Kjøretur3',
                SourceSystem: 'TravelText',
                Description: 'ut på tur aldri sur',
                Email: 'sondre_vik@hotmail.com',
