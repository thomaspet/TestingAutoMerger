...
import { WageTypeTranslationService } from '@app/components/salary/wage-type/shared/services/wage-type-translation.service';

const WAGETYPE_KEY = 'wagetype';

@Component({
    selector: 'uni-wagetype-view',
    templateUrl: './wage-type-view.component.html'
})
export class WageTypeViewComponent extends UniView implements OnDestroy, OnInit {
    public busy: boolean;
