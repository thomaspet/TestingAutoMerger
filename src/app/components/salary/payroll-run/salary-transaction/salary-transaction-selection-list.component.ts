...
import { SalaryTransactionListComponent } from './salary-transaction-list.component';
import { TabService, UniModules } from '@app/components/layout/navbar/tabstrip/tabService';
import { UniModalService } from '@uni-framework/uni-modal';
import { UniFindEmployeeModalComponent } from './find-employee-modal.component';
...
@Component({
    ...
    templateUrl: './salary-transaction-selection-list.component.html',
    styleUrls: ['salary-transaction-selection-list.component.sass']
})

export class SalaryTransactionSelectionListComponent extends UniView implements OnDestroy, AfterViewInit {
    ...
    @ViewChild(SalaryTransactionListComponent)
    private transList: SalaryTransactionListComponent;
    ...
    constructor(
        ...
        private helperMethods: SalaryHelperMethodsService,
    ...
    public getEmployee() {
        this.modalService.open(UniFindEmployeeModalComponent, {
