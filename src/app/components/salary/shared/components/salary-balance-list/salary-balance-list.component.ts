...
import { UniTable, UniTableConfig, UniTableColumn, UniTableColumnType } from '@uni-framework/ui/unitable';
import { SalaryBalance } from '@uni-entities';
import { BehaviorSubject, ReplaySubject } from 'rxjs';
import { SalarybalanceService, NumberFormat } from '@app/services/services';

const SELECTED_KEY = '_rowSelected';

@Component({
  selector: 'uni-salary-balance-list',
  templateUrl: './salary-balance-list.component.html',
  styleUrls: ['./salary-balance-list.component.sass']
})

export class SalaryBalanceListComponent implements OnInit, OnChanges, AfterViewInit {
