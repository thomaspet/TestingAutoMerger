...
export class ProductDetails {
    ...
    public loadProduct() {
        ...
        let subject = null;
        if (this.productId > 0) {
            subject = Observable.forkJoin(this.productService.Get(this.productId));
        } else {
            subject = Observable.forkJoin(this.productService.GetNewEntity(),this.productService.getNewPartname());
        }
