export const options = [
    ...
    { // 3 - Tidligere ar
        ...
        text: `Det er viktig at dine tidligere år er avsluttet og balanserer. Bruk <a>Saldobalanse hovedbok</a> for å finne ut hvor differansen ligger. Dersom du mener at alt er korrekt kan du sjekke ut dette punktet.`
    },
    { // 4 - Aksjekapital
        title: 'Regnskapet ditt mangler  aksjekapital',
        text: `Vi finner ikke minst 30.000 kr i aksjekapital registrert i ditt regnskap. Legg inn denne verdien i <a>Bokføring</a>. Dersom du mener at alt er korrekt kan du sjekke ut dette punktet.`
    },
    { // 5 - Bilag fort
    ...
    { // 6 - Kundefaktura
        ...
        text: `<p>Gå til bankavstemming og avstem disse postene. Du kan velge å gå videre uten å avstemme, da vil du måtte forklare eventuelle differanser i selve avstemmingen av balansen.</p><p><a>Gå til bankavstemming her</a></p>`
    },
    { // 7 - Leverandorfaktura
