...
export const NO = {
    ...
    SETTINGS: {
        ...
        'REM_ACCOUNTS': 'Remitteringskontoer',
        ...
        'LOGO_INFOTEXT': 'Har kan du laste opp logo som brukes på blanketten. Dette er samme logo som lastes opp på firmaoppsettet',
        'ACCOUNTS_INFOTEXT': 'Oppsett av samlekonto for reskontroer og postering av øredifferanse.',
        'ELECTRONIC_INVOICE_INFOTEXT': 'Har kan du aktivere utsendelsesmetoder og OCR-tolkning for faktura. Om du ikke har kjøpt tjenestene, vil vi ta deg til markedsplassen først.',
        ...
        'REM_ACCOUNTS_INFOTEXT': 'Remmitteringskontoer for innbetaling, utbetaling og lønn',
