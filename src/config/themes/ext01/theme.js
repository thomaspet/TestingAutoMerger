...
export default {
    ...
    chatbotIcon: 'config/dist/theme/assets/chatbot-icon.png',

    dashboardConfigs: getDashbordConfig(),
    translationOverrides: getTranslationOverrides(),
    featureBlacklists: getFeatureBlacklists(),
    tableColumnOverrides: undefined,

    init: {
        illustration: 'config/dist/theme/assets/login_background.jpg',
        background: '#ebf6fb',
        login_background: 'url(config/dist/theme/assets/login_background.jpg)',
    ...
    widgets: {
        ...
        pie_colors: ['#005AA4', '#0071CD', '#008ED2', '#7FC6E8', '#A1DFFF']
    },
    ...
    return {
        ...
        ACCOUNTING: {
            SUPPLIER_INVOICE: {
                ...
                'SMART_BOOKING_3': 'Kontoforslag basert på bokføringer gjort i SpareBank 1 Regnskap på leverandører i samme bransje som valgt leverandør på din faktura.',
            },
            POSTPOST: {
...
function getFeatureBlacklists() {
    const PLUS_PACKAGE_BLACKLIST = {
        view_features: [
            'ui.distribution',
