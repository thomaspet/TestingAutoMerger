export const DASHBOARD_CONFIG = {
    large: [
        ...
        {x: 0, y: 6, widgetID: 'overdue_invoices'},
        {x: 8, y: 6, widgetID: 'unpaid_supplierinvoice_sr'},
    ]
};
...
export const SALARY_DASHBOARD_CONFIG = {
    large: [
        { x: 0, y: 0, widgetID: 'employee_counter'},
        { x: 3, y: 0, widgetID: 'chart_employees_per_employment'},
        { x: 8, y: 0, widgetID: 'sum_employments'},
        { x: 8, y: 1, widgetID: 'sum_wagetypes'},
        { x: 8, y: 2, widgetID: 'counter_salary_travels'},
        { x: 0, y: 3, widgetID: 'shortcut_list_salary'},
        { x: 3, y: 3, widgetID: 'transaction_salary'},
    ]
};
