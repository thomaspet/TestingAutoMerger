export const environment = {
    ...
    BASE_URL_INIT: '',
    BASE_URL: '',
    BASE_URL_INTEGRATION: 'https://exedra-integration.unieconomy.no/',
    BASE_URL_FILES: 'https://exedra-files.unieconomy.no',
    UNI_PUSH_ADAPTER_URL: 'https://test-unipushadapter.unieconomy.no',
    UNI_JOB_SERVER_URL: 'https://exedra-jobserver.unieconomy.no/api/',
