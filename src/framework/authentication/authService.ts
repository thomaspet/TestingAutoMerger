    ...
    login(username: string, password: string): void {      
        ...
        .subscribe(
            (response) => {
                ...
                this.jwt_decoded = {"nameid":"dbe829d1-d837-4eee-b662-96d11aa322b9","unique_name":"jonterje","http://schemas.microsoft.com/accesscontrolservice/2010/07/claims/identityprovider":"ASP.NET Identity","AspNet.Identity.SecurityStamp":"a68bef3a-fe29-42ca-8dae-7c290be1603c","role":["Admin","SuperAdmin"],"iss":"https://uni-identity.azurewebsites.net","aud":"414e1927a3884f68abc79f7283837fd1","exp":1455357747,"nbf":1455271347};
