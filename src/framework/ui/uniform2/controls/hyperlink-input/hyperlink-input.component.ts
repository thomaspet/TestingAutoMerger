...
@Component({
    selector: 'uni-hyperlink-input2',
    templateUrl: './hyperlink-input.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [
        { provide: NG_VALUE_ACCESSOR, useExisting: HyperlinkInputComponent, multi: true },
    ]
})
export class HyperlinkInputComponent implements OnInit, ControlValueAccessor {

    @Input() config;
    @Input() formControl: FormControl;
    @Output() focus: EventEmitter<HyperlinkInputComponent> = new EventEmitter();
    @Output() blur: EventEmitter<HyperlinkInputComponent> = new EventEmitter();
