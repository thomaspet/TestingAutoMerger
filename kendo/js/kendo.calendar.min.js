...
!function (e, define) {
    ...
    return function (e, t) {
        ...
        function i(e) {
            for (var t, n = 0, i = e.min, r = e.max, o = e.start, a = e.setter, l = e.build, c = e.cells || 12, d = e.perRow || 4, u = e.content || M, h = e.empty || P, p = e.html || '<table tabindex="0" role="grid" class="k-content k-meta-view" cellspacing="0"><tbody><tr role="row">'; c > n; n++)n > 0 && n % d === 0 && (p += '</tr><tr role="row">'), t = l(o, n), p += s(o, i, r) ? u(t) : h(t), a(o, 1);
        ...
        function p(e) {
            var n = gt[e.start], i = gt[e.depth], r = A(e.culture);
        ...
        var _, w = window.kendo, b = w.support, y = w.ui, k = y.Widget, x = w.keys, C = w.parseDate, S = w.date.adjustDST, T = w._extractFormat, D = w.template, A = w.getCulture, E = w.support.transitions, I = E ? E.css + "transform-origin" : "", M = D('<td#=data.cssClass# role="gridcell"><a tabindex="-1" class="k-link" href="\\#" data-#=data.ns#value="#=data.dateString#">#=data.value#</a></td>', {useWithBlock: !1}), P = D('<td role="gridcell">&nbsp;</td>', {useWithBlock: !1}), F = w.support.browser, z = F.msie && 9 > F.version, R = ".kendoCalendar", B = "click" + R, H = "keydown" + R, L = "id", N = "min", O = "left", V = "slideIn", U = "month", W = "century", j = "change", G = "navigate", q = "value", $ = "k-state-hover", Y = "k-state-disabled", Q = "k-state-focused", K = "k-other-month", X = ' class="' + K + '"', Z = "k-nav-today", J = "td:has(.k-link)", et = "blur" + R, tt = "focus", nt = tt + R, it = b.touch ? "touchstart" : "mouseenter", rt = b.touch ? "touchstart" + R : "mouseenter" + R, ot = b.touch ? "touchend" + R + " touchmove" + R : "mouseleave" + R, at = 6e4, st = 864e5, lt = "_prevArrow", ct = "_nextArrow", dt = "aria-disabled", ut = "aria-selected", ht = e.proxy, pt = e.extend, ft = Date, gt = {
            ...
            init: function (t, n) {
                var i, r, o = this;
                k.fn.init.call(o, t, n), t = o.wrapper = o.element, n = o.options, n.url = window.unescape(n.url), o._templates(), o._header(), o._footer(o.footer), r = t.addClass("k-widget k-calendar").on(rt + " " + ot, J, d).on(H, "table.k-content", ht(o._move, o)).on(B, J, function (t) {
            ...
            options: {
                ...
                depth: U,
                animation: {
                    horizontal: {effects: V, reverse: !0, duration: 500, divisor: 2},
            ...
            navigate: function (n, i) {
                i = isNaN(i) ? gt[i] : i;
                var r, o, s, l, c = this, d = c.options, u = d.culture, h = d.min, p = d.max, g = c._title, m = c._table, v = c._oldTable, w = c._value, b = c._current, y = n && +n > +b, k = i !== t && i !== c._index;
            ...
            _move: function (t) {
                var n, i, r, o, s = this, l = s.options, c = t.keyCode, d = s._view, u = s._index, h = new ft(+s._current), p = w.support.isRtl(s.wrapper);
            ...
            _horizontal: function (e, t, n) {
                var i = this, r = i._active, o = i.options.animation.horizontal, a = o.effects, s = e.outerWidth();
                a && -1 != a.indexOf(V) && (e.add(t).css({width: s}), e.wrap("<div/>"), i._focusView(r, e), e.parent().css({
                    position: "relative",
                    width: 2 * s,
                    "float": O,
                    "margin-left": n ? 0 : -s
            ...
            _vertical: function (e, t) {
                var n, i, r = this, o = r.options.animation.vertical, a = o.effects, s = r._active;
            ...
            _click: function (e) {
                var t = this, n = t.options, i = new Date(+t._current), r = e.attr(w.attr(q)).split("/");
            ...
            _header: function () {
                ...
                n.find(".k-header")[0] || n.html('<div class="k-header"><a href="#" role="button" class="k-link k-nav-prev"><span class="k-icon k-i-arrow-w"></span></a><a href="#" role="button" aria-live="assertive" aria-atomic="true" class="k-link k-nav-fast"></a><a href="#" role="button" class="k-link k-nav-next"><span class="k-icon k-i-arrow-e"></span></a></div>'), e = n.find(".k-link").on(rt + " " + ot + " " + nt + " " + et, d).click(!1), t._title = e.eq(1).on(B, function () {
                    t._active = t.options.focusOnNav !== !1, t.navigateUp()
                }), t[lt] = e.eq(0).on(B, function () {
                    t._active = t.options.focusOnNav !== !1, t.navigateToPast()
                }), t[ct] = e.eq(2).on(B, function () {
                    t._active = t.options.focusOnNav !== !1, t.navigateToFuture()
                })
            },
            _navigate: function (e, t) {
                var n = this, i = n._index + 1, r = new ft(+n._current);
            ...
            _toggle: function (e) {
                ...
                e === t && (e = s(o(), i.min, i.max)), r && (r.off(B), e ? r.addClass(Z).removeClass(Y).on(B, ht(n._todayClick, n)) : r.removeClass(Z).addClass(Y).on(B, u))
            },
            ...
            _templates: function () {
                ...
                e.month = {
                    content: D('<td#=data.cssClass# role="gridcell"><a tabindex="-1" class="k-link#=data.linkClass#" href="#=data.url#" ' + w.attr("value") + '="#=data.dateString#" title="#=data.title#">' + (r || "#=data.value#") + "</a></td>", {useWithBlock: !!r}),
                    empty: D('<td role="gridcell">' + (o || "&nbsp;") + "</td>", {useWithBlock: !!o})
                }, e.footer = n !== !1 ? D(n || '#= kendo.toString(data,"D","' + t.culture + '") #', {useWithBlock: !1}) : null
            }
        });
        y.plugin(mt), _ = {
            firstDayOfMonth: function (e) {
                ...
                var n = e.getTimezoneOffset(), i = new ft(e.getTime() + t), r = i.getTimezoneOffset() - n;
                e.setTime(i.getTime() + r * at)
            }, views: [{
                name: U, title: function (e, t, n, i) {
                    ...
                    var t = new ft(e.getFullYear(), e.getMonth() + 1, 0), n = _.firstDayOfMonth(e), i = Math.abs(t.getTimezoneOffset() - n.getTimezoneOffset());
                ...
                name: "year", title: function (e) {
                    ...
                    var t = h(e.culture).months.namesAbbr, n = this.toDateString, r = e.min, o = e.max;
                    return i({
                        ...
                        setter: this.setDate,
                        build: function (e) {
                            return {value: t[e.getMonth()], ns: w.ns, dateString: n(e), cssClass: ""}
                        }
                    })
                }, first: function (e) {
