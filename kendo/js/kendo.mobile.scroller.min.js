 ...
 */
!function (e, define) {
    define(["./kendo.fx.min", "./kendo.draganddrop.min"], e)
}(function () {
    return function (e, t) {
        var n = window.kendo, i = n.mobile, o = n.effects, r = i.ui, a = e.proxy, s = e.extend, l = r.Widget, c = n.Class, d = n.ui.Movable, h = n.ui.Pane, u = n.ui.PaneDimensions, f = o.Transition, p = o.Animation, g = Math.abs, m = 500, v = .7, _ = .96, w = 10, y = 55, b = .5, x = 5, k = "km-scroller-release", C = "km-scroller-refresh", S = "pull", T = "change", D = "resize", A = "scroll", P = 2, E = p.extend({
            init: function (e) {
                var t = this;
            ...
            init: function (e) {
                ...
                var t, n = this;
                n.dimension.enabled && (n.paneAxis.outOfBounds() ? n._snapBack() : (t = e.touch.id === P ? 0 : e.touch[n.axis].velocity, n.velocity = Math.max(Math.min(t * n.velocityMultiplier, y), -y), n.tapCapture.captureNext(), p.fn.start.call(n)))
            }, tick: function () {
            ...
            init: function (i, o) {
                ...
                }), w = new E({movable: f, dimensions: p, userEvents: v, tapCapture: c}), y = new I({
                    moveTo: function (e) {
                        b.scrollTo(e.x, e.y)
                    }
                }), f.bind(T, function () {
