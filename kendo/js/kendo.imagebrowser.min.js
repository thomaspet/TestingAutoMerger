 ...
 */
!function (e, define) {
    define(["./kendo.filebrowser.min"], e)
}(function () {
    return function (e, t) {
        function n(e, n) {
        ...
        var o, r, a = window.kendo, s = a.ui.FileBrowser, l = e.isPlainObject, c = e.proxy, d = e.extend, h = a.support.browser, u = a.isFunction, f = /(^\/|\/$)/g, p = "error", g = ".kendoImageBrowser", m = "name", v = "size", _ = "type", w = {
            field: _,
            dir: "asc"
        }, y = a.template('<li class="k-tile-empty"><strong>${text}</strong></li>');
        d(!0, a.data, {
            schemas: {
                imagebrowser: {
                    data: function (e) {
            ...
            transports: {
                imagebrowser: a.data.RemoteTransport.extend({
                    ...
                    _call: function (t, n) {
                        n.data = e.extend({}, n.data, {path: this.options.path()}), u(this.options[t]) ? this.options[t].call(this, n) : a.data.RemoteTransport.fn[t].call(this, n)
                    },
                    read: function (e) {
                        this._call("read", e)
                    },
        ...
        }), o = h.msie && 8 > h.version ? function (e) {
            return e.offsetTop
        } : function (t) {
            ...
            init: function (e, t) {
                ...
                var e, i = this, o = i._selectedItem(), r = i.options.transport.imageUrl;
                return o && "f" === o.get(_) ? (e = n(i.path(), o.get(m)).replace(f, ""), r && (e = u(r) ? r(e) : a.format(r, encodeURIComponent(e))), e) : t
            }, _fileUpload: function (e) {
                var t, n = this, i = n.options, o = i.fileTypes, r = RegExp(("(" + o.split(",").join(")|(") + ")").replace(/\*\./g, ".*."), "i"), s = e.files[0].name, l = m, c = v;
                r.test(s) ? (e.data = {path: n.path()}, t = n._createFile(s), t ? (t._uploading = !0, n.upload.one("success", function (e) {
                ...
                })) : e.preventDefault()) : (e.preventDefault(), n._showMessage(a.format(i.messages.invalidFileType, s, o)))
            }, _content: function () {
                var t = this;
                t.list = e('<ul class="k-reset k-floats k-tiles" />').appendTo(t.element).on("scroll" + g, c(t._scroll, t)).on("dblclick" + g, "li", c(t._dblClick, t)), t.listView = new a.ui.ListView(t.list, {
                    ...
                    dataBound: function () {
                        t.dataSource.view().length ? (t._tiles = this.items().filter("[" + a.attr("type") + "=f]"), t._scroll()) : this.wrapper.append(y({text: t.options.messages.emptyFolder}))
                    },
                    change: c(t._listViewChange, t)
                })
            }, _dataSource: function () {
                var e, t = this, n = t.options, i = n.transport, o = d({}, w), r = {
                    field: m,
                    dir: "asc"
                }, s = {type: i.type || "imagebrowser", sort: [o, r]};
                ...
                var n = this, i = e(t), o = n.dataSource.getByUid(i.attr(a.attr("uid"))), r = o.get(m), s = n.options.transport.thumbnailUrl, l = e("<img />", {alt: r}), c = "?";
                o._uploading || (l.hide().on("load" + g, function () {
                    e(this).prev().remove().end().addClass("k-image").fadeIn()
                }), i.find(".k-loading").after(l), u(s) ? s = s(n.path(), encodeURIComponent(r)) : (s.indexOf("?") >= 0 && (c = "&"), s = s + c + "path=" + n.path() + encodeURIComponent(r)), l.attr("src", s), t.loaded = !0)
            }, _scroll: function () {
                var e = this;
