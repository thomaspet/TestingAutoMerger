 ...
 */
!function (e, define) {
    define(["./kendo.dom.min"], e)
}(function () {
    return function (e) {
        function t(e) {
            for (var t, n = 0, i = e.length; i > n; n++)if (2 == e[n].type) {
                t = !0;
                break
            }
            t && e.splice(n + 1, 0, {caption: "KPIs", defaultHierarchy: "[KPIs]", name: "KPIs", uniqueName: "[KPIs]"})
        }

        function n(e) {
            return {name: e.uniqueName, type: e.type}
        }
        ...
        function r(e, t, n) {
            return {hierarchyUniqueName: e, uniqueName: t, caption: t, measure: t, name: t, type: n, kpi: !0}
        }

        function a(e) {
            var t = e.name;
            return [r(t, e.value, "value"), r(t, e.goal, "goal"), r(t, e.status, "status"), r(t, e.trend, "trend")]
        }

        var s = window.kendo, l = s.ui, c = l.Widget, d = ".kendoPivotConfigurator", h = "mouseenter" + d + " mouseleave" + d, u = s.template('<p class="k-reset"><span class="k-icon #=icon#"></span>${name}</p><div class="k-list-container k-reset"/>'), f = c.extend({
            init: function (e, t) {
            ...
            _treeViewDataSource: function () {
                ...
                return s.data.HierarchicalDataSource.create({
                    schema: {
                        ...
                        read: function (o) {
                            var r, s, l;
                            e.isEmptyObject(o.data) ? (r = n.dataSource.schemaDimensions(), r.done(function (e) {
                                n.dataSource.cubeBuilder || t(e), o.success(e)
                            }).fail(o.error)) : (s = n.treeView.dataSource.get(o.data.uniqueName), "[KPIs]" === s.uniqueName ? (l = !0, r = n.dataSource.schemaKPIs(), r.done(function (e) {
                                o.success(i(e))
                            }).fail(o.error)) : "kpi" == s.type && (l = !0, o.success(a(s))), l || (r = 2 == s.type ? n.dataSource.schemaMeasures() : s.dimensionUniqueName ? n.dataSource.schemaLevels(o.data.uniqueName) : n.dataSource.schemaHierarchies(o.data.uniqueName), r.done(o.success).fail(o.error)))
                        }
                    }
                })
            },
            ...
            _fields: function () {
                var t = e('<div class="k-state-default"><p class="k-reset"><span class="k-icon k-i-group"></span>' + this.options.messages.fieldsLabel + "</p></div>").appendTo(this.form), i = '# if (item.type == 2 || item.uniqueName == "[KPIs]") { #<span class="k-icon k-i-#= (item.type == 2 ? "sum" : "kpi") #"></span># } else if (item.type && item.type !== "kpi") { #<span class="k-icon k-i-dimension"></span># } ##: item.caption || item.name #';
                this.treeView = e("<div/>").appendTo(t).kendoTreeView({
                    ...
                    drag: function (e) {
                        var t = "k-denied", n = o(e.dropTarget);
                        n && n.validate(this.dataItem(e.sourceNode)) && (t = "k-add"), e.setStatusClass(t)
                    },
                    drop: function (e) {
                        var t, i, r, s, l, c;
                        if (e.preventDefault(), t = o(e.dropTarget), i = this.dataItem(e.sourceNode), t && t.validate(i)) {
                            if (c = i.defaultHierarchy || i.uniqueName, "kpi" === i.type)for (l = a(i), s = l.length, c = [], r = 0; s > r; r++)c.push(n(l[r])); else i.kpi && (c = [n(i)]);
                            t.add(c)
                        }
                    }
                }).data("kendoTreeView")
            ...
            _createTarget: function (t, n) {
                var i = '<li class="k-item k-header" data-' + s.ns + 'name="${data.name}">${data.name}', o = n.sortable, r = "";
                return o && (r += "#if (data.sortIcon) {#", r += '<span class="k-icon ${data.sortIcon} k-setting-sort"></span>', r += "#}#"), (n.filterable || o) && (r += '<span class="k-icon k-i-arrowhead-s k-setting-fieldmenu"></span>'), r += '<span class="k-icon k-si-close k-setting-delete"></span>', i += '<span class="k-field-actions">' + r + "</span></li>", new s.ui.PivotSettingTarget(t, e.extend({
            ...
            _targets: function () {
                var t = e('<div class="k-state-default"/>').appendTo(this.form), n = e(u({
                    name: this.options.messages.columnsLabel,
                    icon: "k-i-vbars"
                })).appendTo(t), i = e('<ul class="k-pivot-configurator-settings k-list k-reset" />').appendTo(n.last()), o = e(u({
                    name: this.options.messages.rowsLabel,
                    icon: "k-i-hbars"
                })).appendTo(t), r = e('<ul class="k-pivot-configurator-settings k-list k-reset" />').appendTo(o.last()), a = e(u({
                    name: this.options.messages.measuresLabel,
                    icon: "k-i-sum"
                })).appendTo(t), s = e('<ul class="k-pivot-configurator-settings k-list k-reset" />').appendTo(a.last()), l = this.options;
                this.columns = this._createTarget(i, {
                    filterable: l.filterable,
                    sortable: l.sortable,
                    connectWith: r,
                    messages: {empty: l.messages.columns, fieldMenu: l.messages.fieldMenu}
                }), this.rows = this._createTarget(r, {
                    filterable: l.filterable,
                    setting: "rows",
                    connectWith: i,
                    messages: {empty: this.options.messages.rows, fieldMenu: this.options.messages.fieldMenu}
                }), this.measures = this._createTarget(s, {
                    setting: "measures",
                    messages: {empty: l.messages.measures}
                }), i.add(r).add(s).on(h, ".k-item:not(.k-empty)", this._toggleHover)
            },
            _toggleHover: function (t) {
                e(t.currentTarget).toggleClass("k-state-hover", "mouseenter" === t.type)
            },
            _resize: function () {
                var e, t, n = this.element, i = this.options.height;
