 ...
 */
!function (e, define) {
    define(["./kendo.data.min", "./kendo.userevents.min", "./kendo.mobile.button.min"], e)
}(function () {
    return function (e, t) {
        function n() {
        ...
        m.mobile.ui.VirtualList = $, l = m.Class.extend({
            ...
            _start: function () {
                var e = this.options;
                this.options.filterable && (this._filter = new p(this)), this._itemBinder = this.virtual ? new u(this) : new f(this), this.options.pullToRefresh && (this._pullToRefreshHandler = new q(this)), this.setDataSource(e.dataSource), this._enhanceItems(this.items()), m.notify(this, w)
            },
            events: [O, F, L, R],
            options: {
                name: "ListView",
            ...
            setDataItem: function (t, n) {
                var i = this, o = function (o) {
                    var r = e(o[0]);
                    m.destroy(t), e(t).replaceWith(r), i.trigger(R, {item: r, data: n, ns: w})
                };
            ...
            _click: function (t) {
                if (!(t.event.which > 1 || t.event.isDefaultPrevented())) {
                    var n, i = t.target, o = e(t.event.target), r = o.closest(m.roleSelector("button", "detailbutton", "backbutton")), a = m.widgetInstance(r, w), s = i.attr(m.attr("uid"));
