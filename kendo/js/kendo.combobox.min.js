    ...
    return function (e, t) {
        var n = window.kendo, i = n.ui, r = i.List, o = i.Select, a = n.caret, s = n.support, l = s.placeholder, c = n._activeElement, d = n.keys, u = ".kendoComboBox", h = "click" + u, p = "mousedown" + u, f = "disabled", g = "readonly", m = "change", v = "k-state-default", _ = "k-state-focused", b = "k-state-disabled", w = "aria-disabled", y = "aria-readonly", k = "filter", x = "accept", C = "rebind", S = "mouseenter" + u + " mouseleave" + u, T = e.proxy, D = o.extend({
            ...
            _editable: function (e) {
                var t = this, n = e.disable, i = e.readonly, r = t._inputWrapper.off(u), o = t.element.add(t.input.off(u)), a = t._arrow.parent().off(h + " " + p);
                i || n ? (r.addClass(n ? b : v).removeClass(n ? v : b), o.attr(f, n).attr(g, i).attr(w, n).attr(y, i)) : (r.addClass(v).removeClass(b).on(S, t._toggleHover), o.removeAttr(f).removeAttr(g).attr(w, !1).attr(y, !1), a.on(h, T(t._arrowClick, t)).on(p, function (e) {
                    e.preventDefault()
            ...
            _listBound: function () {
                var e, n, i, r, o = this, a = o.options, s = o._initialIndex, l = o._state === k, d = o.input[0] === c(), u = o.listView, h = u.focus(), p = this.dataSource.flatView(), f = this.dataSource.page(), g = p.length;
            ...
            _get: function (e) {
                ...
                if ("function" == typeof e) {
                    for (t = this.dataSource.flatView(), i = 0; t.length > i; i++)if (e(t[i])) {
                        e = i, n = !0;
                        break
                    }
                    n || (e = -1)
            ...
            suggest: function (e) {
                var n, i = this, o = i.input[0], s = i.text(), l = a(o)[0], u = i._last;
            ...
            _click: function (e) {
                var n = e.item;
                return this.trigger("select", {item: n}) ? (this.close(), t) : (this._userTriggered = !0, this._select(n), this._blur(), t)
            },
            _filter: function (e) {
                var n, i = this, r = i.options, o = i.dataSource, a = r.ignoreCase, s = function (n) {
                    var r = i._text(n);
            ...
            _clearSelection: function (e, t) {
                var n = this, i = e.value(), r = i && -1 === e.selectedIndex;
