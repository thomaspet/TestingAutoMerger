 ...
 */
!function (e, define) {
    define(["./kendo.calendar.min", "./kendo.popup.min"], e)
}(function () {
    return function (e, t) {
        function n(t) {
            var n = t.parseFormats, i = t.format;
            R.normalize(t), n = e.isArray(n) ? n : [n], n.length || n.push("yyyy-MM-dd"), -1 === e.inArray(i, n) && n.splice(0, 0, t.format), t.parseFormats = n
        }
        ...
        j.prototype = {
            _calendar: function () {
                var t, n = this, o = n.calendar, a = n.options;
                o || (t = e(u).attr(A, r.guid()).appendTo(n.popup.element).on(D, i).on(g, "td:has(.k-link)", H(n._click, n)), n.calendar = o = new s.Calendar(t), n._setOptions(a), r.calendar.makeUnselectable(o.element), o.navigate(n._value || n._current, a.start), n.value(n._value))
                ...
                var t = this, n = e.keyCode, i = t.calendar, o = e.ctrlKey && n == c.DOWN || n == c.ENTER, r = !1;
                if (e.altKey)n == c.DOWN ? (t.open(), e.preventDefault(), r = !0) : n == c.UP && (t.close(), e.preventDefault(), r = !0); else if (t.popup.visible()) {
            ...
            init: function (t, i) {
                var o, s, c = this;
                a.fn.init.call(c, t, i), t = c.element, i = c.options, i.min = l(t.attr("min")) || l(i.min), i.max = l(t.attr("max")) || l(i.max), n(i), c._initialOptions = N({}, i), c._wrapper(), c.dateView = new j(N({}, i, {
                    id: t.attr(A),
                    anchor: c.wrapper,
                    change: function () {
                    ...
                    close: function (e) {
                        c.trigger(v) ? e.preventDefault() : (t.attr(B, !1), s.attr(L, !0))
                    },
                    open: function (e) {
                        var n, i = c.options;
                        c.trigger(m) ? e.preventDefault() : (c.element.val() !== c._oldText && (n = l(t.val(), i.parseFormats, i.culture), c.dateView[n ? "current" : "value"](n)), t.attr(B, !0), s.attr(L, !1), c._updateARIA(n))
                    }
            ...
            _editable: function (e) {
                var t = this, n = t._dateIcon.off(p), o = t.element.off(p), r = t._inputWrapper.off(p), s = e.readonly, a = e.disable;
            ...
            _keydown: function (e) {
                var t = this, n = t.dateView, i = t.element.val(), o = !1;
            ...
            _update: function (e) {
                var t, n = this, i = n.options, o = i.min, s = i.max, a = n._value, c = l(e, i.parseFormats, i.culture), h = null === c && null === a || c instanceof Date && a instanceof Date;
                return +c === +a && h ? (t = r.toString(c, i.format, i.culture), t !== e && n.element.val(null === c ? e : t), c) : (null !== c && V(c, o) ? c = O(c, o, s) : F(c, o, s) || (c = null), n._value = c, n.dateView.value(c), n.element.val(c ? r.toString(c, i.format, i.culture) : e), n._updateARIA(c), c)
            },
            _wrapper: function () {
                var t, n = this, i = n.element;
