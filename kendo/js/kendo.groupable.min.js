...
!function (e, define) {
    ...
    return function (e, t) {
        ...
        var i = window.kendo, o = i.ui.Widget, r = e.proxy, a = !1, s = ".kendoGroupable", l = "change", c = i.template('<div class="k-group-indicator" data-#=data.ns#field="${data.field}" data-#=data.ns#title="${data.title || ""}" data-#=data.ns#dir="${data.dir || "asc"}"><a href="\\#" class="k-link"><span class="k-icon k-si-arrow-${(data.dir || "asc") == "asc" ? "n" : "s"}">(sorted ${(data.dir || "asc") == "asc" ? "ascending": "descending"})</span>${data.title ? data.title: data.field}</a><a class="k-button k-button-icon k-button-bare"><span class="k-icon k-group-delete"></span></a></div>', {useWithBlock: !1}), d = function (t) {
        ...
        }, h = e('<div class="k-grouping-dropclue"/>'), u = o.extend({
            init: function (c, u) {
                var f, p, g = this, m = i.guid(), v = r(g._intializePositions, g), _ = g._dropCuePositions = [];
                o.fn.init.call(g, c, u), a = i.support.isRtl(c), p = a ? "right" : "left", g.draggable = f = g.options.draggable || new i.ui.Draggable(g.element, {
                    ...
                    drop: function (t) {
                        var n, o = t.draggable.currentTarget, r = o.attr(i.attr("field")), s = o.attr(i.attr("title")), l = g.indicator(r), c = g._dropCuePositions, d = c[c.length - 1];
                    ...
                    dragstart: function (e) {
                        var t = e.currentTarget, i = parseInt(t.css("marginLeft"), 10), o = t.position(), r = a ? o.left - i : o.left + t.outerWidth();
                        v(), h.css({
                    ...
                    var n = e(this).parent(), o = g.buildIndicator(n.attr(i.attr("field")), n.attr(i.attr("title")), "asc" == n.attr(i.attr("dir")) ? "desc" : "asc");
                    n.before(o).remove(), g._change(), t.preventDefault()
                }), f.bind(["dragend", "dragcancel", "dragstart", "drag"], {
                    dragend: function () {
                        g._dragEnd(this)
                    }, dragcancel: r(g._dragCancel, g), dragstart: function (e) {
                        var n, i, o;
            ...
            refresh: function () {
                ...
                t.groupContainer && t.groupContainer.empty().append(e.map(n.group() || [], function (n) {
                    var o = n.field, r = i.attr("field"), a = t.element.find(t.options.filter).filter(function () {
            ...
            buildIndicator: function (e, t, n) {
                return c({field: e.replace(/"/g, "'"), dir: n, title: t, ns: i.ns})
            },
            descriptors: function () {
                var t, n, o, r, a, s = this, l = e(".k-group-indicator", s.groupContainer);
                return t = s.element.find(s.options.filter).map(function () {
                    var t = e(this), o = t.attr(i.attr("aggregates")), s = t.attr(i.attr("field"));
                    if (o && "" !== o)for (n = o.split(","), o = [], r = 0, a = n.length; a > r; r++)o.push({
                        field: s,
                        aggregate: n[r]
                    });
                    return o
            ...
            _drag: function (e) {
                ...
                t && h.css({left: t.left, right: "auto"})
            },
            _canDrag: function (e) {
            ...
            _canDrop: function (e, t, n) {
                var i = e.next(), o = e[0] !== t[0] && (!i[0] || t[0] !== i[0] || !a && n > i.position().left || a && n < i.position().left);
                return o
            },
            _dragEnd: function (t) {
                var n = this, o = t.currentTarget.attr(i.attr("field")), r = n.indicator(o);
            ...
            _intializePositions: function () {
                var t, n = this, o = e(".k-group-indicator", n.groupContainer);
