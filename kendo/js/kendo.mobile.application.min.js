 ...
 */
!function (e, define) {
    define(["./kendo.mobile.pane.min", "./kendo.router.min"], e)
}(function () {
    return function (e, t) {
        function n(e, t) {
            var n = [];
        ...
        var l = window.kendo, c = l.mobile, d = l.support, h = c.ui.Widget, u = c.ui.Pane, f = "ios7", p = d.mobileOS, g = "blackberry" == p.device && p.flatVersion >= 600 && 1e3 > p.flatVersion && p.appMode, m = .93, v = "km-vertical", _ = "chrome" === p.browser, w = p.ios && p.flatVersion >= 700 && 800 > p.flatVersion && (p.appMode || _), y = Math.abs(window.orientation) / 90 == 1, b = "km-horizontal", x = {
            ios7: {
                ios: !0,
                browser: "default",
                device: "iphone",
            ...
            bootstrap: function (t, n) {
                ...
                t = e(t), t[0] || (t = e(document.body)), h.fn.init.call(this, t, n), this.element.removeAttr("data-" + l.ns + "role"), this._setupPlatform(), this._attachMeta(), this._setupElementClass(), this._attachHideBarHandlers(), i = e.extend({}, this.options), delete i.name, o = this, r = function () {
                    o.pane = new u(o.element, i), o.pane.navigateToInitial(), o.options.updateDocumentTitle && o._setupDocumentTitle(), o._startHistory(), o.trigger(R)
            ...
            _resizeToScreenHeight: function () {
                ...
                t = _ ? window.innerHeight : o(i) ? n ? y ? z.availWidth + I : z.availWidth : y ? z.availWidth : z.availWidth - I : n ? y ? z.availHeight : z.availHeight + I : y ? z.availHeight - I : z.availHeight, i.height(t)
            },
            _setupElementClass: function () {
                ...
                i.parent().addClass("km-root km-" + (n.os.tablet ? "tablet" : "phone")), i.addClass(n.osCssClass + " " + r(i)), this.options.useNativeScrolling && i.parent().addClass("km-native-scrolling"), _ && i.addClass("km-ios-chrome"), d.wpDevicePixelRatio && i.parent().css("font-size", d.wpDevicePixelRatio + "em"), this.options.retina && (i.parent().addClass("km-retina"), i.parent().css("font-size", d.devicePixelRatio * m + "em")), g && s(), n.options.useNativeScrolling ? i.parent().addClass("km-native-scrolling") : T && (t = (screen.availWidth > screen.availHeight ? screen.availWidth : screen.availHeight) + 200, e(S({
                    width: t,
                    height: t
                })).appendTo(L)), w && n._resizeToScreenHeight(), l.onResize(function () {
                    i.removeClass("km-horizontal km-vertical").addClass(r(i)), n.options.useNativeScrolling && a(i), w && n._resizeToScreenHeight(), g && s(), l.resize(i)
                })
            },
