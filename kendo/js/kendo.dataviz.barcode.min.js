...
!function (e, define) {
    ...
    return function (e, t) {
        ...
        var i, r, o, a, s, l, c = window.kendo, d = c.ui.Widget, u = e.extend, h = c.deepExtend, p = e.inArray, f = e.isPlainObject, g = c.drawing, m = c.geometry, v = c.util, _ = v.defined, b = c.dataviz, w = b.Box2D, y = b.TextBox, k = 300, x = 100, C = 10, S = /^\d+$/, T = /^[a-z0-9]+$/i, D = "Character '{0}' is not valid for symbology {1}", A = c.Class.extend({
            init: function (e) {
                this.setOptions(e)
            ...
            }, options: {quietZoneLength: C, addQuietZone: !0, addCheckSum: !0}, initValue: function () {
            ...
            minBaseUnitLength: .7, addData: function () {
            ...
            addExtended: function (e) {
                var n, i, r, o = this;
                for (i = 0; o.extendedMappings.length > i; i++)if (n = o.extendedMappings[i].call(o, e)) {
            ...
            extendedMappings: [function (e) {
                ...
                var t, n, i, r = this;
                if (r.specialAsciiCodes[e])for (t = [], i = 0; r.specialAsciiCodes[e].length > i; i++)t.push(r.characterMap[r.shiftCharacters[3]]), t.push(r.characterMap[r.specialAsciiCodes[e][i]]); else n = 6 * Math.floor(e / 32) + (e - 27) % 32 + 64, t = [r.characterMap[r.shiftCharacters[3]], r.characterMap[String.fromCharCode(n)]];
                return t
            }],
            specialAsciiCodes: {0: ["U"], 64: ["V"], 96: ["W"], 127: ["T", "X", "Y", "Z"]},
            shiftValuesAsciiCodes: {39: 36, 40: 47, 41: 43, 42: 37},
            characterMap: {"+": !1, "/": !1, $: !1, "%": !1},
        ...
        E.code39 = I.extend({
            ...
            patternMappings: {b: "1|", w: "1|", B: "ratio|", W: "ratio|"},
            characterMap: {
            ...
            options: {addCheckSum: !1}
        }), E.code39extended = E.code39.extend(h({}, M, {
        ...
        }), E.code93extended = E.code93.extend(h({}, M, {
            name: "Code 93 extended", pushCheckSum: function () {
                var e, t, n = this, i = n._getCheckValues();
            ...
            FNC4: "FNC4", init: function (e, t) {
                ...
                for (p("C", r) >= 0 && (n = o.substr(e.index).match(/\d{4,}/g), n && (a = o.indexOf(n[0], e.index))); (t = e.value.charCodeAt(e.index)) >= 0 && i.isCode(t) && a > e.index;)i.encoding.addPattern(i.getValue(t)), e.index++
            ...
            key: "A", shiftKey: "B", isCode: function (e) {
                return e >= 0 && 96 > e
            }, getValue: function (e) {
                return 32 > e ? e + 64 : e - 32
            }, MOVE: 101, START: 103
        }), o.B = r.extend({
            key: "B", shiftKey: "A", isCode: function (e) {
                return e >= 32 && 128 > e
            }, getValue: function (e) {
                return e - 32
            }, MOVE: 100, START: 104
        }), o.C = i.extend({
            key: "C", addStart: function () {
                this.encoding.addPattern(this.START)
            }, is: function (e, t) {
                var i = n(e, t, 4);
                ...
                for (var t; (t = n(e.value, e.index, 2)) && S.test(t) && 2 == t.length;)this.encoding.addPattern(parseInt(t, 10)), e.index += 2
            }, getValue: function (e) {
                return e
            }, MOVE: 99, START: 105
        }), o.FNC4 = i.extend({
            key: "FNC4", dependentStates: ["A", "B"], init: function (e, t) {
                ...
                if (e.index += o, 3 > o)for (; o > i.index; i.index++)t = i.value.charCodeAt(i.index), i.state = n._getSubState(t), i.previousState != i.state && (i.previousState = i.state, r[i.state].move(i)), r.addPattern(r[i.state].MOVE), r.addPattern(r[i.state].getValue(t)); else i.state != i.previousState && r[i.state].move(i), n._pushStart(i), r.pushData(i, n.subStates), e.value.length > e.index && n._pushStart(i);
                ...
                var t, n = this;
                for (t = 0; n.subStates.length > t; t++)if (n.encoding[n.subStates[t]].isCode(e))return n.subStates[t]
            ...
            getByLength: function (e, t) {
                var i, r, o, a = this;
                for (o = 2; 4 >= o; o++)if (i = n(e, t, o), r = a.getAI(i) || a.getAI(i.substring(0, i.length - 1)))return {
                    id: i,
                    ai: r
                };
            ...
            getAI: function (e) {
                ...
                for (t = 0; o.length > t; t++) {
                    ...
                    if (o[t].ranges)for (n = o[t].ranges, i = 0; n.length > i; i++)if (e >= n[i][0] && n[i][1] >= e)return o[t].type
                }
            },
            applicationIdentifiers: {
                ...
                }, {ids: ["7001"], ranges: [[410, 414]], type: {length: 13}}, {
                    ids: ["10", "21", "254", "420", "8002"],
                    type: {max: 20, type: "alphanumeric"}
                }, {ids: ["00", "8006", "8017", "8018"], type: {length: 18}}, {
                    ids: ["01", "02", "8001"],
                    type: {length: 14}
                }, {ids: ["422"], ranges: [[424, 426]], type: {length: 3}}, {
                    ids: ["20", "8102"],
                    type: {length: 2}
            ...
            getNextState: function (e, t) {
                for (var n = 0; t.length > n; n++)if (this[t[n]].is(e.value, e.index))return t[n];
            ...
            STOP: 106
        }), E.code128a = a.extend({name: "Code 128 A", states: ["A"]}), E.code128b = a.extend({
            name: "Code 128 B",
            states: ["B"]
        }), E.code128c = a.extend({name: "Code 128 C", states: ["C"]}), E.code128 = a.extend({
            name: "Code 128",
            states: ["C", "B", "A", "FNC4"]
        }), E["gs1-128"] = a.extend({
            name: "Code GS1-128",
            ...
            init: function (t, n) {
                var i = this;
                d.fn.init.call(i, t, n), i.element = e(t), i.wrapper = i.element, i.element.addClass("k-barcode").css("display", "block"), i.surfaceWrap = e("<div />").css("position", "relative").appendTo(this.element), i.surface = g.Surface.create(i.surfaceWrap, {type: i.options.renderAs}), i.setOptions(n)
            },
            setOptions: function (e) {
                var t = this;
            ...
            _render: function () {
                var e, t, n, i = this, r = i.options, o = r.value, a = r.text, s = b.getSpacing(a.margin), l = i._getSize(), c = r.border || {}, d = i.encoding, u = w(0, 0, l.width, l.height).unpad(c.width).unpad(r.padding), h = u.height(), p = new g.Group;
                return i.contentBox = u, p.append(i._getBackground(l)), a.visible && (n = g.util.measureText(o, {font: a.font}).height, h -= n + s.top + s.bottom), e = d.encode(o, u.width(), h), a.visible && (t = o, r.checksum && _(d.checksum) && (t += " " + d.checksum), p.append(i._getText(t))), i.barHeight = h, this._bandsGroup = this._getBands(e.pattern, e.baseUnit), p.append(this._bandsGroup), p
            },
            exportVisual: function () {
                return this._render()
            },
            _getSize: function () {
                var e = this, t = e.element, n = new m.Size(k, x);
            ...
            _getBands: function (e, t) {
                var n, i, r, o, a, s = this, l = s.contentBox, c = l.x1, d = new g.Group;
                for (r = 0; e.length > r; r++)i = f(e[r]) ? e[r] : {
                    ...
                    fill: {color: s.options.color},
                    stroke: null
                }), d.append(a)), c += n;
                return d
            },
            _getBackground: function (e) {
                var t = this, n = t.options, i = n.border || {}, r = w(0, 0, e.width, e.height).unpad(i.width / 2), o = g.Path.fromRect(r.toRect(), {
                    fill: {color: n.background},
                    stroke: {color: i.width ? i.color : "", width: i.width, dashType: i.dashType}
                });
                return o
            },
            _getText: function (e) {
                var t = this, n = t.options.text, i = t._textbox = new y(e, {
                    font: n.font,
                    color: n.color,
                    align: "center",
                    vAlign: "bottom",
            ...
            options: {
                ...
                border: {width: 0, dashType: "solid", color: "black"},
                padding: {top: 0, bottom: 0, left: 0, right: 0}
            }
        }), b.ExportMixin.extend(l.fn), b.ui.plugin(l), c.deepExtend(b, {encodings: E, Encoding: A})
