 ...
 */
!function (e, define) {
    define(["./kendo.mobile.view.min", "./kendo.mobile.loader.min"], e)
}(function () {
    return function (e, t) {
        var n = window.kendo, i = n.mobile, o = n.roleSelector, r = i.ui, a = r.Widget, s = i.ViewEngine, l = r.View, c = i.ui.Loader, d = "external", h = "href", u = "#!", f = "navigate", p = "viewShow", g = "sameViewRequested", m = n.support.mobileOS, v = m.ios && !m.appMode && m.flatVersion >= 700, _ = /popover|actionsheet|modalview|drawer/, w = "#:back", y = n.attrValue, b = a.extend({
            init: function (e, t) {
                var i = this;
            ...
            _appLinkClick: function (t) {
                ...
                i || y(e(t.currentTarget), "rel") == d || t.preventDefault()
            },
            _mouseup: function (o) {
                if (!(o.which > 1 || o.isDefaultPrevented())) {
                    var a = this, s = e(o.currentTarget), l = y(s, "transition"), c = y(s, "rel") || "", f = y(s, "target"), p = s.attr(h), g = v && 0 === s[0].offsetHeight, m = p && "#" !== p[0] && this.options.serverNavigation;
