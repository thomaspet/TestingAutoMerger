...
!function (e, define) {
    ...
    return function (e) {
        ...
        var n = window.kendo, i = n.getOffset, o = n.ui.Widget, r = "change", a = "k-reorderable", s = o.extend({
            init: function (s, l) {
                var c, d = this, h = n.guid() + "-reorderable";
                o.fn.init.call(d, s, l), s = d.element.addClass(a), l = d.options, d.draggable = c = l.draggable || new n.ui.Draggable(s, {
                        group: h,
                        filter: l.filter,
                        hint: l.hint
                    ...
                    dragenter: function (e) {
                        var n, o, r, a;
                        d._draggable && (n = this.element, r = !d._dropTargetAllowed(n) || d._isLastDraggable(), t(e.draggable.hint, r), r || (o = i(n), a = o.left, l.inSameContainer && !l.inSameContainer({
                            source: n,
                            target: d._draggable,
                    ...
                    dragcancel: function () {
                        ...
                        var t, n;
                        d._dropTarget && !this.hint.find(".k-drag-status").hasClass("k-denied") && (t = i(d._dropTarget).left, n = d._dropTarget.outerWidth(), d.reorderDropCue.css(e.pageX > t + n / 2 ? {left: t + n} : {left: t}))
                    }
                })
            }, options: {name: "Reorderable", filter: "*"}, events: [r], _isLastDraggable: function () {
                var e, t = this.options.inSameContainer, n = this._draggable[0], i = this._elements.get(), o = !1;
                if (!t)return !1;
                ...
                var t = this.options.inSameContainer, n = this.options.dragOverContainers, i = this._draggable;
