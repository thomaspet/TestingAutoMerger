...
!function (e, define) {
    ...
    return function (e, t) {
        ...
        var o = window.kendo, r = o.ui, a = o.keys, s = e.extend, l = e.each, c = o.template, d = r.Widget, h = /^(ul|a|div)$/i, u = ".kendoPanelBar", f = "img", p = "href", g = "k-last", m = "k-link", v = "." + m, _ = "error", w = ".k-item", y = ".k-group", b = y + ":visible", x = "k-image", k = "k-first", C = "expand", S = "select", T = "k-content", D = "activate", A = "collapse", P = "mouseenter", E = "mouseleave", M = "contentLoad", I = "k-state-active", B = "> .k-panel", z = "> .k-content", L = "k-state-focused", F = "k-state-disabled", R = "k-state-selected", O = "." + R, H = "k-state-highlight", N = w + ":not(.k-state-disabled)", V = "> " + N + " > " + v + ", .k-panel > " + N + " > " + v, U = w + ".k-state-disabled > .k-link", W = "> li > " + O + ", .k-panel > li > " + O, j = "k-state-default", G = "aria-disabled", q = "aria-expanded", $ = "aria-hidden", Y = "aria-selected", Q = ":visible", X = ":empty", K = "single", Z = {
            ...
            aria: function (e) {
                ...
                return n += t.enabled === !1 ? " " + F : t.expanded === !0 ? " " + I : " k-state-default", 0 === i && (n += " k-first"), i == e.length - 1 && (n += " k-last"), t.cssClass && (n += " " + t.cssClass), n
            ...
            init: function (t, n) {
                var i, r = this;
                d.fn.init.call(r, t, n), t = r.wrapper = r.element.addClass("k-widget k-reset k-header k-panelbar"), n = r.options, t[0].id && (r._itemId = t[0].id + "_pb_active"), r._tabindex(), r._initData(n), r._updateClasses(), r._animations(n), t.on("click" + u, V, function (t) {
                    r._click(e(t.currentTarget)) && t.preventDefault()
                }).on(P + u + " " + E + u, V, r._toggleHover).on("click" + u, U, !1).on("keydown" + u, e.proxy(r._keydown, r)).on("focus" + u, function () {
                    var e = r.select();
                    r._current(e[0] ? e : r._first())
                }).on("blur" + u, function () {
                    r._current(null)
                }).attr("role", "menu"), i = t.find("li." + I + " > ." + T), i[0] && r.expand(i.parent(), !1), o.notify(r)
            },
            events: [C, A, S, D, _, M],
            options: {
                name: "PanelBar",
            ...
            destroy: function () {
                d.fn.destroy.call(this), this.element.off(u), o.destroy(this.element)
            },
            ...
            expand: function (t, n) {
                var i = this, o = {};
                return n = n !== !1, t = this.element.find(t), t.each(function (r, a) {
                    a = e(a);
                    var s = a.find(B).add(a.find(z));
                    if (!a.hasClass(F) && s.length > 0) {
                        if (i.options.expandMode == K && i._collapseAllExpanded(a))return i;
                        t.find("." + H).removeClass(H), a.addClass(H), n || (o = i.options.animation, i.options.animation = {
                            expand: {effects: {}},
                            collapse: {hide: !0, effects: {}}
                        }), i._triggerEvent(C, a) || i._toggleItem(a, !1), n || (i.options.animation = o)
                    }
                }), i
            },
            collapse: function (t, n) {
                var i = this, o = {};
                return n = n !== !1, t = i.element.find(t), t.each(function (t, r) {
                    r = e(r);
                    var a = r.find(B).add(r.find(z));
                    !r.hasClass(F) && a.is(Q) && (r.removeClass(H), n || (o = i.options.animation, i.options.animation = {
                        expand: {effects: {}},
                        collapse: {hide: !0, effects: {}}
            ...
            _toggleDisabled: function (e, t) {
                e = this.element.find(e), e.toggleClass(j, t).toggleClass(F, !t).attr(G, !t)
            },
            select: function (n) {
                var i = this;
                return n === t ? i.element.find(W).parent() : (n = i.element.find(n), n.length ? n.each(function () {
                    var n = e(this), o = n.children(v);
                    return n.hasClass(F) ? i : (i._triggerEvent(S, n) || i._updateSelected(o), t)
            ...
            append: function (e, t) {
                ...
                var o = this._insert(e, t, t.length ? t.find(B) : null);
            ...
            remove: function (e) {
                ...
                var t = this, o = e.parentsUntil(t.element, w), r = e.parent("ul");
            ...
            _first: function () {
                return this.element.children(N).first()
            },
            _last: function () {
                var e = this.element.children(N).last(), t = e.children(b);
                return t[0] ? t.children(N).last() : e
            },
            _current: function (n) {
                var i = this, o = i._focused, r = i._itemId;
                return n === t ? o : (i.element.removeAttr("aria-activedescendant"), o && o.length && (o[0].id === r && o.removeAttr("id"), o.children(v).removeClass(L)), e(n).length && (r = n[0].id || r, n.attr("id", r).children(v).addClass(L), i.element.attr("aria-activedescendant", r)), i._focused = n, t)
            },
            _keydown: function (e) {
            ...
            _nextItem: function (e) {
                ...
                var t = e.children(b), n = e.nextAll(":visible").first();
                return t[0] && (n = t.children("." + k)), n[0] || (n = e.parent(b).parent(w).next()), n[0] || (n = this._first()), n.hasClass(F) && (n = this._nextItem(n)), n
            },
            _prevItem: function (e) {
                if (!e)return this._last();
                var t, n = e.prevAll(":visible").first();
                if (n[0])for (t = n; t[0];)t = t.children(b).children("." + g), t[0] && (n = t); else n = e.parent(b).parent(w), n[0] || (n = this._last());
                return n.hasClass(F) && (n = this._prevItem(n)), n
            },
            _insert: function (t, n, i) {
                var r, a, l = this, c = e.isPlainObject(t), d = n && n[0];
                return d || (i = l.element), a = {
                    firstLevel: i.hasClass("k-panelbar"),
                    expanded: i.parent().hasClass(I),
                    length: i.children().length
                }, d && !i.length && (i = e(et.renderGroup({group: a})).appendTo(n)), t instanceof o.Observable && (t = t.toJSON()), c || e.isArray(t) ? (r = e.map(c ? [t] : t, function (t, n) {
                    return e("string" == typeof t ? t : et.renderItem({group: a, item: s(t, {index: n})}))
                }), d && n.attr(q, !1)) : (r = "string" == typeof t && "<" != t.charAt(0) ? l.element.find(t) : e(t), l._updateItemsClasses(r)), {
                    items: r,
                    group: i
                }
            },
            _toggleHover: function (t) {
                ...
                n.parents("li." + F).length || n.toggleClass("k-state-hover", t.type == P)
            },
            ...
            _updateItemClasses: function (t, n) {
                var i, r, a = this._selected, s = this.options.contentUrls, l = s && s[n], c = this.element[0];
                t = e(t).addClass("k-item").attr("role", "menuitem"), o.support.browser.msie && t.css("list-style-position", "inside").css("list-style-position", ""), t.children(f).addClass(x), r = t.children("a").addClass(m), r[0] && (r.attr("href", l), r.children(f).addClass(x)), t.filter(":not([disabled]):not([class*=k-state])").addClass("k-state-default"), t.filter("li[disabled]").addClass("k-state-disabled").attr(G, !0).removeAttr("disabled"), t.children("div").addClass(T).attr("role", "region").attr($, !0).hide().parent().attr(q, !1), r = t.children(O), r[0] && (a && a.removeAttr(Y).children(O).removeClass(R), r.addClass(R), this._selected = t.attr(Y, !0)), t.children(v)[0] || (i = "<span class='" + m + "'/>", s && s[n] && t[0].parentNode == c && (i = '<a class="k-link k-header" href="' + s[n] + '"/>'), t.contents().filter(function () {
                    return !(this.nodeName.match(h) || 3 == this.nodeType && !e.trim(this.nodeValue))
                }).wrapAll(i)), t.parent(".k-panelbar")[0] && t.children(v).addClass("k-header")
            },
            _click: function (e) {
                var t, n, i, o, r, a, s, l = this, c = l.element;
                if (!e.parents("li." + F).length && e.closest(".k-widget")[0] == c[0]) {
                    if (r = e.closest(v), a = r.closest(w), l._updateSelected(r), n = a.find(B).add(a.find(z)), i = r.attr(p), o = i && ("#" == i.charAt(i.length - 1) || -1 != i.indexOf("#" + l.element[0].id + "-")), t = !(!o && !n.length), n.data("animating"))return t;
                    if (l._triggerEvent(S, a) && (t = !0), t !== !1)return l.options.expandMode == K && l._collapseAllExpanded(a) ? t : (n.length && (s = n.is(Q), l._triggerEvent(s ? A : C, a) || (t = l._toggleItem(a, s))), t)
                }
            },
            _toggleItem: function (e, n) {
                var i, o, r = this, a = e.find(B), s = e.find(v), l = s.attr(p);
                return a.length ? (this._toggleGroup(a, n), i = !0) : (o = e.children("." + T), o.length && (i = !0, o.is(X) && l !== t ? r._ajaxRequest(e, o, n) : r._toggleGroup(o, n))), i
            },
            _toggleGroup: function (e, t) {
                var n = this, i = n.options.animation, o = i.expand, r = s({}, i.collapse), a = r && "effects" in r;
                e.is(Q) == t && (e.parent().attr(q, !t).attr($, t).toggleClass(I, !t).find("> .k-link > .k-icon").toggleClass("k-i-arrow-n", !t).toggleClass("k-panelbar-collapse", !t).toggleClass("k-i-arrow-s", t).toggleClass("k-panelbar-expand", t), o = t ? s(a ? r : s({reverse: !0}, o), {hide: !0}) : s({
                    complete: function (e) {
                        n._triggerEvent(D, e.closest(w))
                    }
                }, o), e.kendoStop(!0, !0).kendoAnimate(o))
            },
            _collapseAllExpanded: function (t) {
                var n, i = this, o = !1, r = t.find(B).add(t.find(z));
                return r.is(Q) && (o = !0), r.is(Q) || 0 === r.length || (n = t.siblings(), n.find(B).add(n.find(z)).filter(function () {
                    return e(this).is(Q)
                }).each(function (t, n) {
            ...
            _ajaxRequest: function (t, n, i) {
                var o = this, r = t.find(".k-panelbar-collapse, .k-panelbar-expand"), a = t.find(v), s = setTimeout(function () {
                    r.addClass("k-loading")
                }, 100), l = {}, c = a.attr(p);
                e.ajax({
                    type: "GET", cache: !1, url: c, dataType: "html", data: l, error: function (e, t) {
                        r.removeClass("k-loading"), o.trigger(_, {xhr: e, status: t}) && this.complete()
                    }, complete: function () {
                        clearTimeout(s), r.removeClass("k-loading")
                    }, success: function (e) {
                        function r() {
                        ...
                        o._toggleGroup(n, i), o.trigger(M, {item: t[0], contentElement: n[0]})
                    }
                })
            },
            ...
            _updateSelected: function (e) {
                var t = this, n = t.element, i = e.parent(w), o = t._selected;
                o && o.removeAttr(Y), t._selected = i.attr(Y, !0), n.find(W).removeClass(R), n.find("> ." + H + ", .k-panel > ." + H).removeClass(H), e.addClass(R), e.parentsUntil(n, w).filter(":has(.k-header)").addClass(H), t._current(i[0] ? i : null)
            },
            ...
            renderItem: function (e) {
                ...
                return Z.group(s({
                    renderItems: function (e) {
                        for (var t = "", n = 0, i = e.items, o = i ? i.length : 0, r = s({length: o}, e.group); o > n; n++)t += et.renderItem(s(e, {
                            group: r,
                            item: s({index: n}, i[n])
                        }));
                        return t
