 ...
 */
!function (e, define) {
    define(["./kendo.dataviz.chart.min", "./kendo.drawing.min"], e)
}(function () {
    return function (e, t) {
        function n(e, t) {
        ...
        var r, o, a, s, l, c, d, u, h, p, f, g, m, v, _, y, b, w, k, x, C = Math, S = window.kendo, T = S.deepExtend, D = S.util, A = D.append, I = S.drawing, E = S.geometry, P = S.dataviz, M = P.AreaSegment, F = P.Axis, B = P.AxisGroupRangeTracker, R = P.BarChart, z = P.Box2D, L = P.CategoryAxis, H = P.CategoricalChart, O = P.CategoricalPlotArea, N = P.ChartElement, V = P.CurveProcessor, U = P.DonutSegment, W = P.LineChart, j = P.LineSegment, q = P.LogarithmicAxis, G = P.NumericAxis, $ = P.PlotAreaBase, Y = P.PlotAreaFactory, Q = P.Point2D, K = P.Ring, X = P.ScatterChart, Z = P.ScatterLineChart, J = P.SeriesBinder, et = P.ShapeBuilder, tt = P.SplineSegment, nt = P.SplineAreaSegment, it = P.getSpacing, rt = P.filterSeriesByType, ot = D.limitValue, at = P.round, st = "arc", lt = "#000", ct = P.COORD_PRECISION, dt = .15, ut = C.PI / 180, ht = "gap", pt = "interpolate", ft = "log", gt = "plotAreaClick", mt = "polarArea", vt = "polarLine", _t = "polarScatter", yt = "radarArea", bt = "radarColumn", wt = "radarLine", kt = "smooth", xt = "x", Ct = "y", St = "zero", Tt = [mt, vt, _t], Dt = [yt, bt, wt], At = {
            createGridLines: function (e) {
                ...
                }, s = this.box.center(), l = new E.Circle([s.x, s.y], t), c = this.gridLinesVisual();
                for (r = 0; e.length > r; r++)o = new I.Path(a), i && (l.radius = i(e[r])), o.moveTo(l.center).lineTo(l.pointAt(e[r])), c.append(o);
                return c.children
            }, gridLineAngles: function (n, i, r, o, a) {
                var s = this, l = s.intervals(i, r, o, a), c = n.options, d = c.visible && (c.line || {}).visible !== !1;
            ...
            options: {
                ...
                var e, t, n = this, i = n.options.labels, r = i.skip || 0, o = i.step || 1, a = new z, s = n.labels;
                ...
                var r, o = this, a = o.options, s = a.categories.length, l = 0, c = s / e || 1, d = 360 / c, u = [];
                ...
                var n = this.options, i = n.minorGridLines, r = n.majorGridLines, o = t ? this.intervals(1, r.skip, r.step) : null;
                ...
                var e, t, n, i, r, o, a, s = this, l = s.options, c = l.plotBands || [], d = this._plotbandGroup = new I.Group({zIndex: -1});
                ...
                var n = this.getSlot(e, t), i = n.startAngle + 180, r = i + n.angle;
                return new E.Arc([n.c.x, n.c.y], {startAngle: i, endAngle: r, radiusX: n.r, radiusY: n.r})
        ...
        T(It.fn, At), r = {
            options: {majorGridLines: {visible: !0}}, createPlotBands: function () {
                var e, t, n, i, r, o, a = this, s = a.options, l = s.plotBands || [], c = s.majorGridLines.type, d = a.plotArea.polarAxis, u = d.majorAngles(), h = d.box.center(), p = this._plotbandGroup = new I.Group({zIndex: -1});
                for (e = 0; l.length > e; e++)t = l[e], n = {
                    fill: {color: t.color, opacity: t.opacity},
                    stroke: {opacity: t.opacity}
                }, i = a.getSlot(t.from, t.to, !0), r = new K(h, h.y - i.y2, h.y - i.y1, 0, 360), o = c === st ? et.current.createRing(r, n) : I.Path.fromPoints(a.plotBandPoints(r, u), n).close(), p.append(o);
                a.appendVisual(p)
            }, plotBandPoints: function (e, t) {
                var n, i = [], r = [], o = [e.c.x, e.c.y], a = new E.Circle(o, e.ir), s = new E.Circle(o, e.r);
                for (n = 0; t.length > n; n++)i.push(a.pointAt(t[n])), r.push(s.pointAt(t[n]));
                return i.reverse(), i.push(i[0]), r.push(r[0]), r.concat(i)
            }, createGridLines: function (e) {
                var t, n = this, i = n.options, r = n.radarMajorGridLinePositions(), o = e.majorAngles(), a = e.box.center(), s = [];
                ...
                for (o = 0; t.length > o; o++)if (r = e.y - t[o], r > 0)if (s = new E.Circle([e.x, e.y], r), i.type === st)d.append(new I.Circle(s, c)); else {
                    for (l = new I.Path(c), a = 0; n.length > a; a++)l.lineTo(s.pointAt(n[a]));
                    l.close(), d.append(l)
                }
                return d.children
            }, getValue: function (e) {
                var t, n, r, o, a, s, l, c = this, d = c.options, u = c.lineBox(), h = c.plotArea.polarAxis, p = h.majorAngles(), f = h.box.center(), g = e.distanceTo(f), m = g;
            ...
            init: function (e) {
                var t = this;
                F.fn.init.call(t, e), e = t.options, e.minorUnit = e.minorUnit || t.options.majorUnit / 2
            },
            options: {
                type: "polar",
                startAngle: 0,
                ...
                max: 360,
                labels: {margin: it(10)},
                majorGridLines: {color: lt, visible: !0, width: 1},
            ...
            reflowLabels: function () {
                var e, t, n = this, i = n.options, r = i.labels, o = r.skip || 0, a = r.step || 1, s = new z, l = n.intervals(i.majorUnit, o, a), c = n.labels;
            ...
            intervals: function (e, t, n, i) {
                var r, o, a = this, s = a.options, l = a.getDivisions(e), c = s.min, d = [];
            ...
            minorGridLineAngles: function (e, t) {
                var n = this.options, i = n.minorGridLines, r = n.majorGridLines, o = t ? this.intervals(n.majorUnit, r.skip, r.step) : null;
                return this.gridLineAngles(e, this.options.minorUnit, i.skip, i.step, o)
            },
            createPlotBands: It.fn.createPlotBands,
            plotBandSlot: function (e) {
            ...
            slot: function (e, t) {
                var n, i, r, o, a = this.options, s = 360 - a.startAngle, l = this.getSlot(e, t);
                return P.util.defined(t) || (t = e), r = C.min(e, t), o = C.max(e, t), a.reverse ? (n = r, i = o) : (n = 360 - o, i = 360 - r), n = (n + s) % 360, i = (i + s) % 360, new E.Arc([l.c.x, l.c.y], {
                    startAngle: n,
                    endAngle: i,
                    radiusX: l.r,
                    radiusY: l.r
            ...
            getValue: function (e) {
                var t = this, n = t.options, i = t.box.center(), r = e.x - i.x, o = e.y - i.y, a = C.round(C.atan2(o, r) / ut), s = n.startAngle;
                return n.reverse || (a *= -1, s *= -1), (a + s + 360) % 360
            },
            range: G.fn.range,
            labelsCount: G.fn.labelsCount,
            createAxisLabel: G.fn.createAxisLabel
        }), T(s.fn, At), l = N.extend({
            options: {gap: 1, spacing: 0}, reflow: function (e) {
            ...
            reflow: function (e) {
                var t, n, i = this, r = i.options.isReversed, o = i.children, a = o.length, s = r ? a - 1 : 0, l = r ? -1 : 1;
                for (i.box = new z, n = s; n >= 0 && a > n; n += l)t = o[n].sector, t.startAngle = e.startAngle, t.angle = e.angle
            }
        }), d = U.extend({
            init: function (e, t) {
            ...
            pointType: function () {
                ...
                var n = e.clone(), i = e.c.y;
                return n.r = i - t.y1, n.ir = i - t.y2, n
            }, reflow: H.fn.reflow, reflowPoint: function (e, t) {
                e.sector = t, e.reflow()
            }, options: {clip: !1, animation: {type: "pie"}}, createAnimation: function () {
                this.options.animation.center = this.box.toRect().center(), R.fn.createAnimation.call(this)
            }
        }), h = W.extend({
            options: {clip: !1}, pointSlot: function (e, t) {
                var n = e.c.y - t.y1, i = Q.onCircle(e.c, e.middle(), n);
                return new z(i.x, i.y, i.x, i.y)
        ...
        }), f = nt.extend({closeFill: e.noop}), g = h.extend({
            ...
            pointSlot: function (e, t) {
                var n = e.c.y - t.y1, i = Q.onCircle(e.c, e.startAngle, n);
                return new z(i.x, i.y, i.x, i.y)
            }, options: {clip: !1}
        }), v = Z.extend({pointSlot: m.fn.pointSlot, options: {clip: !1}}), _ = M.extend({
            points: function () {
                var e = this, t = e.parent, n = t.plotArea, i = n.polarAxis, r = i.box.center(), o = e.stackPoints, a = j.fn.points.call(e, o);
            ...
            closeFill: function (e) {
                ...
                var e = this.parent, t = e.plotArea, n = t.polarAxis, i = n.box.center();
                return i
            ...
            createSegment: function (e, t, n) {
                ...
                return i = r == kt ? new y(e, null, !1, t, n) : new _(e, [], t, n)
            }, createMissingValue: function (e, t) {
                var n;
                return P.hasValue(e.x) && t != pt && (n = {x: e.x, y: e.y}, t == St && (n.y = 0)), n
            }, seriesMissingValues: function (e) {
                return e.missingValues || St
            }, _hasMissingValuesGap: function () {
                var e, t = this.options.series;
                for (e = 0; t.length > e; e++)if (this.seriesMissingValues(t[e]) === ht)return !0
            }, sortPoints: function (e) {
                var t, i, r;
                if (e.sort(n), this._hasMissingValuesGap())for (r = 0; e.length > r; r++)i = e[r], i && (t = i.value, P.hasValue(t.y) || this.seriesMissingValues(i.series) !== ht || delete e[r]);
                return e
            }
        }), w = $.extend({
            init: function (e, t) {
                var n = this;
                n.valueAxisRangeTracker = new B, $.fn.init.call(n, e, t)
            }, render: function () {
                var e = this;
                e.addToLegend(e.series), e.createPolarAxis(), e.createCharts(), e.createValueAxis()
            }, alignAxes: function () {
                var e = this.valueAxis, t = e.range(), n = e.options.reverse ? t.max : t.min, i = e.getSlot(n), r = this.polarAxis.getSlot(0).c, o = e.box.translate(r.x - i.x1, r.y - i.y1);
                e.reflow(o)
            }, createValueAxis: function () {
                var e, t, n, i, r = this, s = r.valueAxisRangeTracker, l = s.query(), c = r.valueAxisOptions({
                    roundToMajorUnit: !1,
                    zIndex: -1
                });
                c.type === ft ? (n = a, i = {min: .1, max: 1}) : (n = o, i = {
                    min: 0,
                    max: 1
                ...
                var e, t = this, n = t.options.plotArea, i = t.valueAxis, r = t.polarAxis, o = t.box, a = C.min(o.width(), o.height()) * dt, s = it(n.padding || {}, a), l = o.clone().unpad(s), c = l.clone().shrink(0, l.height() / 2);
                r.reflow(l), i.reflow(c), e = i.lineBox().height() - i.box.height(), i.reflow(i.box.unpad({top: e})), t.axisBox = l, t.alignAxes(l)
            }, backgroundBox: function () {
                return this.box
            }
        }), k = w.extend({
            options: {categoryAxis: {categories: []}, valueAxis: {}}, createPolarAxis: function () {
                var e, t = this;
                e = new It(t.options.categoryAxis), t.polarAxis = e, t.categoryAxis = e, t.appendAxis(e)
            }, valueAxisOptions: function (e) {
                var t = this;
                return t._hasBarCharts && T(e, {
                    majorGridLines: {type: st},
                    minorGridLines: {type: st}
                }), t._isStacked100 && T(e, {roundToMajorUnit: !1, labels: {format: "P0"}}), T(e, t.options.valueAxis)
            }, appendChart: O.fn.appendChart, createCharts: function () {
                var e = this, t = e.filterVisibleSeries(e.series), n = e.panes[0];
                e.createAreaChart(rt(t, [yt]), n), e.createLineChart(rt(t, [wt]), n), e.createBarChart(rt(t, [bt]), n)
            }, chartOptions: function (e) {
                var t, n, i = {series: e}, r = e[0];
                ...
                var i, r, o = this, a = t._eventCoordinates(n), s = new Q(a.x, a.y);
            ...
            options: {xAxis: {}, yAxis: {}}, createPolarAxis: function () {
                var e, t = this;
                e = new s(t.options.xAxis), t.polarAxis = e, t.axisX = e, t.appendAxis(e)
            }, valueAxisOptions: function (e) {
                var t = this;
                return T(e, {majorGridLines: {type: st}, minorGridLines: {type: st}}, t.options.yAxis)
            }, createValueAxis: function () {
                var e = this;
                w.fn.createValueAxis.call(e), e.axisY = e.valueAxis
                ...
                if (0 !== e.length) {
                    var n = this, i = new m(n, {series: e});
                    n.appendChart(i, t)
                }
            }, createAreaChart: function (e, t) {
                if (0 !== e.length) {
                    var n = this, i = new b(n, {series: e});
                    n.appendChart(i, t)
                }
            }, click: function (t, n) {
                var i, r, o = this, a = t._eventCoordinates(n), s = new Q(a.x, a.y);
            ...
            RadarAreaChart: g,
            RadarBarChart: u,
            RadarCategoryAxis: It,
            RadarClusterLayout: l,
            RadarLineChart: h,
            RadarNumericAxis: o,
            RadarPlotArea: k,
            SplinePolarAreaSegment: y,
