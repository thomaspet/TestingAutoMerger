 ...
 */
!function (e, define) {
    define(["./kendo.datepicker.min", "./kendo.numerictextbox.min", "./kendo.dropdownlist.min", "./kendo.binder.min"], e)
}(function () {
    return function (e, t) {
        function n(t, i) {
        ...
        function i(e) {
            var t, n, i, o, r, s;
            if (e && e.length)for (s = [], t = 0, n = e.length; n > t; t++)i = e[t], r = i.text || i.value || i, o = null == i.value ? i.text || i : i.value, s[t] = {
                text: r,
                value: o
            };
            return s
        ...
        var c = window.kendo, h = c.ui, d = e.proxy, u = "kendoPopup", f = "init", p = "refresh", g = "change", m = ".kendoFilterMenu", v = "Is equal to", _ = "Is not equal to", y = {
            ...
            _createForm: function (t) {
                var n = this, o = n.options, r = n.operators || {}, s = n.type;
            ...
            _bind: function (e) {
                var t, n, i, o, r = this, s = e.filters, a = !1, l = 0, c = r.filterModel;
                for (t = 0, n = s.length; n > t; t++)o = s[t], o.field == r.field ? (c.set("logic", e.logic), i = c.filters[l], i || (c.filters.push({field: r.field}), i = c.filters[l]), i.set("value", r._parse(o.value)), i.set("operator", o.operator), l++, a = !0) : o.filters && (a = a || r._bind(o));
                return a
            },
            ...
            _merge: function (e) {
                var t, i, o, r = this, s = e.logic || "and", a = this._stripFilters(e.filters), l = r.dataSource.filter() || {
                        filters: [],
                        logic: "and"
                    };
                for (n(l, r.field), i = 0, o = a.length; o > i; i++)t = a[i], t.value = r._parse(t.value);
                return a.length && (l.filters.length ? (e.filters = a, "and" !== l.logic && (l.filters = [{
                    logic: l.logic,
                    filters: l.filters
                }], l.logic = "and"), l.filters.push(a.length > 1 ? e : a[0])) : (l.filters = a, l.logic = s)), l
            },
            filter: function (e) {
        ...
        }), D = ".kendoFilterMultiCheck", P = c.data.DataSource, M = x.extend({
            init: function (t, n) {
                var i, o;
                x.fn.init.call(this, t, n), n = this.options, this.element = e(t), i = this.field = this.options.field || this.element.attr(c.attr("field")), o = n.checkSource, this._foreignKeyValues() ? (this.checkSource = P.create(n.values), this.checkSource.fetch()) : n.forceUnique ? (o = n.dataSource.options, delete o.pageSize, this.checkSource = P.create(o), this.checkSource.reader.data = l(this.checkSource.reader.data, this.field)) : this.checkSource = P.create(o), this.dataSource = n.dataSource, this.model = this.dataSource.reader.model, this._parse = function (e) {
                    return e + ""
                ...
                var e = this.element, t = e.addClass("k-with-icon k-filterable").find(".k-grid-filter");
                ...
                var e = this, t = this.options.forceUnique, n = this.options;
                this.pane = n.pane, this.pane && (this._isMobile = !0), this._createForm(), this._foreignKeyValues() ? this.refresh() : t && !this.checkSource.options.serverPaging && this.dataSource.data().length ? (this.checkSource.data(a(this.dataSource.data(), this.field)), this.refresh()) : (this._attachProgress(), this.checkSource.fetch(function () {
                    e.refresh.call(e)
                ...
                var t, n, i = this.options, o = "<ul class='k-reset k-multicheck-wrap'></ul><button type='submit' class='k-button k-primary'>" + i.messages.filter + "</button>";
                ...
                })) : i.appendToElement ? (this.popup = this.element.closest(".k-popup").data(u), this.element.append(this.form)) : this.popup = this.form.kendoPopup({anchor: this._link}).data(u)
            }, createCheckAllItem: function () {
                var t = this.options, n = c.template(t.itemTemplate({
                    field: "all",
                    mobile: this._isMobile
                })), i = e(n({all: t.messages.checkAll}));
                ...
                var t = this.options.forceUnique, n = this.dataSource, i = this.getFilterArray();
                this._link && this._link.toggleClass("k-state-active", 0 !== i.length), this.form && (!e || !t || e.sender !== n || n.options.serverPaging || "itemchange" != e.action && "add" != e.action && "remove" != e.action || this._foreignKeyValues() || (this.checkSource.data(a(this.dataSource.data(), this.field)), this.container.empty()), this.container.is(":empty") && this.createCheckBoxes(), this.checkValues(i), this.trigger(p))
            }, getFilterArray: function () {
                var t, n = e.extend(!0, {}, {filters: [], logic: "and"}, this.dataSource.filter());
                return r(n, this.field), t = s(n)
            }, createCheckBoxes: function () {
                var e, t, n, i = this.options, o = {
                    field: this.field,
                    format: i.format,
                    mobile: this._isMobile,
                    type: this.type
                };
                this.options.forceUnique ? this._foreignKeyValues() ? (e = this.checkSource.data(), o.valueField = "value", o.field = "text") : e = this.checkSource.data() : e = this.checkSource.view(), t = c.template(i.itemTemplate(o)), n = c.render(t, e), i.checkAll && (this.createCheckAllItem(), this.container.on(g + D, ":checkbox", d(this.updateCheckAllState, this))), this.container.append(n)
            }, checkAll: function () {
                ...
                e(e.grep(this.container.find(":checkbox").prop("checked", !1), function (i) {
                    var o, r, s = !1;
                    if (!e(i).is(".k-check-all"))for (o = n._parse(e(i).val()), r = 0; t.length > r; r++)if (s = "date" == n.type ? t[r].getTime() == o.getTime() : t[r] == o)return s
                })).prop("checked", !0), this.updateCheckAllState()
            }, _filter: function (t) {
                var n, i;
                t.preventDefault(), t.stopPropagation(), n = {logic: "or"}, i = this, n.filters = e.map(this.form.find(":checkbox:checked:not(.k-check-all)"), function (t) {
                    return {value: e(t).val(), operator: "eq", field: i.field}
                ...
                itemTemplate: function (e) {
                    var n = e.field, i = e.format, o = e.valueField, r = e.mobile, s = "";
                ...
                checkAll: !0,
                appendToElement: !1,
                messages: {checkAll: "Select All", clear: "Clear", filter: "Filter"},
                forceUnique: !0,
                animations: {left: "slide", right: "slide:right"}
            }, events: [f, p]
        });
