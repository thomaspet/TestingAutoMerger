 ...
 */
!function (e, define) {
    define(["./kendo.pivotgrid.min", "./kendo.menu.min", "./kendo.window.min", "./kendo.treeview.min", "./kendo.dropdownlist.min"], e)
}(function () {
    return function (e, t) {
        function n(e, t) {
            var n, i, o = [];
        ...
        function i(e, t, n) {
            var i, o, r, a;
            if (!e)return [];
            for (e = e.filters, i = 0, o = [], r = e.length; r > i; i++)a = e[i].operator, (n || "in" === a) && a !== n || e[i].field !== t || o.push(e[i]);
            return o
        }

        function o(t, n, o) {
            var r, a = 0, s = o.length;
            if (t = i(t, n, "in")[0])for (r = t.value.split(","); s > a; a++)o[a].checked = e.inArray(o[a].uniqueName, r) >= 0; else for (; s > a; a++)o[a].checked = !0
        }

        function r(e, t) {
            var n, i = e.length;
            for (n = 0; i > n; n++)e[n].checked && 0 !== e[n].level() && t.push(e[n].uniqueName), e[n].hasChildren && r(e[n].children.view(), t)
        }

        var a = window.kendo, s = a.ui, l = "kendoContextMenu", c = e.proxy, d = ".kendoPivotFieldMenu", h = s.Widget, u = h.extend({
            init: function (e, t) {
                h.fn.init.call(this, e, t), this._dataSource(), this._layout(), a.notify(this)
            },
            events: [],
            options: {
                name: "PivotFieldMenu",
            ...
            _initFilterForm: function () {
                var e = this.menu.element.find(".k-filter-item"), t = c(this._filter, this);
            ...
            _setFilterForm: function (e) {
                var t = this._filterOperator, n = "", i = "";
                e && (n = e.operator, i = e.value), t.value(n), t.value() || t.select(0), this._filterValue.val(i)
            },
            _clearFilters: function (e) {
                var t, n, o = this.dataSource.filter() || {}, r = 0;
                for (o.filters = o.filters || [], t = i(o, e), n = t.length; n > r; r++)o.filters.splice(o.filters.indexOf(t[r]), 1);
                return o
            },
            _filter: function (e) {
                var n, i, o = this, r = o._filterValue.val();
                return e.preventDefault(), r ? (n = {
                    field: o.currentMember,
                    operator: o._filterOperator.value(),
                    value: r
                }, i = o._clearFilters(o.currentMember), i.filters.push(n), o.dataSource.filter(i), o.menu.close(), t) : (o.menu.close(), t)
            },
            _reset: function (e) {
                var t = this, n = t._clearFilters(t.currentMember);
                e.preventDefault(), n.filters[0] || (n = {}), t.dataSource.filter(n), t._setFilterForm(null), t.menu.close()
            },
            _sort: function (e) {
                var t = this.currentMember, i = this.dataSource.sort() || [];
                i = n(i, t), i.push({field: t, dir: e}), this.dataSource.sort(i), this.menu.close()
            },
            ...
            _createWindow: function () {
                ...
                this.includeWindow = e(a.template(g)({messages: t})).on("click" + d, ".k-button-ok", c(this._applyIncludes, this)).on("click" + d, ".k-button-cancel", c(this._closeWindow, this)), this.includeWindow = new s.Window(this.includeWindow, {
                    title: t.title,
                    visible: !1,
                    resizable: !1,
            ...
            _applyIncludes: function (e) {
                var t, n = [], o = this.treeView.dataSource.view(), a = o[0].checked, s = this.dataSource.filter(), l = i(s, this.currentMember, "in")[0];
                r(o, n), l && (a ? (s.filters.splice(s.filters.indexOf(l), 1), s.filters.length || (s = {})) : l.value = n.join(","), t = s), n.length && (t || a || (t = {
            ...
            _treeViewDataSource: function () {
                ...
                return a.data.HierarchicalDataSource.create({
                    schema: {
                        ...
                        read: function (t) {
                            var n = {}, i = e.treeView.dataSource.get(t.data.uniqueName), r = t.data.uniqueName;
                            r ? (n.memberUniqueName = i.uniqueName.replace(/\&/g, "&amp;"), n.treeOp = 1) : n.levelUniqueName = e.currentMember + ".[(ALL)]", e.dataSource.schemaMembers(n).done(function (n) {
                                o(e.dataSource.filter(), e.currentMember, n), t.success(n)
                            }).fail(t.error)
                        }
                    }
                })
            ...
            destroy: function () {
                h.fn.destroy.call(this), this.menu && (this.menu.destroy(), this.menu = null), this.treeView && (this.treeView.destroy(), this.treeView = null), this.includeWindow && (this.includeWindow.destroy(), this.includeWindow = null), this.wrapper = null, this.element = null
            }
