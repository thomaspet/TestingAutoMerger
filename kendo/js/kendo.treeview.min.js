 ...
 */
!function (e, define) {
    define(["./kendo.data.min", "./kendo.treeview.draganddrop.min"], e)
}(function () {
    return function (e, t) {
        function n(e) {
            return function (t) {
        ...
        c = n(".k-group"), d = n(".k-group,.k-content"), u = function (e) {
            ...
            _syncHtmlAndDataSource: function (e, t) {
                var n, i, r, a, s, l, c, d;
                for (e = e || this.root, t = t || this.dataSource, n = t.view(), i = f.attr("uid"), r = f.attr("expanded"), a = this.options.checkboxes, s = e.children("li"), l = 0; s.length > l; l++)d = n[l], c = s.eq(l), c.attr("role", "treeitem").attr(i, d.uid), d.expanded = "true" === c.attr(r), a && (d.checked = o(c).prop(E)), this._syncHtmlAndDataSource(c.children("ul"), d.children)
            },
            _animation: function () {
                ...
                } : t.collapse && "effects" in t.collapse || (t.collapse = m({reverse: !0}, t.expand)), m(t.collapse, {hide: !0}), e.animation = t
            },
            _dragging: function () {
                var t, n = this.options.dragAndDrop, i = this.dragging;
                n && !i ? (t = this, this.dragging = new p.HierarchicalDragAndDrop(this.element, {
                    ...
                    hintText: b(this._hintText, this),
                    ...
                    dragstart: function (e) {
                        return t.trigger(z, {sourceNode: e[0]})
                    },
                    drag: function (e) {
                        t.trigger(B, {
                    ...
                    dragend: function (e) {
                        function n(n) {
                            t.updateIndeterminate(), t.trigger(R, {
                                originalEvent: e.originalEvent,
                                sourceNode: n && n[0],
                                destinationNode: o[0],
                                dropPosition: r
                        ...
                        var i = e.source, o = e.destination, r = e.position;
            ...
            _hintText: function (e) {
                return this.templates.dragClue({item: this.dataItem(e), treeview: this.options})
            },
            _templates: function () {
            ...
            _bindDataSource: function () {
                this._refreshHandler = b(this.refresh, this), this._errorHandler = b(this._error, this), this.dataSource.bind(D, this._refreshHandler), this.dataSource.bind(M, this._errorHandler)
            },
            ...
            _dataSource: function (e) {
                ...
                var n = this, i = n.options, o = i.dataSource;
                o = _(o) ? {data: o} : o, n._unbindDataSource(), o.fields || (o.fields = [{field: "text"}, {field: "url"}, {field: "spriteCssClass"}, {field: "imageUrl"}]), n.dataSource = o = w.create(o), e && (o.fetch(), t(o.view())), n._bindDataSource()
            },
            events: [z, B, L, R, F, A, I, C, D, T, S],
            options: {
                name: "TreeView",
                dataSource: {},
            ...
            _accessors: function () {
                var e, t, n, i = this, o = i.options, r = i.element;
                for (e in $)t = o[$[e]], n = r.attr(f.attr(e + "-field")), !t && n && (t = n), t || (t = e), _(t) || (t = [t]), o[$[e]] = t
            },
            _fieldAccessor: function (t) {
                var n = this.options[$[t]], i = n.length, o = "(function(item) {";
            ...
            _trigger: function (e, t) {
                return this.trigger(e, {node: t.closest(W)[0]})
            },
            _setChecked: function (t, n) {
                if (t && e.isFunction(t.view))for (var i = 0, o = t.view(); o.length > i; i++)o[i][E] = n, o[i].children && this._setChecked(o[i].children, n)
            },
            _setIndeterminate: function (e) {
                ...
                if (r.length && (t = o(r.children()), n = t.length)) {
                    ...
                    return o(e).data(P, !a).prop(P, !a).prop(E, a && t[0].checked)
                }
            },
            ...
            _checkboxChange: function (t) {
                var n = e(t.target), i = n.prop(E), o = n.closest(W), r = this.dataItem(o);
                r.checked != i && (r.set(E, i), this._trigger(S, o))
            },
            ...
            focus: function () {
                var e, t = this.wrapper, n = t[0], i = [], o = [], r = document.documentElement;
                do n = n.parentNode, n.scrollHeight > n.clientHeight && (i.push(n), o.push(n.scrollTop)); while (n != r);
                for (t.focus(), e = 0; i.length > e; e++)i[e].scrollTop = o[e]
            },
            _blur: function () {
            ...
            parent: function (t) {
                var n, i, o = /\bk-treeview\b/, r = /\bk-item\b/;
                typeof t == j && (t = this.element.find(t)), Y(t) || (t = t[0]), i = r.test(t.className);
            ...
            _nextVisible: function (e) {
                ...
                var n, i = this, o = i._expanded(e);
                return e.length && e.is(":visible") ? o ? (n = c(e).children().first(), n.length || (n = t(e))) : n = t(e) : n = i.root.children().eq(0), i._enabled(n) || (n = i._nextVisible(n)), n
            },
            ...
            _keydown: function (n) {
                var i, o = this, r = n.keyCode, a = o.current(), s = o._expanded(a), l = a.find(".k-checkbox:first :checkbox"), c = f.support.isRtl(o.element);
                n.target == n.currentTarget && (!c && r == x.RIGHT || c && r == x.LEFT ? s ? i = o._nextVisible(a) : o.expand(a) : !c && r == x.LEFT || c && r == x.RIGHT ? s ? o.collapse(a) : (i = o.parent(a), o._enabled(i) || (i = t)) : r == x.DOWN ? i = o._nextVisible(a) : r == x.UP ? i = o._previousVisible(a) : r == x.HOME ? i = o._nextVisible(e()) : r == x.END ? i = o._previousVisible(e()) : r == x.ENTER ? a.find(".k-in:first").hasClass("k-state-selected") || o._trigger(C, a) || o.select(a) : r == x.SPACEBAR && l.length && (l.prop(E, !l.prop(E)).data(P, !1).prop(P, !1), o._checkboxChange({target: l}), i = a), i && (n.preventDefault(), a[0] != i[0] && (o._trigger(T, i), o.current(i))))
            },
            _click: function (t) {
                var n, i = this, o = e(t.currentTarget), r = d(o.closest(W)), a = o.attr("href");
                n = a ? "#" == a || a.indexOf("#" + this.element.id + "-") >= 0 : r.length && !r.children().length, n && t.preventDefault(), o.hasClass(".k-state-selected") || i._trigger(C, o) || i.select(o)
            },
            _wrapper: function () {
                var e, t, n = this, i = n.element, o = "k-widget k-treeview";
                i.is("ul") ? (e = i.wrap("<div />").parent(), t = i) : (e = i, t = e.children("ul").eq(0)), n.wrapper = e.addClass(o), n.root = t
            },
            _group: function (e) {
                var t = this, n = e.hasClass(V), i = {
                    firstLevel: n,
            ...
            _insertNode: function (t, n, i, o, r) {
                ...
                for (d = 0; t.length > d; d++)u = t[d], u.index = n + d, m += h._renderItem({group: g, item: u});
                if (l = e(m), l.length) {
                    ...
                    }), f.length || (f = e(h._renderGroup({group: g})).appendTo(i)), o(l, f), i.hasClass("k-item") && (s(i), h._updateNodeClasses(i)), h._updateNodeClasses(l.prev().first()), h._updateNodeClasses(l.next().last()), d = 0; t.length > d; d++)u = t[d], u.hasChildren && (a = u.children.data(), a.length && h._insertNode(a, u.index, l.eq(d), v, !h._expanded(l.eq(d))));
                    return l
                }
            },
            _updateNodes: function (t, n) {
                ...
                var o, r, a, s, l, c, u, h = this, f = {
                    treeview: h.options,
                    item: s
                }, g = "expanded" != n && "checked" != n;
                if ("selected" == n)s = t[0], r = h.findByUid(s.uid).find(".k-in:first").removeClass("k-state-hover").toggleClass("k-state-selected", s[n]).end(), s[n] && h.current(r), r.attr(G, !!s[n]); else {
                    for (u = e.map(t, function (e) {
                        return h.findByUid(e.uid).children("div")
                    }), g && h.angular("cleanup", function () {
                        return {elements: u}
                    }), o = 0; t.length > o; o++)f.item = s = t[o], a = u[o], r = a.parent(), g && a.children(".k-in").html(h.templates.itemContent(f)), n == E ? (l = s[n], i(a, l), h.options.checkboxes.checkChildren && (i(r.children(".k-group"), l), h._setChecked(s.children, l), h._bubbleIndeterminate(r))) : "expanded" == n ? h._toggle(r, s, s[n]) : "enabled" == n && (r.find(".k-checkbox :checkbox").prop("disabled", !s[n]), c = !d(r).is(U), r.removeAttr(q), s[n] || (s.selected && s.set("selected", !1), s.expanded && s.set("expanded", !1), c = !0, r.attr(G, !1).attr(q, !0)), h._updateNodeClasses(r, {}, {
                        enabled: s[n],
                        expanded: !c
                    })), a.length && this.trigger("itemChange", {item: a, data: s, ns: p});
                    g && h.angular("compile", function () {
                        return {
                            elements: u, data: e.map(t, function (e) {
                                return [{dataItem: e}]
                            })
                        }
                    })
            ...
            _appendItems: function (e, t, n) {
                var i = c(n), o = i.children(), r = !this._expanded(n);
                typeof e == H && (e = o.length), this._insertNode(t, e, n, function (t, n) {
                    e >= o.length ? t.appendTo(n) : t.insertBefore(o.eq(e))
                }, r), this._expanded(n) && (this._updateNodeClasses(n), c(n).css("display", "block"))
            },
            _refreshChildren: function (e, t, n) {
                var i, o, r, a = this.options, l = a.loadOnDemand, d = a.checkboxes && a.checkboxes.checkChildren;
                if (c(e).empty(), t.length)for (this._appendItems(n, t, e), o = c(e).children(), l && d && this._bubbleIndeterminate(o.last()), i = 0; o.length > i; i++)r = o.eq(i), this.trigger("itemChange", {
                    item: r.children("div"),
            ...
            _refreshRoot: function (t) {
                var n, i, o, r = this._renderGroup({items: t, group: {firstLevel: !0, expanded: !0}});
                for (this.root.length ? (this._angularItems("cleanup"), n = e(r), this.root.attr("class", n.attr("class")).html(n.html())) : this.root = this.wrapper.html(r).children("ul"), this.root.attr("role", "tree"), i = 0; t.length > i; i++)o = this.root.children(".k-item"), this.trigger("itemChange", {
                    item: o.eq(i),
                    data: t[i],
                    ns: p
                });
            ...
            refresh: function (e) {
                var n, i, o = e.node, r = e.action, a = e.items, s = this.wrapper, l = this.options, c = l.loadOnDemand, d = l.checkboxes && l.checkboxes.checkChildren;
                if (e.field) {
                    if (!a[0] || !a[0].level)return;
                    return this._updateNodes(a, e.field)
                }
                if (o && (s = this.findByUid(o.uid), this._progress(s, !1)), d && "remove" != r) {
                    for (i = !1, n = 0; a.length > n; n++)if ("checked" in a[n]) {
                        i = !0;
                        break
                    }
                    if (!i && o && o.checked)for (n = 0; a.length > n; n++)a[n].checked = !0
                }
                if ("add" == r ? this._appendItems(e.index, a, s) : "remove" == r ? this._remove(this.findByUid(a[0].uid), !1) : "itemchange" == r ? this._updateNodes(a) : "itemloaded" == r ? this._refreshChildren(s, a, e.index) : this._refreshRoot(a), "remove" != r)for (n = 0; a.length > n; n++)(!c || a[n].expanded) && a[n].load();
                this.trigger(F, {node: o ? s : t})
            },
            _error: function (e) {
            ...
            current: function (n) {
                var i = this, o = i._current, r = i.element, a = i._ariaId;
                return arguments.length > 0 && n && n.length ? (o && (o[0].id === a && o.removeAttr("id"), o.find(".k-in:first").removeClass("k-state-focused")), o = i._current = e(n, r).closest(W), o.find(".k-in:first").addClass("k-state-focused"), a = o[0].id || a, a && (i.wrapper.removeAttr("aria-activedescendant"), o.attr("id", a), i.wrapper.attr("aria-activedescendant", a)), t) : (o || (o = i._nextVisible(e())), o)
            },
            select: function (n) {
                var i = this, o = i.element;
                return arguments.length ? (n = e(n, o).closest(W), o.find(".k-state-selected").each(function () {
                    var t = i.dataItem(this);
                    t ? (t.set("selected", !1), delete t.selected) : e(this).removeClass("k-state-selected")
                }), n.length && i.dataItem(n).set("selected", !0), i.trigger(D), t) : o.find(".k-state-selected").closest(W)
            },
            _toggle: function (e, t, n) {
                var i, o, r = this.options, a = d(e), s = n ? "expand" : "collapse";
                a.data("animating") || this._trigger(s, e) || (this._expanded(e, n), i = t && t.loaded(), o = !a.children().length, !n || i && !o ? (this._updateNodeClasses(e, {}, {expanded: n}), n || a.css("height", a.height()).css("height"), a.kendoStop(!0, !0).kendoAnimate(m({reset: !0}, r.animation[s], {
                    complete: function () {
                        n && a.css("height", "")
                    }
                }))) : (r.loadOnDemand && this._progress(e, !0), a.remove(), t.load()))
            },
            toggle: function (t, n) {
            ...
            _expanded: function (e, n) {
                var i = f.attr("expanded"), o = this.dataItem(e);
                return 1 == arguments.length ? "true" === e.attr(i) || o && o.expanded : (d(e).data("animating") || (o && (o.set("expanded", n), n = o.expanded), n ? (e.attr(i, "true"), e.attr("aria-expanded", "true")) : (e.removeAttr(i), e.attr("aria-expanded", "false"))), t)
            },
            ...
            text: function (e, n) {
                var i = this.dataItem(e), o = this.options[$.text], r = i.level(), a = o.length, s = o[Math.min(r, a - 1)];
            ...
            _dataSourceMove: function (t, n, i, o) {
                var r, a = this._objectOrSelf(i || n), s = a.dataSource, l = e.Deferred().resolve().promise();
                return i && i[0] != a.element[0] && (r = a.dataItem(i), r.loaded() || (a._progress(i, !0), l = r.load()), i != this.root && (s = r.children, s && s instanceof w || (r._initChildren(), r.loaded(!0), s = r.children))), t = this._toObservableData(t), o.call(this, s, t, l)
            },
            _toObservableData: function (t) {
                var n, i, o = t;
                return (t instanceof window.jQuery || Y(t)) && (n = this._objectOrSelf(t).dataSource, i = e(t).attr(f.attr("uid")), o = n.getByUid(i), o && (o = n.remove(o))), o
            },
            ...
            append: function (t, n, i) {
                var o = this, r = o.root;
                return n && (r = c(n)), o._dataSourceMove(t, r, n, function (t, r, a) {
                    function s() {
                        n && o._expanded(n, !0);
                        var e = t.data(), i = Math.max(e.length, 0);
                        return o._insert(e, r, i)
                    }
            ...
            _remove: function (t, n) {
                ...
                }), i = t.parent().parent(), o = t.prev(), r = t.next(), t[n ? "detach" : "remove"](), i.hasClass("k-item") && (s(i), a._updateNodeClasses(i)), a._updateNodeClasses(o), a._updateNodeClasses(r), t
            },
            remove: function (e) {
            ...
            findByUid: function (t) {
                var n, i, o = this.element.find(".k-item"), r = f.attr("uid");
                for (i = 0; o.length > i; i++)if (o[i].getAttribute(r) == t) {
                    n = o[i];
                    break
                }
                return e(n)
            ...
            expandPath: function (n, i) {
                ...
                var r, a, s;
                for (n = n.slice(0), r = this, a = this.dataSource, s = a.get(n[0]), i = i || e.noop; n.length > 0 && s && (s.expanded || s.loaded());)s.set("expanded", !0), n.shift(), s = a.get(n[0]);
                return n.length ? (a.bind("change", function (e) {
                    var t, s = e.node && e.node.id;
                    s && s === n[0] && (n.shift(), n.length ? (t = a.get(n[0]), o(t, i, r)) : i.call(r))
                }), o(s, i, r), t) : i.call(r)
            },
            _parents: function (e) {
            ...
            expandTo: function (e) {
                var t, n;
                for (e instanceof f.data.Node || (e = this.dataSource.get(e)), t = this._parents(e), n = 0; t.length > n; n++)t[n].set("expanded", !0)
            },
            ...
            _renderGroup: function (e) {
                ...
                return e.renderItems = function (e) {
                    var n = "", i = 0, o = e.items, r = o ? o.length : 0, a = e.group;
                    for (a.length = r; r > i; i++)e.group = a, e.item = o[i], e.item.index = i, n += t._renderItem(e);
                    return n
