 ...
 */
!function (e, define) {
    define(["./kendo.core.min", "./kendo.data.odata.min", "./kendo.data.xml.min"], e)
}(function () {
    return function (e, t) {
        function n(e, t, n, i) {
            return function (r) {
                var o, a = {};
                for (o in r)a[o] = r[o];
                a.field = i ? n + "." + r.field : n, t == bt && e._notifyChange && e._notifyChange(a), e.trigger(t, a)
            }
        }
        ...
        function a(e, n) {
            if (e) {
                var i = typeof e === pt ? {field: e, dir: n} : e, r = rt(i) ? i : i !== t ? [i] : [];
        ...
        function s(e) {
            ...
            if (o)for (t = 0, n = o.length; n > t; t++)i = o[t], r = i.operator, r && typeof r === pt && (i.operator = U[r.toLowerCase()] || r), s(i)
        }

        function l(e) {
            return e && !it(e) ? ((rt(e) || !e.filters) && (e = {logic: "and", filters: rt(e) ? e : [e]}), s(e), e) : t
        }
        ...
        function w(e) {
            var t, n, i, r, o, a = [];
            for (t = 0, n = e.length; n > t; t++)if (o = e.at(t), o.hasSubgroups)a = a.concat(w(o.items)); else for (i = o.items, r = 0; i.length > r; r++)a.push(i.at(r));
            return a
        }

        function k(e, t) {
            var n, i, r;
            if (t)for (n = 0, i = e.length; i > n; n++)r = e.at(n), r.hasSubgroups ? k(r.items, t) : r.items = new jt(r.items, t)
        }
        ...
        function T(e, n, i, r, o) {
            var a, s, l, c;
            for (a = 0, s = e.length; s > a; a++)if (l = e[a], l && !(l instanceof r))if (l.hasSubgroups === t || o) {
        ...
        function D(e, t) {
            var n, i, r;
            for (n = 0, i = e.length; i > n; n++)if (r = e.at(n), r.uid == t.uid)return e.splice(n, 1), r
        }
        ...
        function P(e, t) {
            ...
            if (e.filters)for (o.filters = [], n = 0, i = e.filters.length; i > n; n++)o.filters[n] = P(e.filters[n], t); else o.field = M(t.fields, o.field);
            return o
        }
        ...
        function F(e, t) {
            ...
            for (n = 0, i = e.length; i > n; n++) {
                r = {}, o = e[n];
                for (a in o)r[a] = o[a];
                r.field = M(t.fields, r.field), r.aggregates && rt(r.aggregates) && (r.aggregates = F(r.aggregates, t)), s.push(r)
            }
            return s
        }
        ...
        function H(e) {
            return function () {
                var t = this._data, n = Y.fn[e].apply(this, Ht.call(arguments));
        ...
        var L, O, N, V, U, W, j, q, G, $, Y, Q, K, X, Z, J, et = e.extend, tt = e.proxy, nt = e.isPlainObject, it = e.isEmptyObject, rt = e.isArray, ot = e.grep, at = e.ajax, st = e.each, lt = e.noop, ct = window.kendo, dt = ct.isFunction, ut = ct.Observable, ht = ct.Class, pt = "string", ft = "function", gt = "create", mt = "read", vt = "update", _t = "destroy", bt = "change", yt = "sync", wt = "get", kt = "error", xt = "requestStart", Ct = "progress", St = "requestEnd", Tt = [gt, mt, vt, _t], Dt = function (e) {
            return e
        }, At = ct.getter, Et = ct.stringify, It = Math, Mt = [].push, Pt = [].join, Ft = [].pop, zt = [].splice, Rt = [].shift, Ht = [].slice, Bt = [].unshift, Lt = {}.toString, Ot = ct.support.stableSort, Nt = /^\/Date\((.*?)\)\/$/, Vt = /(\r+|\n+)/g, Ut = /(?=['\\])/g, Wt = ut.extend({
            init: function (e, t) {
                var n = this;
                n.type = t || qt, ut.fn.init.call(n), n.length = e.length, n.wrapAll(e, n)
            }, at: function (e) {
                return this[e]
            }, toJSON: function () {
                ...
                var n, i = this;
                return null !== e && "[object Object]" === Lt.call(e) && (n = e instanceof i.type || e instanceof Yt, n || (e = e instanceof qt ? e.toJSON() : e, e = new i.type(e)), e.parent = t, e.bind(bt, function (e) {
                    i.trigger(bt, {
                        field: e.field,
                        node: e.node,
                        index: e.index,
                ...
                return e = Mt.apply(this, n), this.trigger(bt, {action: "add", index: t, items: n}), e
            }, slice: Ht, sort: [].sort, join: Pt, pop: function () {
                var e = this.length, t = Ft.apply(this);
                return e && this.trigger(bt, {action: "remove", index: e - 1, items: [t]}), t
            }, splice: function (e, t, n) {
                var i, r, o, a = this.wrapAll(Ht.call(arguments, 2));
                if (i = zt.apply(this, [e, t].concat(a)), i.length)for (this.trigger(bt, {
                    action: "remove",
                    index: e,
                    items: i
                }), r = 0, o = i.length; o > r; r++)i[r] && i[r].children && i[r].unbind(bt);
                return n && this.trigger(bt, {action: "add", index: e, items: a}), i
            }, shift: function () {
                var e = this.length, t = Rt.apply(this);
                return e && this.trigger(bt, {action: "remove", index: 0, items: [t]}), t
            }, unshift: function () {
                var e, t = this.wrapAll(arguments);
                return e = Bt.apply(this, t), this.trigger(bt, {action: "add", index: 0, items: t}), e
            }, indexOf: function (e) {
                var t, n, i = this;
            ...
            init: function (e, t) {
                ut.fn.init.call(this), this.type = t || qt;
            ...
            init: function (e) {
                ...
                var e, t, n = {};
                for (t in this)this.shouldSerialize(t) && (e = this[t], (e instanceof qt || e instanceof Wt) && (e = e.toJSON()), n[t] = e);
                return n
            }, get: function (e) {
                var t, n = this;
                return n.trigger(wt, {field: e}), t = "this" === e ? n : ct.getter(e, !0)(n)
            }, _set: function (e, t) {
                var n, i, r, o = this, a = e.indexOf(".") >= 0;
                if (a)for (n = e.split("."), i = ""; n.length > 1;) {
                    if (i += n.shift(), r = ct.getter(i, !0)(o), r instanceof qt)return r.set(n.join("."), t), a;
                    i += "."
                }
                return ct.setter(e)(o, t), a
            }, set: function (e, t) {
                var n = this, i = e.indexOf(".") >= 0, r = ct.getter(e, !0)(n);
                r !== t && (n.trigger("set", {field: e, value: t}) || (i || (t = n.wrap(t, e, function () {
                    return n
                })), (!n._set(e, t) || e.indexOf("(") >= 0 || e.indexOf("[") >= 0) && n.trigger(bt, {field: e})))
            }, parent: lt, wrap: function (e, t, i) {
                var r, o, a = this, s = Lt.call(e);
                return null == e || "[object Object]" !== s && "[object Array]" !== s || (r = e instanceof Wt, o = e instanceof Y, "[object Object]" !== s || o || r ? ("[object Array]" === s || r || o) && (r || o || (e = new Wt(e)), e.parent() != i() && e.bind(bt, n(a, bt, t, !1))) : (e instanceof qt || (e = new qt(e)), e.parent() != i() && (e.bind(wt, n(a, wt, t, !0)), e.bind(bt, n(a, bt, t, !0)))), e.parent = i), e
            }
        }), Gt = {
            number: function (e) {
            ...
            init: function (n) {
                var i, r, o = this;
                if ((!n || e.isEmptyObject(n)) && (n = e.extend({}, o.defaults, n), o._initializers))for (i = 0; o._initializers.length > i; i++)r = o._initializers[i], n[r] = o.defaults[r]();
                ...
                return e = a[e], e || (e = r(a, o)), e && (n = e.parse, !n && e.type && (n = Gt[e.type.toLowerCase()])), n ? n(t) : t
        ...
        Yt.define = function (e, n) {
            n === t && (n = e, e = Yt);
            var i, r, o, a, s, l, c, d, u = et({defaults: {}}, n), h = {}, p = u.id, f = [];
            ...
            for (r in u.fields)o = u.fields[r], a = o.type || "default", s = null, d = r, r = typeof o.field === pt ? o.field : r, o.nullable || (s = u.defaults[d !== r ? d : r] = o.defaultValue !== t ? o.defaultValue : $t[a.toLowerCase()], "function" == typeof s && f.push(r)), n.id === r && (u._defaultId = s), u.defaults[d !== r ? d : r] = s, o.parse = o.parse || Gt[a];
            ...
            function t(t, n, i, r) {
                var o;
                return null != i && (typeof i === pt && (i = e(i), o = Nt.exec(i), o ? i = new Date(+o[1]) : r ? (i = "'" + i.toLowerCase() + "'", n = "(" + n + " || '').toLowerCase()") : i = "'" + i + "'"), i.getTime && (n = "(" + n + "?" + n + ".getTime():" + n + ")", i = i.getTime())), n + " " + t + " " + i
            }
            ...
            toArray: function () {
                ...
                var n = {dir: t};
                return e && (e.compare ? n.compare = e.compare : n.field = e), new o(this.data.slice(0).sort(O.create(n)))
            }, orderBy: function (e) {
                ...
                return e.length > 0 && (n = e[0], r = r.groupBy(n).select(function (i) {
                    var r = new o(t).filter([{field: i.field, operator: "eq", value: i.value, ignoreCase: !1}]);
                    return {
                        field: i.field,
                        value: i.value,
                ...
                var t, n, i, r, a = e.field, s = this._sortForGrouping(a, e.dir || "asc"), l = ct.accessor(a), c = l.get(s[0], a), d = {
                    field: a,
                    value: c,
                    items: []
                }, h = [d];
                ...
                if (!Ot) {
                    ...
                    for (r = new o(r).sort(e, t, N).toArray(), n = 0, i = r.length; i > n; n++)delete r[n].__position;
                    return r
                }
                return this.sort(e, t).toArray()
            }, aggregate: function (e) {
                var t, n, i = {}, r = {};
                if (e && e.length)for (t = 0, n = this.data.length; n > t; t++)h(i, e, this.data[t], t, n, r);
                return i
            }
        }, W = {
            sum: function (e, t, n) {
            ...
            n = n || {};
            var i, r = new o(e), s = n.group, l = d(s || []).concat(a(n.sort || [])), c = n.filterCallback, u = n.filter, h = n.skip, p = n.take;
            ...
            init: function (e) {
                ...
                e = e || {};
                var n, i = this, r = i.options[t], o = dt(r.data) ? r.data(e.data) : r.data;
            ...
            return nt(e) && dt(e.find) ? e : e === !0 ? new G : t[e]()
        }, $ = ht.extend({
            init: function (e) {
                ...
                }), !e.serialize && h && (f.serialize = b(s, i, m, d, l, u))), f._dataAccessFunction = o, f.data = b(o, i, v, c, l, u), f.groups = b(a, i, _, c, l, u))
            }, errors: function (e) {
            ...
            init: function (e) {
                ...
                }) : o._storage = e.offlineStorage), o.reader = new ct.data.readers[e.schema.type || "json"](e.schema), n = o.reader.model || {}, o._detachObservableParents(), o._data = o._observe(o._data), o._online = !0, o.bind(["push", kt, bt, xt, yt, St, Ct], e)
            },
            options: {
                data: null,
                schema: {modelBase: Yt},
            ...
            _flatData: function (e, t) {
                if (e) {
                    if (this._isServerGrouped())return w(e);
            ...
            _observeView: function (e) {
                var t, n = this;
                return T(e, n._data, n._ranges, n.reader.model || qt, n._isServerGrouped()), t = new jt(e, n.reader.model), t.parent = function () {
                    return n.parent()
                }, t
            },
            flatView: function () {
                var e = this.group() || [];
                return e.length ? w(this._view) : this._view
            },
            add: function (e) {
            ...
            pushUpdate: function (e) {
                var t, n, i, r, o;
                for (rt(e) || (e = [e]), t = [], n = 0; e.length > n; n++)i = e[n], r = this._createNewModel(i), o = this.get(r.id), o ? (t.push(o), o.accept(i), o.trigger(bt), this._updatePristineForModel(o, i)) : this.pushCreate(i);
            ...
            _removeItems: function (e) {
                ...
                try {
                    for (i = 0; e.length > i; i++)r = e[i], o = this._createNewModel(r), a = !1, this._eachItem(this._data, function (e) {
                        var n, i;
                        for (n = 0; e.length > n; n++)if (i = e.at(n), i.id === o.id) {
            ...
            sync: function () {
                var t, n = this, i = [], r = [], o = n._destroyed, a = (n._flatData(n._data), e.Deferred().resolve().promise());
                if (n.online()) {
                    ...
                    i = n.created(), r = n.updated(), t = [], n.options.batch && n.transport.submit ? t = n._sendSubmit(i, r, o) : (t.push.apply(t, n._send("create", i)), t.push.apply(t, n._send("update", r)), t.push.apply(t, n._send("destroy", o))), a = e.when.apply(null, t).then(function () {
                        ...
                        n._storeData(!0), n._change({action: "sync"}), n.trigger(yt)
                    })
            ...
            _accept: function (t) {
                ...
                if (i.trigger(St, {response: o, type: c}), o && !it(o)) {
            ...
            _submit: function (t, n) {
                var i = this;
                i.trigger(xt, {type: "submit"}), i.transport.submit(et({
            ...
            _promise: function (t, n, i) {
                ...
                return e.Deferred(function (e) {
                    r.trigger(xt, {type: i}), r.transport[i].call(r.transport, et({
                        success: function (t) {
            ...
            _send: function (e, t) {
                var n, i, r = this, o = [], a = r.reader.serialize(g(t));
            ...
            success: function (e) {
                var n, i, r, o, a, s, l, c, d = this, u = d.options;
            ...
            _storeData: function (e) {
                ...
                var n, i, r, o = this._isServerGrouped(), a = this.reader.model;
            ...
            error: function (e, t, n) {
                this._dequeueRequest(), this.trigger(St, {}), this.trigger(kt, {xhr: e, status: t, errorThrown: n})
            },
            _params: function (e) {
                var t = this, n = et({
                    take: t.take(),
                ...
                return t.options.serverPaging || (delete n.take, delete n.skip, delete n.page, delete n.pageSize), t.options.serverGrouping ? t.reader.model && n.group && (n.group = F(n.group, t.reader.model)) : delete n.group, t.options.serverFiltering ? t.reader.model && n.filter && (n.filter = P(n.filter, t.reader.model)) : delete n.filter, t.options.serverSorting ? t.reader.model && n.sort && (n.sort = F(n.sort, t.reader.model)) : delete n.sort, t.options.serverAggregates ? t.reader.model && n.aggregate && (n.aggregate = F(n.aggregate, t.reader.model)) : delete n.aggregate, n
            },
            ...
            _observe: function (e) {
                ...
                return n._shouldDetachObservableParents = !0, e instanceof Wt ? (n._shouldDetachObservableParents = !1, n._shouldWrap(e) && (e.type = n.reader.model, e.wrapAll(e, e))) : (t = n.pageSize() && !n.options.serverPaging ? jt : Wt, e = new t(e, n.reader.model), e.parent = function () {
                    return n.parent()
                }), n._isServerGrouped() && k(e, i), n._changeHandler && n._data && n._data instanceof Wt ? n._data.unbind(bt, n._changeHandler) : n._changeHandler = tt(n._change, n), e.bind(bt, n._changeHandler)
            },
            _change: function (e) {
            ...
            query: function (n) {
                ...
                return o || (this._data === t || 0 === this._data.length) && !this._destroyed.length ? this.read(this._mergeState(n)) : (r = this.trigger(xt, {type: "read"}), r || (this.trigger(Ct), i = this._queryProcess(this._data, this._mergeState(n)), this.options.serverFiltering || (this._total = i.total !== t ? i.total : this._data.length), this._aggregateResult = this._calculateAggregates(this._data, n), this.view(i.data), this.trigger(St, {type: "read"}), this.trigger(bt, {items: i.data})), e.Deferred().resolve(r).promise())
            },
            fetch: function (e) {
            ...
            page: function (e) {
                var n, i = this;
                return e !== t ? (e = It.max(It.min(It.max(e, 1), i.totalPages()), 1), i._query({page: e}), t) : (n = i.skip(), n !== t ? It.round((n || 0) / (i.take() || 1)) + 1 : t)
            },
            pageSize: function (e) {
                var n = this;
            ...
            _emptyAggregates: function (e) {
                var t, n, i = {};
                if (!it(e))for (t = {}, rt(e) || (e = [e]), n = 0; e.length > n; n++)t[e[n].aggregate] = 0, i[e[n].field] = t;
                return i
            },
            ...
            inRange: function (e, t) {
                var n = this, i = It.min(e + t, n.total());
            ...
            _findRange: function (e, n) {
                var i, r, o, s, l, c, u, h, p, f, g, m, v = this, _ = v._ranges, b = [], y = v.options, w = y.serverSorting || y.serverPaging || y.serverFiltering || y.serverGrouping || y.serverAggregates;
                for (r = 0, g = _.length; g > r; r++)if (i = _[r], e >= i.start && i.end >= e) {
                    for (f = 0, o = r; g > o; o++)if (i = _[o], p = v._flatData(i.data, !0), p.length && e + f >= i.start && (c = i.data, u = i.end, w || (m = d(v.group() || []).concat(a(v.sort() || [])), h = v._queryProcess(i.data, {
                            sort: m,
                            filter: v.filter()
                        }), p = c = h.data, h.total !== t && (u = h.total)), s = 0, e + f > i.start && (s = e + f - i.start), l = p.length, u > n && (l -= u - n), f += l - s, b = v._mergeGroups(b, c, s, l), i.end >= n && f == n - e))return b;
                    break
                }
                return []
            },
            ...
            _prefetchSuccessHandler: function (e, t, n, i) {
                var r = this, o = r._timeStamp();
                return function (a) {
                    var s, l, c, d = !1, u = {start: e, end: t, data: [], timestamp: r._timeStamp()};
                    if (r._dequeueRequest(), r.trigger(St, {
                            response: a,
                            type: "read"
                        }), a = r.reader.parse(a), c = r._readData(a), c.length) {
                        for (s = 0, l = r._ranges.length; l > s; s++)if (r._ranges[s].start === e) {
                            d = !0, u = r._ranges[s];
                            break
                        }
                        d || r._ranges.push(u)
                    ...
                    u.data = r._observe(c), u.end = u.start + r._flatData(u.data, !0).length, r._ranges.sort(function (e, t) {
                        return e.start - t.start
                    }), r._total = r.reader.total(a), (i || o >= r._currentRequestTimeStamp || !r._skipRequestsInProgress) && (n && c.length ? n() : r.trigger(bt, {}))
                }
            },
            prefetch: function (e, t, n) {
                var i = this, r = It.min(e + t, i.total()), o = {
                    take: t,
                    skip: e,
                    page: e / t + 1,
                    pageSize: t,
                ...
                i._rangeExists(e, r) ? n && n() : (clearTimeout(i._timeout), i._timeout = setTimeout(function () {
                    i._queueRequest(o, function () {
                        i.trigger(xt, {type: "read"}) ? i._dequeueRequest() : i.transport.read({
                            data: i._params(o),
            ...
            _multiplePrefetch: function (e, t, n) {
                ...
                i._rangeExists(e, r) ? n && n() : i.trigger(xt, {type: "read"}) || i.transport.read({
                    data: i._params(o),
            ...
            _rangeExists: function (e, t) {
                ...
                for (n = 0, i = o.length; i > n; n++)if (e >= o[n].start && o[n].end >= t)return !0;
                return !1
            },
            ...
            return o ? (o.read = typeof o.read === pt ? {url: o.read} : o.read, "jsdo" === t.type && (o.dataSource = i), t.type && (ct.data.transports = ct.data.transports || {}, ct.data.schemas = ct.data.schemas || {}, ct.data.transports[t.type] && !nt(ct.data.transports[t.type]) ? r = new ct.data.transports[t.type](et(o, {data: n})) : o = et(!0, {}, ct.data.transports[t.type], o), t.schema = et(!0, {}, ct.data.schemas[t.type], t.schema)), r || (r = dt(o.read) ? o : new q(o))) : r = new j({data: t.data || []}), r
        }, Y.create = function (e) {
            (rt(e) || e instanceof Wt) && (e = {data: e});
            var n, i, r, o = e || {}, a = o.data, s = o.fields, l = o.table, c = o.select, d = {};
            if (a || !s || o.transport || (l ? a = R(l, s) : c && (a = z(c, s), o.group === t && a[0] && a[0].optgroup !== t && (o.group = "optgroup"))), ct.data.Model && s && (!o.schema || !o.schema.model)) {
                for (n = 0, i = s.length; i > n; n++)r = s[n], r.type && (d[r.field] = r);
                it(d) || (o.schema = et(!0, o.schema, {model: {fields: d}}))
            }
            ...
            idField: "id", init: function (e) {
                ...
                i.children instanceof X || (e = i.children = new X(i._childrenOptions), t = e.transport, n = t.parameterMap, t.parameterMap = function (e, t) {
                    ...
                    e.node = e.node || i, i.trigger(bt, e)
                ...
                var n, i, r = {}, o = "_query";
                return this.hasChildren ? (this._initChildren(), n = this.children, r[this.idField || "id"] = this.id, this._loaded || (n._data = t, o = "read"), n.one(bt, tt(this._childrenLoaded, this)), i = n[o](r)) : this.loaded(!0), i || e.Deferred().resolve().promise()
            }, parentNode: function () {
                var e = this.parent();
                return e.parent()
            }, loaded: function (e) {
            ...
            init: function (e) {
            ...
            }, success: H("success"), data: H("data"), insert: function (e, t) {
                var n = this.parent();
                ...
                if (a) {
                    ...
                    for (a = this._flatData(this._data), n = 0, i = a.length; i > n; n++)if (o = a[n].children, o instanceof X && (r = o[e](t)))return r
                }
            }, get: function (e) {
            ...
            init: function (e, t, n) {
                ...
                var e = this, t = e.pageSize, n = e.skip - e.viewSize + t, i = It.max(It.floor(n / t), 0) * t;
                this.offset = n, this.dataSource.prefetch(i, t, function () {
                    e._goToRange(n, !0)
                })
            }, range: function (e, t) {
                if (this.offset === e)return !0;
                var n = this, i = this.pageSize, r = It.max(It.floor(e / i), 0) * i, o = this.dataSource;
