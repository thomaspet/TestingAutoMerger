...
!function (e, define) {
    ...
    return function (e, t) {
        ...
        function r(t) {
            t = e(t), t.addClass("k-item").children(k).addClass(M), t.children("a").addClass(T).children(k).addClass(M), t.filter(":not([disabled])").addClass(G), t.filter(".k-separator:empty").append("&nbsp;"), t.filter("li[disabled]").addClass(Y).removeAttr("disabled").attr("aria-disabled", !0), t.filter("[role]").length || t.attr("role", "menuitem"), t.children("." + T).length || t.contents().filter(function () {
        ...
        var l, c = window.kendo, d = c.ui, h = c._activeElement, u = c.support.touch && c.support.mobileOS, f = "mousedown", p = "click", g = e.extend, m = e.proxy, v = e.each, _ = c.template, w = c.keys, y = d.Widget, b = /^(ul|a|div)$/i, x = ".kendoMenu", k = "img", C = "open", S = "k-menu", T = "k-link", D = "k-last", A = "close", P = "timer", E = "k-first", M = "k-image", I = "select", B = "zIndex", z = "activate", L = "deactivate", R = "touchstart" + x + " MSPointerDown" + x + " pointerdown" + x, F = c.support.pointers, O = c.support.msPointers, H = O || F, N = F ? "pointerover" : O ? "MSPointerOver" : "mouseenter", V = F ? "pointerout" : O ? "MSPointerOut" : "mouseleave", U = u || H, W = e(document.documentElement), j = "kendoPopup", G = "k-state-default", q = "k-state-hover", $ = "k-state-focused", Y = "k-state-disabled", Q = ".k-menu", X = ".k-menu-group", K = X + ",.k-animation-container", Z = ":not(.k-list) > .k-item", J = ".k-item.k-state-disabled", et = ".k-item:not(.k-state-disabled)", tt = ".k-item:not(.k-state-disabled) > .k-link", nt = ":not(.k-item.k-separator)", it = nt + ":eq(0)", ot = nt + ":last", rt = "> div:not(.k-animation-container,.k-list-container)", at = {
            ...
            setOptions: function (e) {
                ...
                this._animations(e), e.animation = g(!0, t, e.animation), "dataSource" in e && this._initData(e), this._updateClasses(), y.fn.setOptions.call(this, e)
            },
            destroy: function () {
                var t = this;
                y.fn.destroy.call(t), t.element.off(x), t._documentClickHandler && e(document).unbind("click", t._documentClickHandler), c.destroy(t.element)
            },
            enable: function (e, t) {
            ...
            _insert: function (t, n, i) {
                ...
                }, n && !i.length && (i = e(ct.renderGroup({group: l})).appendTo(n)), s || e.isArray(t) ? o = e(e.map(s ? [t] : t, function (t, n) {
            ...
            open: function (o) {
                var r = this, a = r.options, s = "horizontal" == a.orientation, l = a.direction, d = c.support.isRtl(r.wrapper);
                return o = r.element.find(o), /^(top|bottom|default)$/.test(l) && (l = d ? s ? (l + " left").replace("default", "bottom") : "left" : s ? (l + " right").replace("default", "bottom") : "right"), o.siblings().find(">.k-popup:visible,>.k-animation-container>.k-popup:visible").each(function () {
                    var t = e(this).data("kendoPopup");
                    t && t.close()
                }), o.each(function () {
                    var o = e(this);
                    clearTimeout(o.data(P)), o.data(P, setTimeout(function () {
                        var h, f, p, m, v, _, w, y, b = o.find(".k-menu-group:first:hidden");
                        b[0] && r._triggerEvent({
                            item: o[0],
                            type: C
                        }) === !1 && (!b.find(".k-menu-group")[0] && b.children(".k-item").length > 1 ? (f = e(window).height(), p = function () {
                            b.css({
                                maxHeight: f - (b.outerHeight() - b.height()) - c.getShadows(b).bottom,
                                overflow: "auto"
                            })
                        }, c.support.browser.msie && 7 >= c.support.browser.version ? setTimeout(p, 0) : p()) : b.css({
                            maxHeight: "",
                            overflow: ""
                        }), o.data(B, o.css(B)), o.css(B, r.nextItemZIndex++), h = b.data(j), m = o.parent().hasClass(S), v = m && s, _ = i(l, m, d), w = a.animation.open.effects, y = w !== t ? w : "slideIn:" + n(l, m), h ? (h = b.data(j), h.options.origin = _.origin, h.options.position = _.position, h.options.animation.open.effects = y) : h = b.kendoPopup({
                            activate: function () {
                                r._triggerEvent({item: this.wrapper.parent(), type: z})
                            },
                            deactivate: function (e) {
                                e.sender.element.removeData("targetTransform").css({opacity: ""}), r._triggerEvent({
                            ...
                            close: function (e) {
                                ...
                                r._triggerEvent({
                                    item: t[0],
                                    type: A
                                }) ? e.preventDefault() : (t.css(B, t.data(B)), t.removeData(B), u && (t.removeClass(q), r._removeHoverItem()))
                            }
                        }).data(j), b.removeAttr("aria-hidden"), h.open())
            ...
            close: function (t, n) {
                ...
                return t = o.find(t), t.length || (t = o.find(">.k-item")), t.each(function () {
                    var t = e(this);
                    !n && i._isRootItem(t) && (i.clicked = !1), clearTimeout(t.data(P)), t.data(P, setTimeout(function () {
            ...
            _toggleHover: function (t) {
                var n = e(c.eventTarget(t) || t.target).closest(Z), i = t.type == N || -1 !== f.indexOf(t.type);
            ...
            _checkActiveElement: function (t) {
                var n = this, i = e(t ? t.currentTarget : this._hoverItem()), r = n._findRootParent(i)[0];
            ...
            _mouseenter: function (t) {
                var n = this, i = e(t.currentTarget), r = i.children(".k-animation-container").length || i.children(X).length;
                t.delegateTarget == i.parents(Q)[0] && (n.options.openOnClick && !n.clicked || u || (F || O) && t.originalEvent.pointerType in at && n._isRootItem(i.closest(Z)) || !o(t.currentTarget, t.relatedTarget) && r && n.open(i), (n.options.openOnClick && n.clicked || U) && i.siblings().each(m(function (e, t) {
                    n.close(t, !0)
                }, n)))
            },
            _mouseleave: function (n) {
                var i = this, r = e(n.currentTarget), a = r.children(".k-animation-container").length || r.children(X).length;
                return r.parentsUntil(".k-animation-container", ".k-list-container,.k-calendar-container")[0] ? (n.stopImmediatePropagation(), t) : (i.options.openOnClick || u || (F || O) && n.originalEvent.pointerType in at || o(n.currentTarget, n.relatedTarget || n.target) || !a || o(n.currentTarget, c._activeElement()) || i.close(r), t)
            },
            _click: function (n) {
                var i, o, r, a = this, s = a.options, l = e(c.eventTarget(n)), d = l[0] ? l[0].nodeName.toUpperCase() : "", h = "INPUT" == d || "SELECT" == d || "BUTTON" == d || "LABEL" == d, u = l.closest("." + T), f = l.closest(Z), p = u.attr("href"), g = l.attr("href"), m = e("<a href='#' />").attr("href"), v = !!p && p !== m, _ = v && !!p.match(/^#/), w = !!g && g !== m, y = s.openOnClick && r && a._isRootItem(f);
                if (!l.closest(rt, f[0]).length) {
                    if (f.hasClass(Y))return n.preventDefault(), t;
                    if (n.handled || !a._triggerEvent({
                            item: f[0],
                            type: I
                        }) || h || n.preventDefault(), n.handled = !0, o = f.children(K), r = o.is(":visible"), s.closeOnClick && (!v || _) && (!o.length || y))return f.removeClass(q).css("height"), a._oldHoverItem = a._findRootParent(f), a.close(u.parentsUntil(a.element, Z)), a.clicked = !1, -1 != "MSPointerUp".indexOf(n.type) && n.preventDefault(), t;
                    v && n.enterKey && u[0].click(), (a._isRootItem(f) && s.openOnClick || c.support.touch || (F || O) && a._isRootItem(f.closest(Z))) && (v || h || w || n.preventDefault(), a.clicked = !0, i = o.is(":visible") ? A : C, (s.closeOnClick || i != A) && a[i](f))
                }
            },
            ...
            _focus: function (n) {
                var i = this, o = n.target, r = i._hoverItem(), a = h();
            ...
            _keydown: function (e) {
                var n, i, o, r = this, a = e.keyCode, s = r._oldHoverItem, l = c.support.isRtl(r.wrapper);
                if (e.target == e.currentTarget || a == w.ESC) {
                    if (s || (s = r._oldHoverItem = r._hoverItem()), i = r._itemBelongsToVertival(s), o = r._itemHasChildren(s), a == w.RIGHT)n = r[l ? "_itemLeft" : "_itemRight"](s, i, o); else if (a == w.LEFT)n = r[l ? "_itemRight" : "_itemLeft"](s, i, o); else if (a == w.DOWN)n = r._itemDown(s, i, o); else if (a == w.UP)n = r._itemUp(s, i, o); else if (a == w.ESC)n = r._itemEsc(s, i); else if (a == w.ENTER || a == w.SPACEBAR)n = s.children(".k-link"), n.length > 0 && (r._click({
                        target: n[0],
                        preventDefault: function () {
                        },
                        enterKey: !0
                    }), r._moveHover(s, r._findRootParent(s))); else if (a == w.TAB)return n = r._findRootParent(s), r._moveHover(s, n), r._checkActiveElement(), t;
            ...
            _itemRight: function (e, t, n) {
                var i, o, r = this;
                if (!e.hasClass(Y))return t ? n ? (r.open(e), i = e.find(".k-menu-group").children().first()) : "horizontal" == r.options.orientation && (o = r._findRootParent(e), r.close(o), i = o.nextAll(it)) : (i = e.nextAll(it), i.length || (i = e.prevAll(ot))), i && !i.length ? i = r.wrapper.children(".k-item").first() : i || (i = []), r._moveHover(e, i), i
            },
            _itemLeft: function (e, t) {
                var n, i = this;
                return t ? (n = e.parent().closest(".k-item"), i.close(n), i._isRootItem(n) && "horizontal" == i.options.orientation && (n = n.prevAll(it))) : (n = e.prevAll(it), n.length || (n = e.nextAll(ot))), n.length || (n = i.wrapper.children(".k-item").last()), i._moveHover(e, n), n
            },
            ...
            _focusHandler: function (t) {
                var n = this, i = e(c.eventTarget(t)).closest(Z);
                setTimeout(function () {
        ...
        g(ct, {
            renderItem: function (e) {
                ...
                return st.group(g({
                    renderItems: function (e) {
                        for (var t = "", n = 0, i = e.items, o = i ? i.length : 0, r = g({length: o}, e.group); o > n; n++)t += ct.renderItem(g(e, {
                            group: r,
                            item: g({index: n}, i[n])
                        }));
                        return t
            ...
            setOptions: function (t) {
                var n = this;
                ct.fn.setOptions.call(n, t), n.target.off(n.showOn + x, n._showProxy), n.userEvents && n.userEvents.destroy(), n.target = e(n.options.target), t.orientation && n.popup.wrapper[0] && n.popup.element.unwrap(), n._wire(), ct.fn.setOptions.call(this, t)
            },
            destroy: function () {
                var e = this;
                e.target.off(e.options.showOn + x), W.off(c.support.mousedown + x, e._closeProxy), e.userEvents && e.userEvents.destroy(), ct.fn.destroy.call(e)
            },
            open: function (n, i) {
                var r = this;
                return n = e(n)[0], o(r.element[0], e(n)[0]) ? ct.fn.open.call(r, n) : r._triggerEvent({
                    item: r.element,
                    type: C
                }) === !1 && (r.popup.visible() && r.options.filter && r.popup.close(!0), i !== t ? (r.popup.wrapper.hide(), r.popup.open(n, i)) : (r.popup.options.anchor = (n ? n : r.popup.anchor) || r.target, r.popup.open()), W.off(r.popup.downEvent, r.popup._mousedownProxy), W.on(c.support.mousedown + x, r._closeProxy)), r
            },
            close: function () {
                var t = this;
                o(t.element[0], e(arguments[0])[0]) ? ct.fn.close.call(t, arguments[0]) : t.popup.visible() && t._triggerEvent({
                    item: t.element,
                    type: A
                }) === !1 && (t.popup.close(), W.off(c.support.mousedown + x, t._closeProxy), t.unbind(I, t._closeTimeoutProxy))
            },
            _showHandler: function (e) {
                var t, n = e, i = this, r = i.options;
            ...
            _closeHandler: function (t) {
                var n, i = this, r = e(t.relatedTarget || t.target), a = r.closest(i.target.selector)[0] == i.target[0], s = r.closest(et).children(K), l = o(i.element[0], r[0]);
            ...
            _triggerEvent: function (n) {
                var i = this, o = e(i.popup.options.anchor)[0], r = i._eventOrigin;
