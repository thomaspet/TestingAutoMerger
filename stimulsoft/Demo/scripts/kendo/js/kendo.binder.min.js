    ...
    return function (e, t) {
        function n(t, n, i) {
            return v.extend({
                init: function (e, t, n) {
                    var i = this;
                    v.fn.init.call(i, e.element[0], t, n), i.widget = e, i._dataBinding = M(i.dataBinding, i), i._dataBound = M(i.dataBound, i), i._itemChange = M(i.itemChange, i)
                    ...
                    var i, r, o, s, l = this.widget, c = e.addedItems || l.items(), d = l[n], u = (d.group() || [], C.data.HierarchicalDataSource);
        ...
        function a(e, t, n, s) {
            var c, d, u, h = e.getAttribute("data-" + C.ns + "role"), p = e.getAttribute("data-" + C.ns + "bind"), v = e.children, _ = [], b = !0, y = {};
            if (s = s || [t], (h || p) && l(e), h && (u = i(e, n)), p && (p = r(p.replace(x, "")), u || (y = C.parseOptions(e, {
                    ...
                    valuePrimitive: !1,
                    autoBind: !0
                }), y.roles = n, u = new w(e, y)), u.source = t, d = o(p, s, f), y.template && (d.template = new m(s, "", y.template)), d.click && (p.events = p.events || {}, p.events.click = p.click, d.click.destroy(), delete d.click), d.source && (b = !1), p.attr && (d.attr = o(p.attr, s, f)), p.style && (d.style = o(p.style, s, f)), p.events && (d.events = o(p.events, s, g)), p.css && (d.css = o(p.css, s, f)), u.bind(d)), u && (e.kendoBindingTarget = u), b && v) {
        ...
        var f, g, m, v, _, b, w, y, k, x, C = window.kendo, S = C.Observable, T = C.data.ObservableObject, D = C.data.ObservableArray, A = {}.toString, E = {}, I = C.Class, M = e.proxy, P = "value", F = "source", z = "events", R = "checked", B = "css", H = !0, L = "change";
        !function () {
            ...
            init: function (e, t) {
                ...
                if ("this" === r.path)r.trigger(L, e); else for (t in r.dependencies)if (0 === t.indexOf(i) && (n = t.charAt(i.length), !n || "." === n || "[" === n)) {
                    r.trigger(L, e);
                    break
                }
            }, start: function (e) {
            ...
            init: function (e, t, n) {
                ...
                var n = e(this.element), i = this.bindings.css[t], r = this.classes[t] = i.get();
            ...
            init: function (t, n, i) {
                _.fn.init.call(this, t, n, i), this._change = M(this.change, this), this.eventName = i.valueUpdate || L, e(this.element).on(this.eventName, this._change), this._initChange = !1
            }, change: function () {
            ...
            init: function (e, t, n) {
                ...
                if (e(c).html(C.render(this.template(), n)), c.children.length)for (i = this.bindings.source._parents(), r = 0, o = n.length; o > r; r++)s = c.children[0], l.insertBefore(s, d || null), a(s, n[r], this.options.roles, [n[r]].concat(i))
            }, remove: function (e, t) {
            ...
            checked: _.extend({
                init: function (t, n, i) {
                    _.fn.init.call(this, t, n, i), this._change = M(this.change, this), e(this.element).change(this._change)
                }, change: function () {
                    var e, t, n, i = this.element, r = this.value();
                    if ("radio" == i.type)r = this.parsedValue(), this.bindings[R].set(r); else if ("checkbox" == i.type)if (e = this.bindings[R].get(), e instanceof D) {
                    ...
                    var e, t, n = this.bindings[R].get(), i = n, r = this.dataType(), o = this.element;
                    if ("checkbox" == o.type)if (i instanceof D) {
                        ...
                        o.checked = e >= 0
                    } else o.checked = i; else"radio" == o.type && null != n && ("date" == r ? n = C.toString(n, "yyyy-MM-dd") : "datetime-local" == r && (n = C.toString(n, "yyyy-MM-ddTHH:mm:ss")), o.value === "" + n && (o.checked = !0))
                }, value: function () {
            ...
            source: E.source.extend({
                refresh: function (n) {
                    var i = this, r = i.bindings.source.get();
                ...
                init: function (t, n, i) {
                    ...
                    var e, n, i, r, o, a, s, l, c = [], d = this.element, u = this.options.valueField || this.options.textField, h = this.options.valuePrimitive;
                    ...
                    if (u)for (e = this.bindings.source.get(), e instanceof C.data.DataSource && (e = e.view()), i = 0; c.length > i; i++)for (o = 0, a = e.length; a > o; o++)if (s = this._parseValue(e[o].get(u), this.dataType()), l = s + "" === c[i]) {
                        c[i] = e[o];
                        break
                    }
                    r = this.bindings[P].get(), r instanceof D ? r.splice.apply(r, [0, r.length].concat(c)) : this.bindings[P].set(h || !(r instanceof T || null === r || r === t) && u ? c[0].get(u) : c[0])
                }, refresh: function () {
                    var e, t, n, i = this.element, r = i.options, o = this.bindings[P].get(), a = o, s = this.options.valueField || this.options.textField, l = !1, c = this.dataType();
                    for (a instanceof D || (a = new D([o])), i.selectedIndex = -1, n = 0; a.length > n; n++)for (o = a[n], s && o instanceof T && (o = o.get(s)), "date" == c ? o = C.toString(a[n], "yyyy-MM-dd") : "datetime-local" == c && (o = C.toString(a[n], "yyyy-MM-ddTHH:mm:ss")), e = 0; r.length > e; e++)t = r[e].value, "" === t && "" !== o && (t = r[e].text), null != o && t == "" + o && (r[e].selected = !0, l = !0)
                }, destroy: function () {
                    e(this.element).off(L, this._change)
                }
            })
            ...
            checked: v.extend({
                init: function (e, t, n) {
                    v.fn.init.call(this, e.element[0], t, n), this.widget = e, this._change = M(this.change, this), this.widget.bind(L, this._change)
                }, change: function () {
            ...
            value: v.extend({
                init: function (t, n, i) {
                    ...
                    if (this._initChange = !0, l)if (this.bindings.source && (a = this.bindings.source.get()), "" === s && (d || this.options.valuePrimitive))s = null; else {
                        for ((!a || a instanceof C.data.DataSource) && (a = this.widget.dataSource.flatView()), c && (t = s.length, u = s.slice(0)), r = 0, o = a.length; o > r; r++)if (n = a[r], i = n.get(l), c) {
                    ...
                    if (!this._initChange) {
                        if (e = this.widget, n = e.options, i = n.dataTextField, r = n.dataValueField || i, o = this.bindings.value.get(), a = n.text || "", s = 0, c = [], o === t && (o = null), r)if (o instanceof D) {
            ...
            multiselect: {
                value: v.extend({
                    init: function (t, n, i) {
                        ...
                        var e, n, i, r, o, a, s, l, c, d = this, u = d.bindings[P].get(), h = d.options.valuePrimitive, p = h ? d.widget.value() : d.widget.dataItems(), f = this.options.dataValueField || this.options.dataTextField;
            ...
            init: function (e, t) {
                ...
                var t, n, i, r, o, a, s = this instanceof y, l = this.binders();
                for (t in e)t == P ? n = !0 : t == F ? i = !0 : t != z || s ? t == R ? o = !0 : t == B ? a = !0 : this.applyBinding(t, e, l) : r = !0;
                i && this.applyBinding(F, e, l), n && this.applyBinding(P, e, l), o && this.applyBinding(R, e, l), r && !s && this.applyBinding(z, e, l), a && !s && this.applyBinding(B, e, l)
            }, binders: function () {
