 ...
 */
!function (e, define) {
    define(["./kendo.core.min", "./kendo.color.min", "./kendo.drawing.min"], e)
}(function () {
    return function (e, t) {
        e.PDFMixin = {
            extend: function (e) {
            ...
            saveAsPDF: function () {
                var n, i = new t.Deferred, o = i.promise(), r = {promise: o};
            ...
            _drawPDF: function (n) {
                ...
                return e.drawing.drawDOM(this.wrapper).done(function (e) {
                    var t = {page: e, pageNumber: 1, progress: 1, totalPages: 1};
            ...
            _drawPDFShadow: function (n) {
                ...
                return n = n || {}, i = this.wrapper, o = t("<div class='k-pdf-export-shadow'>"), n.width && o.css({
                    width: n.width,
                    overflow: "visible"
                }), i.before(o), o.append(n.content || i.clone(!0, !0)), r = t.Deferred(), setTimeout(function () {
                    var t = e.drawing.drawDOM(o);
                    t.always(function () {
                        o.remove()
                    }).then(function () {
                        ...
                        r.progress.apply(r, arguments)
                    })
                }, 15), r.promise()
            }
        }
    }(kendo, window.kendo.jQuery), function (e, t, n) {
        "use strict";
        function i() {
            function e() {
                var t, o, r;
                for (t = 0; arguments.length > t; ++t) {
                    ...
                    if (o instanceof b)o.beforeRender(e), o.render(e); else if (V(o))g(o, e); else if (p(o))m(o, e); else if ("number" == typeof o) {
        ...
        function o(e, t) {
            var n = e.beforeRender, i = e.render;
        ...
        function r(e) {
            ...
            return n[0] = y(n[0]), n[1] = y(n[1]), e("landscape", !1) && (n = [Math.max(n[0], n[1]), Math.min(n[0], n[1])]), t = e("margin"), t && ("string" == typeof t || "number" == typeof t ? (t = y(t, 0), t = {
                ...
                right: y(t.right, 0),
                bottom: y(t.bottom, 0)
            }, e("addMargin") && (n[0] += t.left + t.right, n[1] += t.top + t.bottom)), {paperSize: n, margin: t}
        }
        ...
        function a(e) {
            ...
            s.getOption = t, s.attach = function (e) {
                ...
                var t, n, o, l = r(function (t, n) {
                    return e && null != e[t] ? e[t] : n
                }), c = l.paperSize, d = l.margin, h = c[0], u = c[1];
        ...
        function D(e, t, n, i, o, r, a) {
            var s = T([t, n, i, o, r, a]), l = e.GRAD_COL_FUNCTIONS[s];
        ...
        function A(e, t, n) {
            var i = T([t, n]), o = e.GRAD_OPC_FUNCTIONS[i];
        ...
        function P(e, t) {
            function n(e) {
                return 1 == e.length ? e[0] : {FunctionType: 3, Functions: e, Domain: [0, 1], Bounds: h, Encode: u}
            }

            var i, o, r, a, s, l = !1, c = [], d = [], h = [], u = [];
            ...
            if (l)for (i = 1; t.length > i; ++i)o = t[i - 1], r = t[i], a = o.color, s = r.color, c.push(A(e, a.a, s.a));
            return h.pop(), {hasAlpha: l, colors: n(d), opacities: l ? n(c) : null}
        }
            ...
            return r || (l = [t].concat(i), n.forEach(function (e) {
                ...
                SMask: {
                    ...
                    G: e.attach(new $("/a0 gs /s0 sh", {
                        ...
                        Group: {Type: k("Group"), S: k("Transparency"), CS: k("DeviceGray"), I: !0},
                        Resources: {
        ...
        function I(e, t, n) {
            var i = "radial" == t.type, o = P(e, t.stops), r = i ? [t.start.x, t.start.y, t.start.r, t.end.x, t.end.y, t.end.r] : [t.start.x, t.start.y, t.end.x, t.end.y], a = E(e, i, t.stops, r, o.colors, t.userSpace && n), s = o.hasAlpha ? M(e, i, t.stops, r, o.opacities, t.userSpace && n) : null;
        ...
        function L(e) {
            var t, n = /^\s*((normal|italic)\s+)?((normal|small-caps)\s+)?((normal|bold|\d+)\s+)?(([0-9.]+)(px|pt))(\/(([0-9.]+)(px|pt)|normal))?\s+(.*?)\s*$/i, i = n.exec(e);
        ...
        function F(e) {
            ...
            if (r instanceof Array)for (o = 0; r.length > o && (n = t(r[o]), !(i = et[n])); ++o); else i = et[r.toLowerCase()];
        ...
        function O(e, t) {
            if (1 == arguments.length)for (var n in e)f(e, n) && O(n, e[n]); else switch (e = e.toLowerCase(), et[e] = t, e) {
                case"dejavu sans":
                    et["sans-serif"] = t;
                    break;
        ...
        function N(e, t) {
            var n = e[0], i = e[1], o = e[2], r = e[3], a = e[4], s = e[5], l = t[0], c = t[1], d = t[2], h = t[3], u = t[4], f = t[5];
        ...
        var V, U, W, j, G, q, $, Y, Q, X, K, Z, J, et, tt = e.kendo, nt = !!e.Uint8Array, it = "\n", ot = 0, rt = function () {
        ...
        a.prototype = {
            loadFonts: ct, loadImages: dt, getFont: function (e) {
                var t = this.FONTS[e];
                if (!t) {
                ...
                return e = t(a), a += n ? "S" : "F", i = this._opacityGSCache || (this._opacityGSCache = {}), o = i[a], o || (r = {Type: k("ExtGState")}, n ? r.CA = e : r.ca = e, o = this.attach(new q(r)), o._resourceName = k("GS" + ++ot), i[a] = o), o
            }, dict: function (e) {
                return new q(e)
            }, name: function (e) {
                return k(e)
            ...
            render: function (t) {
                var n = this.data.get(), i = this.props;
            ...
            this.props = {Type: k("Pages"), Kids: [], Count: 0}
        }, {
            addPage: function (e) {
                this.props.Kids.push(e), this.props.Count++
            }
        }, q), X = x(function (e) {
            this.props = {Type: k("Font"), Subtype: k("Type1"), BaseFont: k(e)}, this._resourceName = k("F" + ++ot)
        }, {
            ...
            encodeText: function (e) {
                ...
                var n, i, o = 0, r = this._font.cmap.getUnicodeEntry().codeMap;
                for (n = 0; t.length > n; ++n)i = r[t.charCodeAt(n)], o += this._font.widthOfGlyph(i || 0);
                return o * e / 1e3
            }, beforeRender: function () {
                var e, t, n, o, r = this, a = r._sub, s = a.render(), l = new $(B(s), {Length1: s.length}, !0), c = r._pdf.attach(new q({
                ...
                })), d = a.ncid2ogid, h = a.firstChar, u = a.lastChar, f = [];
                !function p(e, t) {
                    if (u >= e) {
                        var n = d[e];
                    ...
                    CIDSystemInfo: new q({Registry: new U("Adobe"), Ordering: new U("Identity"), Supplement: 0}),
                    FontDescriptor: c,
                    FirstChar: h,
                    LastChar: u,
            ...
            _out: function () {
                ...
                H(arguments) || (this._matrix = N(arguments, this._matrix), this._out(e, " ", t, " ", n, " ", i, " ", o, " ", r, " cm"), this._out(it))
                ...
                var n = this._toPage({x: t.left, y: t.bottom}), i = this._toPage({x: t.right, y: t.top});
                this._annotations.push(new q({
                    Type: k("Annot"),
                    Subtype: k("Link"),
                    Rect: [n.x, n.y, i.x, i.y],
                    Border: [0, 0, 0],
                    A: new q({Type: k("Action"), S: k("URI"), URI: new U(e)})
                }))
                ...
                var t = this._matrix, n = t[0], i = t[1], o = t[2], r = t[3], a = t[4], s = t[5];
                return {x: n * e.x + o * e.y + a, y: i * e.x + r * e.y + s}
            }
        }, q), et = {
            serif: "Times-Roman",
        ...
        function a(e) {
            this.font = e, this.subset = {}, this.unicodes = {}, this.ogid2ngid = {0: 0}, this.ngid2ogid = {0: 0}, this.ncid2ogid = {}, this.next = this.firstChar = 1, this.nextGid = 1, this.psName = r() + "+" + this.font.psName
        }

        function s(e, t) {
            var n, i, o, r, a = this, s = a.contents = y(e);
            if ("ttcf" == s.readString(4)) {
                if (!t)throw Error("Must specify a name for TTC files");
                for (n = s.readLong(), i = s.readLong(), o = 0; i > o; ++o)if (r = s.readLong(), s.saveExcursion(function () {
                        s.offset(r), a.parse()
                    }), a.psName == t)return;
        ...
        var l, c, d, h, u, f, p, g, m, v, _, w = e.kendo.pdf, y = w.BinaryStream;
        i.prototype = {
            readTable: function (e, t) {
                ...
                var n, i, o, r, a, s, l, c, d = Object.keys(e).length, h = Math.pow(2, Math.floor(Math.log(d) / Math.LN2)), u = 16 * h, f = Math.floor(Math.log(h) / Math.LN2), p = 16 * d - u, g = y();
                g.writeLong(this.scalerType), g.writeShort(d), g.writeShort(u), g.writeShort(f), g.writeShort(p), n = 16 * d, i = g.offset() + n, o = null, r = y();
                for (a in e)if (t(e, a))for (s = e[a], g.writeString(a), g.writeLong(this.checksum(s)), g.writeLong(i), g.writeLong(s.length), r.write(s), "head" == a && (o = i), i += s.length; i % 4;)r.writeByte(0), i++;
            ...
            parse: function (e) {
                ...
                var t, n = y(), i = e[e.length - 1] > 65535;
                for (t = 0; e.length > t; ++t)i ? n.writeLong(e[t]) : n.writeShort(e[t] / 2);
                return {format: i ? 1 : 0, table: n.get()}
            }
        }), d = o({
            parse: function (e) {
            ...
            parse: function (e) {
                ...
                e.offset(this.offset), t = this.file, n = t.hhea, this.metrics = e.times(n.numOfLongHorMetrics, function () {
                    return {advance: e.readShort(), lsb: e.readShort_()}
                }), i = t.maxp.numGlyphs - t.hhea.numOfLongHorMetrics, this.leftSideBearings = e.times(i, e.readShort_)
            }, forGlyph: function (e) {
                var t = this.metrics, n = t.length;
                return n > e ? t[e] : {advance: t[n - 1].advance, lsb: this.leftSideBearings[e - n]}
            }, render: function (e) {
                var t, n, i = y();
            ...
            var i, r, a, s, l, c;
            return e.prototype = {
                compound: !1, render: function () {
                    return this.raw.get()
                }
            }, i = 1, r = 8, a = 32, s = 64, l = 128, c = 256, n.prototype = {
                compound: !0, render: function (e) {
                ...
                parse: function () {
                    ...
                    return s.push(a.offset()), {table: a.get(), offsets: s}
                }
            })
        }(), p = function () {
            function e(e, t) {
            ...
            return o({
                parse: function (t) {
                    ...
                    var i, o, r, a, s, l, c = this.strings, d = 0;
                    for (i in c)t(c, i) && (d += c[i].length);
                    o = y(), r = y(), o.writeShort(0), o.writeShort(d), o.writeShort(6 + 12 * d);
                    for (i in c)if (t(c, i))for (a = 6 == i ? [new e(n, this.postscriptEntry)] : c[i], s = 0; a.length > s; ++s)l = a[s], o.writeShort(l.platformID), o.writeShort(l.platformSpecificID), o.writeShort(l.languageID), o.writeShort(l.nameID), o.writeShort(l.length), o.writeShort(r.offset()), r.writeString(l.text);
                ...
                n.platformID = e.readShort(), n.platformSpecificID = e.readShort(), n.offset = t + e.readLong(), e.saveExcursion(function () {
                    ...
                    switch (e.offset(n.offset), n.format = e.readShort(), n.length = e.readShort(), n.language = e.readShort(), n.isUnicode = 3 == n.platformID && 1 == n.platformSpecificID && 4 == n.format || 0 === n.platformID && 4 == n.format, n.codeMap = {}, n.format) {
                        case 0:
                            ...
                            break;
                        case 4:
                            for (i = e.readShort() / 2, e.skip(6), o = e.times(i, e.readShort), e.skip(2), r = e.times(i, e.readShort), a = e.times(i, e.readShort_), s = e.times(i, e.readShort), l = (n.length + n.offset - e.offset()) / 2, c = e.times(l, e.readShort), t = 0; i > t; ++t)for (d = r[t], h = o[t], u = d; h >= u; ++u)0 === s[t] ? f = u + a[t] : (p = s[t] / 2 - (i - t) + (u - d), f = c[p] || 0, 0 !== f && (f += a[t])), n.codeMap[u] = 65535 & f
                    }
                })
            }
            ...
            function t(e, t) {
                ...
                var o, r, a, s, l, c, d, h, u, f, p, g, m, v, _, w, b, x = n(e), k = [], C = [], S = null, T = null;
                ...
                for (S && C.push(S), C.push(65535), k.push(65535), l = k.length, c = 2 * l, d = 2 * Math.pow(2, Math.floor(Math.log(l) / Math.LN2)), h = Math.log(d / 2) / Math.LN2, u = c - d, f = [], p = [], g = [], o = 0; l > o; ++o) {
                    ...
                    if (_ = i(m), m - _ >= 32768)for (f.push(0), p.push(2 * (g.length + l - o)), w = m; v >= w; ++w)g.push(i(w)); else f.push(_ - m), p.push(0)
                }
        ...
        function n(t, n) {
            ...
            function o() {
                function o(e) {
                    var t, n, o, r, l, c = e.options, d = S(e), h = d.bbox;
            ...
            var r, l = [], c = [], d = t.options, h = i("multiPage");
            t.traverse(function (t) {
                a({
                    Image: function (e) {
                        c.indexOf(e.src()) < 0 && c.push(e.src())
                    }, Text: function (t) {
                        var n = e.pdf.parseFontDef(t.options.font), i = e.pdf.getFontURL(n);
        ...
        function o(e, t) {
            n(e, function (e) {
                t(new Blob([e.get()], {type: "application/pdf"}))
            })
        }

        function r(t, n, r, a) {
            window.Blob && !e.support.browser.safari ? o(t, function (t) {
                e.saveAs({dataURI: t, fileName: n}), a && a(t)
            }) : i(t, function (t) {
                e.saveAs({dataURI: t, fileName: n, proxyURL: r}), a && a(t)
            })
        }
        ...
        function u(e, t, n, i) {
            ...
            return h instanceof T.Gradient ? (i ? t.clipStroke() : t.clip(), o = h instanceof T.RadialGradient, o ? (r = {
                ...
                y: h.center().y,
                r: 0
            }, a = {x: h.center().x, y: h.center().y, r: h.radius()}) : (r = {
                x: h.start().x,
                y: h.start().y
            }, a = {x: h.end().x, y: h.end().y}), s = {
        ...
        function y(t, n) {
            var i, o = e.pdf.parseFontDef(t.options.font), r = t._position;
        ...
        function S(e) {
            ...
            var l, c = !1, d = D.Matrix.unit(), u = null;
            do l = !1, e = s(e); while (e && l);
            return {root: e, bbox: u}
        }

        var T = e.drawing, D = e.geometry, A = e.pdf.TEXT_RENDERING_MODE, P = {
            dash: [4],
            dashDot: [4, 2, 1, 2],
            dot: [1, 2],
            longDash: [8, 2],
            ...
            solid: []
        }, E = {butt: 0, round: 1, square: 2}, M = {miter: 0, round: 1, bevel: 2};
        e.deepExtend(T, {exportPDF: k, pdf: {toDataURL: i, toBlob: o, saveAs: r, toStream: n}})
