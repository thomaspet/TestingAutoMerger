...
!function (e, define) {
    ...
    return function (e, t) {
        ...
        function s(e, t, n) {
            var i, o, r, a;
            for (n = bt(n) ? n : [n], i = 0, o = n.length; o > i; i++)r = n[i], vt(r) && r.click && (a = r.name || r.text, t.on(on + Rt, "a.k-grid-" + (a || "").replace(/\s/g, ""), {commandName: a}, Ct(r.click, e)))
        }

        function l(e, t, n) {
            return wt(e, function (e) {
                var i, o;
                return e = typeof e === ln ? {field: e} : e, (!f(e) || n) && (e.attributes = W(e.attributes), e.footerAttributes = W(e.footerAttributes), e.headerAttributes = W(e.headerAttributes), i = !0), e.columns && (e.columns = l(e.columns, t, i)), o = dt.guid(), e.headerAttributes = _t({id: o}, e.headerAttributes), _t({
                    encoded: t,
                    hidden: i
                }, e)
            })
        ...
        function m(e, t, n) {
            var i = w(B(t)), o = w(z(t)), r = e.rowSpan;
            e.rowSpan = n ? i > o ? r - (i - o) || 1 : r + (o - i) : i > o ? r + (i - o) : r - (o - i) || 1
        }

        function v(t, n, i, o, r, a, s) {
            var l, c, d = w(t), h = w([n]);
            d > h && (l = Array(s + 1).join('<th class="k-group-cell k-header">&nbsp;</th>'), c = a.children(":not(.k-filter-row)"), e(Array(d - h + 1).join("<tr>" + l + "</tr>")).insertAfter(c.last())), M(a, d - h), y(i, o, r, a)
        }
        ...
        function _(t, n, i) {
            ...
            }, d = 0, h = n.length; h > d; d++)o = b(n[d], a), s[o.row] || (s[o.row] = l.eq(o.row).find(".k-header").filter(c)), r = s[o.row].eq(o.cell), r.attr(dt.attr("index"), i + d);
            return n.length
        }

        function w(e) {
            var t, n, i = 1, o = 0;
            for (t = 0; e.length > t; t++)e[t].columns && (n = w(e[t].columns), n > o && (o = n));
            return i + o
        }

        function y(t, n, i, o) {
            var r, a, s = C(t[0], n), l = i.find(">tr:not(.k-filter-row):eq(" + s.row + ")>th.k-header"), c = e(), d = s.cell;
        ...
        function E(t) {
            var n, i = t.find("tr:not(.k-filter-row)"), o = i.filter(function () {
                return !e(this).children().length
            }).remove().length, r = i.find("th:not(.k-group-cell,.k-hierarchy-cell)");
        ...
        function N(n) {
            var i, o = n.find(">tr:not(.k-filter-row)"), r = function () {
                var t = e(this);
                return !t.hasClass("k-group-cell") && !t.hasClass("k-hierarchy-cell")
            }, a = e();
            return o.length > 1 && (a = o.find("th").filter(r).filter(function () {
                return this.rowSpan > 1
            })), a = a.add(o.last().find("th").filter(r)), i = dt.attr("index"), a.sort(function (n, o) {
                var r, a;
        ...
        function H(t) {
            var n, i, o, r, a, s, l, c = t.closest("table"), d = e().add(t), h = t.closest("tr"), u = c.find("tr:not(.k-filter-row)"), f = u.index(h);
            if (f > 0) {
        ...
        function V(t) {
            var n, i, o, r, a, s, l, c, d = t.closest("thead"), h = e().add(t), u = t.closest("tr"), f = d.find("tr:not(.k-filter-row)"), p = f.index(u) + t[0].rowSpan, g = dt.attr("colspan");
            if (f.length - 1 >= p) {
        ...
        function W(e) {
            e = e || {};
            var t = e.style;
            return t ? (t = t.replace(/((.*)?display)(.*)?:([^;]*)/i, "$1:none"), t === e.style && (t = t.replace(/(.*)?/i, "display:none;$1"))) : t = "display:none", _t({}, e, {style: t})
        }
        ...
        function G(t, n, i, o) {
            var r, a = t.find(">colgroup"), s = wt(n, function (e) {
                return r = e.width, r && 0 !== parseInt(r, 10) ? dt.format('<col style="width:{0}"/>', typeof r === ln ? r : r + "px") : "<col />"
            });
            (i || a.find(".k-hierarchy-col").length) && s.splice(0, 0, '<col class="k-hierarchy-col" />'), a.length && a.remove(), a = e(Array(o + 1).join('<col class="k-group-col">') + s.join("")), a.is("colgroup") || (a = e("<colgroup/>").append(a)), t.prepend(a), yn.msie && 8 == yn.version && (t.css("display", "inline-table"), window.setTimeout(function () {
                t.css("display", "")
            }, 1))
        }

        function q(e, t) {
            var n, i, o = 0, r = e.find("th:not(.k-group-cell)");
            for (n = 0, i = t.length; i > n; n++)t[n].locked && (r.eq(n).insertBefore(r.eq(o)), r = e.find("th:not(.k-group-cell)"), o++)
        }
        ...
        function Y(e, t, n, i) {
            var o = n && n.length && vt(n[0]) && "value" in n[0], r = o ? $(n)[e] : e;
            return r = null != r ? r : "", t ? dt.format(t, r) : i === !1 ? r : dt.htmlEncode(r)
        }
        ...
        function tt(e) {
            var t, n, i = 0, o = e.find(">colgroup>col");
        ...
        function it(e, t) {
            var n, i = e.offsetHeight, o = t.offsetHeight;
        ...
        function ot(e, t) {
            ...
            if (bt(e))for (n = 0, i = e.length; i > n; n++)if (o = e[n], typeof o === ln && o === t || o.name === t)return o;
            return null
        }
        ...
        function at(n) {
            var i = e(n.currentTarget), o = i.is("th"), r = this.table.add(this.lockedTable), a = this.thead.parent().add(e(">table", this.lockedHeader)), s = e(n.target).is(":button,a,:input,a>.k-icon,textarea,span.k-select,span.k-icon,span.k-link,.k-input,.k-multiselect-wrap,.k-tool-icon"), l = i.closest("table")[0];
            if (!dt.support.touch)return s && i.find(dt.roleSelector("filtercell")).length ? (this.current(i), t) : ((l === r[0] || l === r[1] || l === a[0] || l === a[1]) && (e(n.target).is("a.k-i-collapse, a.k-i-expand") || (this.options.navigatable && this.current(i), (o || !s) && setTimeout(function () {
                xn && e(dt._activeElement()).hasClass("k-widget") || rt(l, !0)
        ...
        var dt = window.kendo, ht = dt.ui, ut = dt.data.DataSource, ft = dt.support.tbodyInnerHtml, pt = dt._activeElement, gt = ht.Widget, mt = dt.keys, vt = e.isPlainObject, _t = e.extend, wt = e.map, yt = e.grep, bt = e.isArray, xt = e.inArray, kt = Array.prototype.push, Ct = e.proxy, St = dt.isFunction, Tt = e.isEmptyObject, Dt = Math, At = "progress", Pt = "error", Mt = ":not(.k-group-cell):not(.k-hierarchy-cell):visible", Et = "tbody>tr:not(.k-grouping-row):not(.k-detail-row):not(.k-group-footer) > td:not(.k-group-cell):not(.k-hierarchy-cell)", It = "tr:not(.k-footer-template):visible", Bt = ":not(.k-group-cell):not(.k-hierarchy-cell):visible", zt = It + ":first>" + Bt + ":first", Lt = "th.k-header:not(.k-group-cell):not(.k-hierarchy-cell)", Rt = ".kendoGrid", Ft = "edit", Ot = "save", Nt = "remove", Ht = "detailInit", Vt = "filterMenuInit", Ut = "columnMenuInit", Wt = "change", jt = "columnHide", Gt = "columnShow", qt = "saveChanges", $t = "dataBound", Yt = "detailExpand", Qt = "detailCollapse", Xt = "k-state-focused", Kt = "k-state-selected", Zt = "k-grid-norecords", Jt = "columnResize", en = "columnReorder", tn = "columnLock", nn = "columnUnlock", on = "click", rn = "height", an = "tabIndex", sn = "function", ln = "string", cn = "Are you sure you want to delete this record?", dn = "No records available.", hn = "Delete", un = "Cancel", fn = /(\}|\#)/gi, pn = /#/gi, gn = "[\\x20\\t\\r\\n\\f]", mn = RegExp("(^|" + gn + ")(k-group-cell|k-hierarchy-cell)(" + gn + "|$)"), vn = RegExp("(^|" + gn + ")(k-filter-row)(" + gn + "|$)"), _n = '<a class="k-button k-button-icontext #=className#" #=attr# href="\\#"><span class="#=iconClass# #=imageClass#"></span>#=text#</a>', wn = !1, yn = dt.support.browser, bn = yn.msie && 7 == yn.version, xn = yn.msie && 8 == yn.version, kn = gt.extend({
            init: function (e, t) {
            ...
            }, options: {name: "VirtualScrollable", itemHeight: e.noop, prefetch: !0}, destroy: function () {
                var e = this;
                ...
                var t, n = this, i = dt.support.scrollbar() + 1, o = n.element;
                o.css({
                    width: "auto",
                    overflow: "hidden"
                }).css(wn ? "padding-left" : "padding-right", i), n.content = o.children().first(), t = n.wrapper = n.content.wrap('<div class="k-virtual-scrollable-wrap"/>').parent().bind("DOMMouseScroll" + Rt + " mousewheel" + Rt, Ct(n._wheelScroll, n)), dt.support.kineticScrollNeeded && (n.drag = new dt.UserEvents(n.wrapper, {
                    global: !0,
                    start: function (e) {
                        e.sender.capture()
                    },
                ...
                })), n.verticalScrollbar = e('<div class="k-scrollbar k-scrollbar-vertical" />').css({width: i}).appendTo(o).bind("scroll" + Rt, Ct(n._scroll, n))
            }, _wheelScroll: function (t) {
                if (!t.ctrlKey) {
                    var n = this.verticalScrollbar, i = n.scrollTop(), o = dt.wheelDeltaY(t);
                    !o || o > 0 && 0 === i || 0 > o && i + n[0].clientHeight == n[0].scrollHeight || (t.preventDefault(), e(t.currentTarget).one("wheel" + Rt, !1), this.verticalScrollbar.scrollTop(i + -o))
                }
            }, _scroll: function (e) {
                var t = this, n = !t.options.prefetch, i = e.currentTarget.scrollTop, o = t.dataSource, r = t.itemHeight, a = o.skip() || 0, s = t._rangeStart || a, l = t.element.innerHeight(), c = !!(t._scrollbarTop && t._scrollbarTop > i), d = Dt.max(Dt.floor(i / r), 0), h = Dt.max(d + Dt.floor(l / r), 0);
                ...
                var t, n = this._rangeStart || this.dataSource.skip() || 0, i = this.dataSource.pageSize();
                return t = e > n ? e - n + 1 : n - e - 1, t > i ? i : t
            }, scrollIntoView: function (e) {
                var t = this.wrapper[0], n = t.clientHeight, i = this._scrollTop || t.scrollTop, o = e[0].offsetTop, r = e[0].offsetHeight;
                i > o ? this.verticalScrollbar[0].scrollTop -= n / 2 : o + r >= i + n && (this.verticalScrollbar[0].scrollTop += n / 2)
            }, _fetch: function (t, n, i) {
                var o = this, r = o.dataSource, a = o.itemHeight, s = r.take(), l = o._rangeStart || r.skip() || 0, c = Dt.floor(t / s) * s, d = !1, h = .33;
                ...
                var n = this, i = !n.options.prefetch, o = n.dataSource;
                clearTimeout(n._timeout), n._fetching = !0, n._rangeStart = e, o.inRange(e, t) ? o.range(e, t) : (i || dt.ui.progress(n.wrapper.parent(), !0), n._timeout = setTimeout(function () {
                    n._scrolling || (i && dt.ui.progress(n.wrapper.parent(), !0), o.range(e, t))
                }, 100))
            }, repaintScrollbar: function () {
                var e, t = this, n = "", i = 25e4, o = t.dataSource, r = dt.support.kineticScrollNeeded ? 0 : dt.support.scrollbar(), a = t.wrapper[0], s = t.itemHeight = t.options.itemHeight() || 0, l = a.scrollWidth > a.offsetWidth ? r : 0, c = o.total() * s + l;
                ...
                var e = this, t = e.dataSource, n = e._rangeStart;
            ...
            save: {text: "Save changes", imageClass: "k-update", className: "k-grid-save-changes", iconClass: "k-icon"},
            destroy: {text: "Delete", imageClass: "k-delete", className: "k-grid-delete", iconClass: "k-icon"},
            edit: {text: "Edit", imageClass: "k-edit", className: "k-grid-edit", iconClass: "k-icon"},
            update: {text: "Update", imageClass: "k-update", className: "k-primary k-grid-update", iconClass: "k-icon"},
            canceledit: {text: "Cancel", imageClass: "k-cancel", className: "k-grid-cancel", iconClass: "k-icon"},
            excel: {text: "Export to Excel", imageClass: "k-i-excel", className: "k-grid-excel", iconClass: "k-icon"},
            pdf: {text: "Export to PDF", imageClass: "k-i-pdf", className: "k-grid-pdf", iconClass: "k-icon"}
            ...
            init: function (t, n, i) {
                ...
                n = bt(n) ? {dataSource: n} : n, gt.fn.init.call(o, t, n), i && (o._events = i), wn = dt.support.isRtl(t), o._element(), o._aria(), o._columns(o.options.columns), o._dataSource(), o._tbody(), o._pageable(), o._thead(), o._groupable(), o._toolbar(), o._setContentHeight(), o._templates(), o._navigatable(), o._selectable(), o._clipboard(), o._details(), o._editable(), o._attachCustomCommandsEvent(), o._minScreenSupport(), o.options.autoBind ? o.dataSource.fetch() : o._footer(), o.lockedContent && (o.wrapper.addClass("k-grid-lockedcolumns"), o._resizeHandler = function () {
                    o.resize()
                }, e(window).on("resize" + Rt, o._resizeHandler)), dt.notify(o)
            },
            events: [Wt, "dataBinding", "cancel", $t, Yt, Qt, Ht, Vt, Ut, Ft, Ot, Nt, qt, Jt, en, Gt, jt, tn, nn],
            setDataSource: function (e) {
                var t = this, n = t.options.scrollable;
            ...
            options: {
                ...
                mobile: "",
                messages: {
                    editable: {cancelDelete: un, confirmation: cn, confirmDelete: hn},
                    commands: {
            ...
            _destroyColumnAttachments: function () {
                ...
                t.resizeHandle = null, t.thead && (this.angular("cleanup", function () {
                    return {elements: t.thead.get()}
                }), t.thead.add(t.lockedHeader).find("th").each(function () {
                    var t = e(this), n = t.data("kendoFilterMenu"), i = t.data("kendoColumnSorter"), o = t.data("kendoColumnMenu");
                    n && n.destroy(), i && i.destroy(), o && o.destroy()
                }))
            },
            _attachCustomCommandsEvent: function () {
                var e, t, n, i = this, o = O(i.columns || []);
            ...
            _createResizeHandle: function (t, n) {
                var i, o, r, a, s, l, c, d = this, h = d.options.columnResizeHandleWidth, u = d.options.scrollable, f = d.resizeHandle, p = this._groups();
                if (f && d.lockedContent && f.data("th")[0] !== n[0] && (f.off(Rt).remove(), f = null), f || (f = d.resizeHandle = e('<div class="k-resize-handle"><div class="k-resize-handle-inner"></div></div>'), t.append(f)), wn)i = n.position().left, u && (a = n.closest(".k-grid-header-wrap, .k-grid-header-locked"), s = yn.msie ? a.scrollLeft() : 0, l = yn.webkit ? a[0].scrollWidth - a[0].offsetWidth - a.scrollLeft() : 0, c = yn.mozilla ? a[0].scrollWidth - a[0].offsetWidth - (a[0].scrollWidth - a[0].offsetWidth - a.scrollLeft()) : 0, i -= l - c + s); else {
            ...
            _positionColumnResizeHandle: function () {
                var t = this, n = t.options.columnResizeHandleWidth, i = t.lockedHeader ? t.lockedHeader.find("thead:first") : e();
                t.thead.add(i).on("mousemove" + Rt, "th", function (i) {
                    var r, a, s, l = e(this);
                    l.hasClass("k-group-cell") || l.hasClass("k-hierarchy-cell") || (r = i.clientX, a = e(window).scrollLeft(), s = l.offset().left + (wn ? 0 : this.offsetWidth), r + a > s - n && s + n > r + a ? t._createResizeHandle(l.closest("div"), l) : t.resizeHandle ? t.resizeHandle.hide() : o(t.wrapper, ""))
                })
            },
            ...
            _positionColumnResizeHandleTouch: function () {
                var t = this, n = t.lockedHeader ? t.lockedHeader.find("thead:first") : e();
            ...
            _resizable: function () {
                ...
                d.resizable && (t = d.scrollable ? c.wrapper.find(".k-grid-header-wrap:first") : c.wrapper, h ? c._positionColumnResizeHandleTouch(t) : c._positionColumnResizeHandle(t), c.resizable && c.resizable.destroy(), c.resizable = new ht.Resizable(t.add(c.lockedHeader), {
                    ...
                    resizeend: function () {
                        ...
                        o(c.wrapper, ""), yn.webkit && c.wrapper.removeClass("k-grid-column-resizing"), i != r && (t = c.lockedHeader ? c.lockedHeader.find("thead:first tr:first").add(c.thead.find("tr:first")) : l.parent(), n = l.attr(dt.attr("index")), n || (n = t.find("th:not(.k-group-cell):not(.k-hierarchy-cell)").index(l)), e = O(c.columns)[n], e.width = r, c.trigger(Jt, {
                            column: e,
                            oldWidth: i,
                            newWidth: r
            ...
            _reorderable: function () {
                ...
                n.options.reorderable && (n.wrapper.data("kendoReorderable") && n.wrapper.data("kendoReorderable").destroy(), t = function (e, t, i) {
                    var o = e[t], r = e[i], a = c(o, n.columns);
                    return e = a ? a.columns : n.columns, xt(r, e)
                }, n.wrapper.kendoReorderable({
                    draggable: n._draggableInstance, dragOverContainers: function (e, i) {
                        var o = S(n.columns);
                        ...
                        var i = S(n.columns), o = i[e.oldIndex], r = t(i, e.oldIndex, e.newIndex);
                        n.trigger(en, {
                            newIndex: r,
                            oldIndex: xt(o, i),
                            column: o
            ...
            _reorderHeader: function (e, t, n) {
                var i, o, s, l, c = this, d = b(e[0], c.columns), h = b(t, c.columns), u = [];
            ...
            _reorderContent: function (t, n, i) {
                var o, s, l, c, d = this, h = e(), u = t[0], f = p(t), g = xt(u, O(d.columns)), m = xt(n, O(d.columns)), v = xt(u, F(d.columns)), _ = xt(n, F(d.columns)), w = B(d.columns).length, y = !!n.locked, b = d.footer || d.wrapper.find(".k-grid-footer"), x = o = _;
            ...
            autoFitColumn: function (t) {
                var n, i, o, r, a, s, l, c, d, h, p, g, m, v, _, w, y, b = this, x = b.options, k = b.columns, C = b.lockedHeader ? N(b.lockedHeader.find(">table>thead")).filter(u).length : 0, S = "col:not(.k-group-col):not(.k-hierarchy-col)", D = "td:visible:not(.k-group-cell):not(.k-hierarchy-cell)";
                if (t = "number" == typeof t ? k[t] : vt(t) ? yt(T(k), function (e) {
                        return e === t
                    })[0] : yt(T(k), function (e) {
                        return e.field === t
                    })[0], t && f(t)) {
                    for (n = xt(t, O(k)), r = t.locked, o = r ? b.lockedHeader.children("table") : b.thead.parent(), i = o.find("[data-index='" + n + "']"), s = r ? b.lockedTable : b.table, l = b.footer || e(), b.footer && b.lockedContent && (l = b.footer.children(r ? ".k-grid-footer-locked" : ".k-grid-footer-wrap")), c = l.find("table").first(), b.lockedHeader && !r && (n -= C), d = 0; k.length > d && k[d] !== t; d++)k[d].hidden && n--;
                    if (a = x.scrollable ? o.find(S).eq(n).add(s.children("colgroup").find(S).eq(n)).add(c.find("colgroup").find(S).eq(n)) : s.children("colgroup").find(S).eq(n), h = o.add(s).add(c), p = i.outerWidth(), a.width(""), h.css("table-layout", "fixed"), a.width("auto"), h.addClass("k-autofitting"), h.css("table-layout", ""), g = Math.ceil(Math.max(i.outerWidth(), s.find("tr:not(.k-grouping-row)").eq(0).children(D).eq(n).outerWidth(), c.find("tr").eq(0).children(D).eq(n).outerWidth())) + 1, a.width(g), t.width = g, x.scrollable) {
                        for (m = o.find("col"), _ = 0, w = 0, y = m.length; y > w; w += 1) {
            ...
            lockColumn: function (e) {
                ...
                e = "number" == typeof e ? n[e] : yt(n, function (t) {
                    return t.field === e
            ...
            _editable: function () {
                var t, n = this, i = n.selectable && n.selectable.options.multiple, o = n.options.editable, r = function () {
                    var t = pt(), i = n._editContainer;
                ...
                o && (t = n._editMode(), "incell" === t ? o.update !== !1 && n.wrapper.on(on + Rt, "tr:not(.k-grouping-row) > td", function (t) {
                    var o = e(this), r = n.lockedTable && o.closest("table")[0] === n.lockedTable[0];
            ...
            editCell: function (t) {
                ...
                t = e(t), n = this, i = O(n.columns)[n.cellIndex(t)], o = n._modelForContainer(t), n.closeCell(), !o || o.editable && !o.editable(i.field) || i.command || !i.field || (n._attachModelChange(o), n._editContainer = t, n.editable = t.addClass("k-edit-cell").kendoEditable({
                    fields: {
                        ...
                        editor: i.editor,
                        values: i.values
                    }, model: o, target: n, change: function (e) {
                        n.trigger(Ot, {values: e.values, container: t, model: o}) && e.preventDefault()
                    }
                }).data("kendoEditable"), r = t.parent().addClass("k-grid-edit-row"), n.lockedContent && it(r[0], n._relatedRow(r).addClass("k-grid-edit-row")[0]), n.trigger(Ft, {
                    container: t,
                    model: o
                }))
            },
            _adjustLockedHorizontalScrollBar: function () {
                var e = this.table, t = e.parent(), n = e[0].offsetWidth > t[0].clientWidth ? dt.support.scrollbar() : 0;
            ...
            closeCell: function (t) {
                var n, i, o, r, a = this, s = a._editContainer;
                s && (n = s.closest("tr").attr(dt.attr("uid")), r = a.dataSource.getByUid(n), t && a.trigger("cancel", {
                    container: s,
                    model: r
                }) || (s.removeClass("k-edit-cell"), i = O(a.columns)[a.cellIndex(s)], o = s.parent().removeClass("k-grid-edit-row"), a._destroyEditable(), a._displayCell(s, i, r), s.hasClass("k-dirty-cell") && e('<span class="k-dirty"/>').prependTo(s), a.lockedContent && it(o.css("height", "")[0], a._relatedRow(o).css("height", "")[0])))
            },
            _displayCell: function (e, t, n) {
                var i = this, o = {
                    storage: {},
                    count: 0
                }, r = _t({}, dt.Template, i.options.templateSettings), a = dt.template(i._cellTmpl(t, o), r);
                o.count > 0 && (a = Ct(a, o.storage)), e.empty().html(a(n)), i.angular("compile", function () {
                    return {elements: e, data: [{dataItem: n}]}
                })
            },
            ...
            _removeRow: function (t) {
                var n, i = this, o = i._editMode();
                "incell" !== o && i.cancelRow(), t = e(t), i.lockedContent && (t = t.add(i._relatedRow(t))), t = t.hide(), n = i._modelForContainer(t), n && !i.trigger(Nt, {
                    row: t,
                    model: n
            ...
            editRow: function (n) {
                var i, o, r, a = this;
                n instanceof dt.data.ObservableObject ? i = n : (n = e(n), i = a._modelForContainer(n)), o = a._editMode(), a.cancelRow(), i && (a._attachModelChange(i), "popup" === o ? a._createPopupEditor(i) : "inline" === o ? a._createInlineEditor(n, i) : "incell" === o && e(n).children(Mt).each(function () {
                    var n = e(this), o = O(a.columns)[n.index()];
            ...
            _editCancelClick: function (t) {
                var n, i = this, o = i.options.navigatable, r = i.editable.options.model, a = i.editView ? i.editView.element : i._editContainer;
                t.preventDefault(), t.stopPropagation(), i.trigger("cancel", {
                    container: a,
                    model: r
                }) || (n = i.items().index(e(i.current()).parent()), i.cancelRow(), o && (i.current(i.items().eq(n).children().filter(Bt).first()), rt(i.table, !0)))
            },
            _createPopupEditor: function (n) {
                var i, o, r, a, s, l, c, d, h, u, f, p = this, g = "<div " + dt.attr("uid") + '="' + n.uid + '" class="k-popup-edit-form' + (p._isMobile ? " k-mobile-list" : "") + '"><div class="k-edit-form-container">', m = [], v = O(p.columns), _ = p.options.editable, w = _.template, y = vt(_) ? _.window : {}, b = _t({}, dt.Template, p.options.templateSettings);
                if (y = y || {}, w)for (typeof w === ln && (w = window.unescape(w)), g += dt.template(w, b)(n), r = 0, a = v.length; a > r; r++)i = v[r], i.command && (d = ot(i.command, "edit"), d && (o = d)); else for (r = 0, a = v.length; a > r; r++)i = v[r], i.command ? i.command && (d = ot(i.command, "edit"), d && (o = d)) : (g += '<div class="k-edit-label"><label for="' + i.field + '">' + (i.title || i.field || "") + "</label></div>", n.editable && !n.editable(i.field) || !i.field ? (u = {
                    storage: {},
                    count: 0
                }, s = dt.template(p._cellTmpl(i, u), b), u.count > 0 && (s = Ct(s, u.storage)), g += '<div class="k-edit-field">' + s(n) + "</div>") : (m.push({
                    field: i.field,
                    format: i.format,
                    editor: i.editor,
                    values: i.values
                }), g += "<div " + dt.attr("container-for") + '="' + i.field + '" class="k-edit-field"></div>'));
                o && vt(o) && (o.text && vt(o.text) && (l = o.text.update, c = o.text.cancel), o.attr && (h = o.attr)), p._isMobile ? (g += "</div></div>", p.editView = p.pane.append("<div data-" + dt.ns + 'role="view" data-' + dt.ns + 'init-widgets="false" class="k-grid-edit-form"><div data-' + dt.ns + 'role="header" class="k-header">' + p._createButton({
                        name: "update",
                        text: l,
                        attr: h
                    ...
                    close: function (i) {
                        if (i.userTriggered) {
                            ...
                            p.cancelRow(), p.options.navigatable && (p.current(p.items().eq(o).children().filter(Bt).first()), rt(p.table, !0))
                        }
                    }
                ...
                }), p._openPopUpEditor(), p.trigger(Ft, {container: f, model: n})
            },
            ...
            _createInlineEditor: function (t, n) {
                ...
                a.lockedContent && (t = t.add(a._relatedRow(t))), t.children(":not(.k-group-cell,.k-hierarchy-cell)").each(function () {
                    if (o = e(this), i = O(a.columns)[a.cellIndex(o)], i.command || !i.field || n.editable && !n.editable(i.field)) {
                        if (i.command && (r = ot(i.command, "edit"))) {
                            o.empty();
                            var t, l, c;
                            vt(r) && (r.text && vt(r.text) && (t = r.text.update, l = r.text.cancel), r.attr && (c = r.attr)), e(a._createButton({
                                    ...
                                    text: t,
                                    attr: c
                                }) + a._createButton({name: "canceledit", text: l, attr: c})).appendTo(o)
                        }
                    } else s.push({
                        field: i.field,
                        format: i.format,
                        editor: i.editor,
                        values: i.values
                    }), o.attr(dt.attr("container-for"), i.field), o.empty()
                }), a._editContainer = t, a.editable = new dt.ui.Editable(t.addClass("k-grid-edit-row"), {
                    target: a,
                    fields: s,
                    model: n,
                    clearContainer: !1
                }), t.length > 1 && (it(t[0], t[1]), a._applyLockedContainersWidth()), a.trigger(Ft, {
                    container: t,
                    model: n
                })
            },
            ...
            saveRow: function () {
                ...
                t && i && i.end() && !e.trigger(Ot, {container: t, model: n}) && e.dataSource.sync()
            },
            _displayRow: function (t) {
                var n, i, o, r = this, a = r._modelForContainer(t), s = t.hasClass("k-state-selected"), l = t.hasClass("k-alt");
                a && (r.lockedContent && (n = e((l ? r.lockedAltRowTemplate : r.lockedRowTemplate)(a)), r._relatedRow(t.last()).replaceWith(n)), r.angular("cleanup", function () {
                    ...
                    return {elements: i.get(), data: [{dataItem: a}]}
                }), s && r.options.selectable && r.select(i.add(n)), n && it(i[0], n[0]), o = i.next(), o.hasClass("k-detail-row") && o.is(":visible") && i.find(".k-hierarchy-cell .k-icon").removeClass("k-plus").addClass("k-minus"))
            },
            _showMessage: function (t, n) {
                var i, o, r, a = this;
                return a._isMobile ? (i = dt.template('<ul><li class="km-actionsheet-title">#:title#</li><li><a href="\\#" class="k-button k-grid-delete">#:confirmDelete#</a></li></ul>'), o = e(i(t)).appendTo(a.view.element), r = a._actionSheet = new dt.mobile.ui.ActionSheet(o, {
            ...
            _confirmation: function (e) {
                var t = this, n = t.options.editable, i = n === !0 || typeof n === ln ? t.options.messages.editable.confirmation : n.confirmation;
            ...
            addRow: function () {
                var e, t, n, i, o, r, a = this, s = a.dataSource, l = a._editMode(), c = a.options.editable.createAt || "", d = s.pageSize(), h = s.view() || [];
            ...
            _firstEditableColumnIndex: function (e) {
                var t, n, i, o = this, r = O(o.columns), a = o._modelForContainer(e);
                for (n = 0, i = r.length; i > n; n++)if (t = r[n], a && (!a.editable || a.editable(t.field)) && !t.command && t.field && t.hidden !== !0)return n;
                return -1
            },
            _toolbar: function () {
                var t, n = this, i = n.wrapper, o = n.options.toolbar, r = n.options.editable;
                o && (t = n.wrapper.find(".k-grid-toolbar"), t.length || (St(o) || (o = typeof o === ln ? o : n._toolbarTmpl(o).replace(pn, "\\#"), o = Ct(dt.template(o), n)), t = e('<div class="k-header k-grid-toolbar" />').html(o({})).prependTo(i), n.angular("compile", function () {
                    return {elements: t.get()}
            ...
            _toolbarTmpl: function (e) {
                var t, n, i = this, o = "";
                if (bt(e))for (t = 0, n = e.length; n > t; t++)o += i._createButton(e[t]);
                return o
            },
            _createButton: function (e) {
                var n, o = e.template || _n, r = typeof e === ln ? e : e.name || e.text, a = Cn[r] ? Cn[r].className : "k-grid-" + (r || "").replace(/\s/g, ""), s = {
                    className: a,
                    text: r,
                    imageClass: "",
                    attr: "",
                ...
                return vt(e) ? (e.className && xt(s.className, e.className.split(" ")) < 0 ? e.className += " " + s.className : e.className === t && (e.className = s.className), "edit" === r && vt(e.text) && (e = _t(!0, {}, e), e.text = e.text.edit), e.attr && (vt(e.attr) && (e.attr = i(e.attr)), typeof e.attr === ln && (n = e.attr.match(/class="(.+?)"/), n && xt(n[1], e.className.split(" ")) < 0 && (e.className += " " + n[1]))), s = _t(!0, s, Cn[r], {text: l[r]}, e)) : s = _t(!0, s, Cn[r], {text: l[r]}), dt.template(o)(s)
            },
            ...
            _attachGroupable: function () {
                var t = this, n = t.wrapper, i = t.options.groupable, o = Lt + "[" + dt.attr("field") + "]", r = t.content ? ".k-grid-header:first " + o : "table:first>.k-grid-header " + o;
                i && i.enabled !== !1 && (n.has("div.k-grouping-header")[0] || e("<div>&nbsp;</div>").addClass("k-grouping-header").prependTo(n), t.groupable && t.groupable.destroy(), t.groupable = new ht.Groupable(n, _t({}, i, {
            ...
            _selectable: function () {
                var n, i, o, r, a = this, s = [], l = a._isLocked(), c = a.options.selectable;
                c && (a.selectable && a.selectable.destroy(), c = dt.ui.Selectable.parseOptions(c), n = c.multiple, i = c.cell, a._hasDetails() && (s[s.length] = ".k-detail-row"), (a.options.groupable || a._hasFooters()) && (s[s.length] = ".k-grouping-row,.k-group-footer"), s = s.join(","), "" !== s && (s = ":not(" + s + ")"), o = a.table, l && (o = o.add(a.lockedTable)), r = ">" + (i ? Et : "tbody>tr" + s), a.selectable = new dt.ui.Selectable(o, {
                    filter: r,
                    aria: !0,
                    multiple: n,
                    change: function () {
            ...
            _clipboard: function () {
                var e, t = this.options, n = t.selectable;
                ...
                }).on("mousedown" + Rt, It + ">" + Bt, Ct(at, e)), e.copyHandler = Ct(e.copySelection, e), e.updateClipBoardState = function () {
            ...
            getTSV: function () {
                var t, n, i, o, r, a, s = this, l = s.select(), c = "	", d = s.options.allowCopy, h = !0;
            ...
            hideMinScreenCols: function () {
                var e, n, i, o = this.columns, r = !1, a = window.innerWidth > 0 ? window.innerWidth : screen.width;
            ...
            _scrollCurrent: function () {
                var t, n, i, o, r, a, s = this._current, l = this.options.scrollable;
            ...
            _scrollTo: function (t, n) {
                var i, o = t.tagName.toLowerCase(), r = "td" === o || "th" === o, a = t[r ? "offsetLeft" : "offsetTop"], s = t[r ? "offsetWidth" : "offsetHeight"], l = n[r ? "scrollLeft" : "scrollTop"], c = n[r ? "clientWidth" : "clientHeight"], d = a + s, h = 0, u = 0, f = 0;
                wn && r && (i = e(t).closest("table")[0], yn.msie ? u = i.offsetLeft : yn.mozilla && (f = i.offsetLeft - dt.support.scrollbar())), l = Math.abs(l + u - f), h = l > a ? a : d > l + c ? c >= s ? d - c : a : l, h = Math.abs(h + u) + f, n[r ? "scrollLeft" : "scrollTop"] = h
            },
            _navigatable: function () {
                ...
                o.options.navigatable && (t = o.table.add(o.lockedTable), n = o.thead.parent().add(e(">table", o.lockedHeader)), i = t, o.options.scrollable && (i = i.add(n), n.attr(an, -1)), this._navigatableTables = i, i.off("mousedown" + Rt + " focus" + Rt + " focusout" + Rt + " keydown" + Rt), n.on("keydown" + Rt, Ct(o._openHeaderMenu, o)).find("a.k-link").attr("tabIndex", -1), t.attr(an, Dt.max(t.attr(an) || 0, 0)).on("mousedown" + Rt + " keydown" + Rt, ".k-detail-cell", function (e) {
                    e.target !== e.currentTarget && e.stopImmediatePropagation()
                }), i.on(dt.support.touch ? "touchstart" + Rt : "mousedown" + Rt, It + ">" + Bt, Ct(at, o)).on("focus" + Rt, Ct(o._tableFocus, o)).on("focusout" + Rt, Ct(o._tableBlur, o)).on("keydown" + Rt, Ct(o._tableKeyDown, o)))
            },
            ...
            _tableFocus: function (t) {
                var n, i;
                dt.support.touch || (n = this.current(), i = e(t.currentTarget), n && n.is(":visible") ? n.addClass(Xt) : this.current(i.find(zt)), this._setTabIndex(i))
            },
            _tableBlur: function () {
                var e = this.current();
                e && e.removeClass(Xt)
            ...
            _tableKeyDown: function (n) {
                var i, o = this.current(), r = this.virtualScrollable && this.virtualScrollable.fetching(), a = e(n.target), s = !n.isDefaultPrevented() && !a.is(":button,a,:input,a>.k-icon");
            ...
            _moveLeft: function (e, t) {
                var n, i, o = e.parent(), r = o.parent();
                return t ? this.collapseRow(o) : (i = r.find(It).index(o), n = this._prevHorizontalCell(r, e, i), n[0] || (r = this._horizontalContainer(r), n = this._prevHorizontalCell(r, e, i), n[0] !== e[0] && rt(r.parent(), !0)), this.current(n)), !0
            },
            _moveRight: function (e, t) {
                var n, i, o = e.parent(), r = o.parent();
                return t ? this.expandRow(o) : (i = r.find(It).index(o), n = this._nextHorizontalCell(r, e, i), n[0] || (r = this._horizontalContainer(r, !0), n = this._nextHorizontalCell(r, e, i), n[0] !== e[0] && rt(r.parent(), !0)), this.current(n)), !0
            },
            _moveUp: function (e) {
                var t = e.parent().parent(), n = this._prevVerticalCell(t, e);
                return n[0] || (t = this._verticalContainer(t, !0), n = this._prevVerticalCell(t, e), n[0] && rt(t.parent(), !0)), this.current(n), !0
            },
            _moveDown: function (e) {
                var t = e.parent().parent(), n = this._nextVerticalCell(t, e);
                return n[0] || (t = this._verticalContainer(t), n = this._nextVerticalCell(t, e), n[0] && rt(t.parent(), !0)), this.current(n), !0
            },
            ...
            _handleEscKey: function (t, n) {
                var i, o = pt(), r = "incell" == this._editMode();
                return st(t) ? (r ? this.closeCell(!0) : (i = e(t).parent().index(), o && o.blur(), this.cancelRow(), i >= 0 && this.current(this.items().eq(i).children(Bt).first())), yn.msie && 9 > yn.version && document.body.focus(), rt(n, !0), !0) : t.has(o).length ? (rt(n, !0), !0) : !1
            },
            ...
            _handleEnterKey: function (t, n, i) {
                var o, r = this.options.editable, a = i.closest("[role=gridcell]");
            ...
            _prevVerticalCell: function (t, n) {
                var i, o = n.parent(), r = t.children(It), a = r.index(o), s = this._currentDataIndex(t, n);
            ...
            _nextVerticalCell: function (e, n) {
                var i, o = n.parent(), r = e.children(It), a = r.index(o), s = this._currentDataIndex(e, n);
            ...
            _verticalContainer: function (e, t) {
                var n = e.parent(), i = this._navigatableTables.length, o = Math.floor(i / 2), r = xt(n[0], this._navigatableTables);
            ...
            _tabNext: function (e, t, n) {
                var i = !0, o = n ? e.prevAll(Mt + ":first") : e.nextAll(":visible:first");
            ...
            _handleEditing: function (n, i, o) {
                var r, a, s = this, l = e(pt()), c = s._editMode(), d = yn.msie, h = d && 9 > yn.version, u = s._editContainer;
                if (o = e(o), a = "incell" == c ? n.hasClass("k-edit-cell") : n.parent().hasClass("k-grid-edit-row"), s.editable) {
                    if (e.contains(u[0], l[0]) && (yn.opera || h ? l.change().triggerHandler("blur") : (l.blur(), d && l.blur())), !s.editable)return rt(o), t;
                ...
                i && s.current(i), h && document.body.focus(), rt(o, !0), (!a && !i || i) && ("incell" == c ? s.editCell(s.current()) : s.editRow(s.current().parent()))
            },
            _wrapper: function () {
            ...
            _initMobile: function () {
                ...
                this._isMobile = n.mobile === !0 && dt.support.mobileOS || "phone" === n.mobile || "tablet" === n.mobile, this._isMobile && (t = this.wrapper.addClass("k-grid-mobile").wrap("<div data-" + dt.ns + 'role="view" data-' + dt.ns + 'init-widgets="false"></div>').parent(), this.pane = dt.mobile.ui.Pane.wrap(t), this.view = this.pane.view(), this._actionSheetPopupOptions = e(document.documentElement).hasClass("km-root") ? {modal: !1} : {
                    align: "bottom center",
            ...
            _scrollable: function () {
                var t, n, i, o, r = this, a = r.options, s = a.scrollable, l = s !== !0 && s.virtual && !r.virtualScrollable, c = !dt.support.kineticScrollNeeded || l ? dt.support.scrollbar() : 0;
                s && (t = r.wrapper.children(".k-grid-header"), t[0] || (t = e('<div class="k-grid-header" />').insertBefore(r.table)), t.css(wn ? "padding-left" : "padding-right", s.virtual ? c + 1 : c), n = e('<table role="grid" />'), bn && n.attr("cellspacing", 0), n.width(r.table[0].style.width), n.append(r.thead), t.empty().append(e('<div class="k-grid-header-wrap" />').append(n)), r.content = r.table.parent(), r.content.is(".k-virtual-scrollable-wrap, .km-scroll-container") && (r.content = r.content.parent()), r.content.is(".k-grid-content, .k-virtual-scrollable-wrap") || (r.content = r.table.wrap('<div class="k-grid-content" />').parent()), l && (r.virtualScrollable = new kn(r.content, {
                    ...
                    r.scrollables.scrollLeft(this.scrollLeft), r.lockedContent && (r.lockedContent[0].scrollTop = this.scrollTop)
                }), o = r.content.data("kendoTouchScroller"), o && o.destroy(), o = dt.touchScroller(r.content), o && o.movable && (r.touchScroller = o, o.movable.bind("change", function (e) {
            ...
            _renderNoRecordsContent: function () {
                var t, n = this;
                n.options.noRecords && (t = n.table.parent().children("." + Zt), t.length && t.remove(), n.dataSource && n.dataSource.view().length || e(n.noRecordsTemplate({})).insertAfter(n.table))
            },
            _setContentWidth: function (t) {
                var n, i = this, o = "k-grid-content-expander", r = '<div class="' + o + '"></div>', a = i.resizable;
            ...
            _applyLockedContainersWidth: function () {
                if (this.options.scrollable && this.lockedHeader) {
                    var e, t = this.thead.parent(), n = t.parent(), i = this.wrapper[0].clientWidth, o = this._groups(), r = dt.support.scrollbar(), a = this.lockedHeader.find(">table>colgroup>col:not(.k-group-col, .k-hierarchy-col)"), s = t.find(">colgroup>col:not(.k-group-col, .k-hierarchy-col)"), l = A(a), c = A(s);
            ...
            _setContentHeight: function () {
                var e, t = this, n = t.options, i = t.wrapper.innerHeight(), o = t.wrapper.children(".k-grid-header"), r = dt.support.scrollbar();
            ...
            _averageRowHeight: function () {
                var e, t = this, n = t._items(t.tbody).length, i = t._rowHeight;
            ...
            _modelChange: function (t) {
                var n, i, o, r, a, s, l, c, d, h, u = this, f = u.tbody, p = t.model, g = u.tbody.find("tr[" + dt.attr("uid") + "=" + p.uid + "]"), m = g.hasClass("k-alt"), v = u._items(f).index(g), _ = u.lockedContent;
                if (_ && (n = u._relatedRow(g)), g.add(n).children(".k-edit-cell").length && !u.options.rowTemplate)g.add(n).children(":not(.k-group-cell,.k-hierarchy-cell)").each(function () {
                    ...
                    for (s = e().add(g), _ && (r = (m ? u.lockedAltRowTemplate : u.lockedRowTemplate)(p), s = s.add(n), n.replaceWith(r)), u.angular("cleanup", function () {
                        return {elements: s.get()}
                    }), r = (m ? u.altRowTemplate : u.rowTemplate)(p), g.replaceWith(r), r = u._items(f).eq(v), h = [{dataItem: p}], _ && (g = g.add(n), n = u._relatedRow(r)[0], it(r[0], n), r = r.add(n), h.push({dataItem: p})), u.angular("compile", function () {
                        return {elements: r.get(), data: h}
                    ...
                    u.trigger("itemChange", {item: r, data: p, ns: ht})
                }
            },
            _pageable: function () {
                var t, n = this, i = n.options.pageable;
                i && (t = n.wrapper.children("div.k-grid-pager"), t.length || (t = e('<div class="k-pager-wrap k-grid-pager"/>').appendTo(n.wrapper)), n.pager && n.pager.destroy(), n.pager = "object" == typeof i && i instanceof dt.ui.Pager ? i : new dt.ui.Pager(t, _t({}, i, {dataSource: n.dataSource})))
            },
            _footer: function () {
                var t, n, i, o, r = this, a = r.dataSource.aggregates(), s = "", l = r.footerTemplate, c = r.options, d = r.footer || r.wrapper.find(".k-grid-footer");
                l ? (s = e(r._wrapFooter(l(a))), d.length ? (n = s, r.angular("cleanup", function () {
                    return {elements: d.get()}
                    ...
                    return {
                        ...
                        data: wt(r.columns, function (e) {
                            return {column: e, aggregate: a[e.field]}
                        })
                    }
            ...
            _wrapFooter: function (t) {
                var n = this, i = "", o = dt.support.mobileOS ? 0 : dt.support.scrollbar();
                return n.options.scrollable ? (i = e('<div class="k-grid-footer"><div class="k-grid-footer-wrap"><table' + (bn ? ' cellspacing="0"' : "") + "><tbody>" + t + "</tbody></table></div></div>"), n._appendCols(i.find("table")), i.css(wn ? "padding-left" : "padding-right", o), i) : '<tfoot class="k-grid-footer">' + t + "</tfoot>"
            },
            _columnMenu: function () {
                var e, n, i, o, r, a, s, l, c, d = this, h = O(d.columns), u = d.options, f = u.columnMenu, p = yt(d.columns, function (e) {
                        return e.columns !== t
                    }).length > 0, g = this._isMobile, m = function (e) {
                    d.trigger(Ut, {field: e.field, container: e.container})
                }, v = function (e) {
                    rt(e.closest("table"), !0)
                }, _ = u.$angular;
                if (f)for ("boolean" == typeof f && (f = {}), a = N(d.thead), s = 0, l = a.length; l > s; s++)n = h[s], c = a.eq(s), n.command || !n.field && !c.attr("data-" + dt.ns + "field") || (e = c.data("kendoColumnMenu"), e && e.destroy(), o = n.sortable !== !1 && f.sortable !== !1 && u.sortable !== !1 ? _t({}, u.sortable, {compare: (n.sortable || {}).compare}) : !1, r = u.filterable && n.filterable !== !1 && f.filterable !== !1 ? _t({pane: d.pane}, u.filterable, n.filterable) : !1, n.filterable && n.filterable.dataSource && (r.forceUnique = !1, r.checkSource = n.filterable.dataSource), r && (r.format = n.format), i = {
            ...
            _filterable: function () {
                var e, t, n, i, o, r, a, s = this, l = O(s.columns), c = function (e) {
                    s.trigger(Vt, {field: e.field, container: e.container})
                }, d = function (e) {
                    rt(e.closest("table"), !0)
                }, h = s.options.filterable;
                if (h && typeof h.mode == ln && -1 == h.mode.indexOf("menu") && (h = !1), h && !s.options.columnMenu)for (t = N(s.thead), i = 0, o = t.length; o > i; i++)n = t.eq(i), l[i].filterable === !1 || l[i].command || !l[i].field && !n.attr("data-" + dt.ns + "field") || (e = n.data("kendoFilterMenu"), e && e.destroy(), e = n.data("kendoFilterMultiCheck"), e && e.destroy(), r = l[i].filterable, a = _t({}, h, r, {
            ...
            _filterRow: function () {
                ...
                if (f._hasFilterRow())for (t = O(f.columns), n = f.options.filterable, i = f.thead.find(".k-filter-row"), this._updateHeader(this.dataSource.group().length), o = 0; t.length > o; o++)if (a = t[o], s = f.options.filterable.operators, l = !1, c = e("<th/>"), d = a.field, a.hidden && c.hide(), i.append(c), d && a.filterable !== !1) {
                    if (h = a.filterable && a.filterable.cell || {}, r = f.options.dataSource, r instanceof ut && (r = f.options.dataSource.options), u = _t(!0, {}, n.messages), a.filterable && _t(!0, u, a.filterable.messages), h.enabled === !1) {
                        c.html("&nbsp;");
                        continue
                    }
                    h.dataSource && (r = h.dataSource, l = !0), a.filterable && a.filterable.operators && (s = a.filterable.operators), e("<span/>").attr(dt.attr("field"), d).kendoFilterCell({
            ...
            _sortable: function () {
                var e, t, n, i, o, r, a = this, s = O(a.columns), l = a.options.sortable;
                if (l) {
                    for (i = N(a.thead), o = 0, r = i.length; r > o; o++)e = s[o], e.sortable !== !1 && !e.command && e.field && (n = i.eq(o), t = n.data("kendoColumnSorter"), t && t.destroy(), n.attr("data-" + dt.ns + "field", e.field).kendoColumnSorter(_t({}, l, e.sortable, {
            ...
            _columns: function (t) {
                var n, i, o, r = this, a = r.table, s = a.find("col"), c = r.options.dataSource;
                if (t = t.length ? t : wt(a.find("th"), function (t, n) {
                        t = e(t);
                        var i = t.attr(dt.attr("sortable")), o = t.attr(dt.attr("filterable")), r = t.attr(dt.attr("type")), a = t.attr(dt.attr("groupable")), l = t.attr(dt.attr("field")), c = t.attr(dt.attr("title")), d = t.attr(dt.attr("menu"));
                    ...
                    q(r.element.find("tr:has(th):first"), o), t = i.concat(t)
                }
                r.columns = l(t, n)
            },
            _groups: function () {
            ...
            _tmpl: function (e, t, o, r) {
                var a, s, l, c, d = this, h = _t({}, dt.Template, d.options.templateSettings), u = t.length, f = {
                    storage: {},
                    count: 0
                }, p = d._hasDetails(), g = [], m = d._groups();
                if (!e) {
                    for (e = "<tr", o && g.push("k-alt"), p && g.push("k-master-row"), g.length && (e += ' class="' + g.join(" ") + '"'), u && (e += " " + dt.attr("uid") + '="#=' + dt.expr("uid", h.paramName) + '#"'), e += " role='row'>", m > 0 && !r && (e += n(m)), p && (e += '<td class="k-hierarchy-cell"><a class="k-icon k-plus" href="\\#" tabindex="-1"></a></td>'), a = 0; u > a; a++)l = t[a], s = l.template, c = typeof s, e += "<td" + i(l.attributes) + " role='gridcell'>", e += d._cellTmpl(l, f), e += "</td>";
                    e += "</tr>"
                }
                return e = dt.template(e, h), f.count > 0 ? Ct(e, f.storage) : e
            },
            _headerCellText: function (e) {
                var t = this, n = _t({}, dt.Template, t.options.templateSettings), i = e.headerTemplate, o = typeof i, r = e.title || e.field || "";
                return o === sn ? r = dt.template(i, n)({}) : o === ln && (r = i), r
            },
            _cellTmpl: function (e, t) {
                var n, i, o = this, r = _t({}, dt.Template, o.options.templateSettings), a = e.template, s = r.paramName, l = e.field, c = "", d = e.format, h = typeof a, u = e.values;
                if (e.command) {
                    if (bt(e.command)) {
                ...
                return h === sn ? (t.storage["tmpl" + t.count] = a, c += "#=this.tmpl" + t.count + "(" + s + ")#", t.count++) : h === ln ? c += a : u && u.length && vt(u[0]) && "value" in u[0] && l ? (c += "#var v =" + dt.stringify($(u)).replace(pn, "\\#") + "#", c += "#var f = v[", r.useWithBlock || (c += s + "."), c += l + "]#", c += "${f != null ? f : ''}") : (c += e.encoded ? "#:" : "#=", d && (c += 'kendo.format("' + d.replace(fn, "\\$1") + '",'), l ? (l = dt.expr(l, s), c += l + "==null?'':" + l) : c += "''", d && (c += ")"), c += "#"), c
            },
            _templates: function () {
                var t = this, n = t.options, i = t.dataSource, o = i.group(), r = t.footer || t.wrapper.find(".k-grid-footer"), a = i.aggregate(), s = O(t.columns), l = O(B(t.columns)), c = n.scrollable ? O(z(t.columns)) : s;
                ...
                t._hasDetails() && (t.detailTemplate = t._detailTmpl(n.detailTemplate || "")), (t._group && !Tt(a) || !Tt(a) && !r.length || yt(s, function (e) {
                    return e.footerTemplate
                }).length) && (t.footerTemplate = t._footerTmpl(s, a, "footerTemplate", "k-footer-template")), o && yt(s, function (e) {
            ...
            _noRecordsTmpl: function () {
                var t, n, i, o = '<div class="{0}">{1}</div>', r = '<div class="k-grid-norecords-template"{1}>{0}</div>', a = this.options.scrollable && !this.wrapper[0].style.height ? ' style="margin:0 auto;position:static;"' : "", s = {
                    storage: {},
                    count: 0
                }, l = e.extend({}, dt.Template, this.options.templateSettings), c = l.paramName, d = "";
                return t = this.options.noRecords.template ? this.options.noRecords.template : dt.format(r, this.options.messages.noRecords, a), n = typeof t, "function" === n ? (s.storage["tmpl" + s.count] = t, d += "#=this.tmpl" + s.count + "(" + c + ")#", s.count++) : "string" === n && (d += t), i = dt.template(dt.format(o, Zt, d), l), s.count > 0 && (i = e.proxy(i, s.storage)), i
            },
            _footerTmpl: function (e, t, o, r, a) {
                var s, l, c, d, h, u = this, f = _t({}, dt.Template, u.options.templateSettings), p = f.paramName, g = "", m = {}, v = 0, _ = {}, w = u._groups(), y = u.dataSource._emptyAggregates(t);
                for (g += '<tr class="' + r + '">', w > 0 && !a && (g += n(w)), u._hasDetails() && (g += '<td class="k-hierarchy-cell">&nbsp;</td>'), s = 0, l = e.length; l > s; s++)h = e[s], c = h[o], d = typeof c, g += "<td" + i(h.footerAttributes) + ">", c ? (d !== sn && (_ = y[h.field] ? _t({}, f, {paramName: p + "['" + h.field + "']"}) : {}, c = dt.template(c, _)), m["tmpl" + v] = c, g += "#=this.tmpl" + v + "(" + p + ")#", v++) : g += "&nbsp;", g += "</td>";
                return g += "</tr>", g = dt.template(g, f), v > 0 ? Ct(g, m) : g
            },
            _detailTmpl: function (e) {
                var t = this, i = "", o = _t({}, dt.Template, t.options.templateSettings), r = o.paramName, a = {}, s = 0, l = t._groups(), c = p(O(t.columns)).length, d = typeof e;
                return i += '<tr class="k-detail-row">', l > 0 && (i += n(l)), i += '<td class="k-hierarchy-cell"></td><td class="k-detail-cell"' + (c ? ' colspan="' + c + '"' : "") + ">", d === sn ? (a["tmpl" + s] = e, i += "#=this.tmpl" + s + "(" + r + ")#", s++) : i += e, i += "</td></tr>", i = dt.template(i, o), s > 0 ? Ct(i, a) : i
            },
            ...
            _hasFilterRow: function () {
                var t = this.options.filterable, n = t && typeof t.mode == ln && -1 != t.mode.indexOf("row"), i = this.columns, o = e.grep(i, function (e) {
            ...
            _details: function () {
                ...
                t.table.on(on + Rt, ".k-hierarchy-cell .k-plus, .k-hierarchy-cell .k-minus", function (n) {
                    var i, o, r = e(this), a = r.hasClass("k-plus"), s = r.closest("tr.k-master-row"), l = t.detailTemplate, c = t._hasDetails();
                    return r.toggleClass("k-plus", !a).toggleClass("k-minus", a), i = s.next(), c && !i.hasClass("k-detail-row") && (o = t.dataItem(s), i = e(l(o)).addClass(s.hasClass("k-alt") ? "k-alt" : "").insertAfter(s), t.angular("compile", function () {
                        return {elements: i.get(), data: [{dataItem: o}]}
                    }), t.trigger(Ht, {
                        masterRow: s,
                        detailRow: i,
                        data: o,
            ...
            dataItem: function (t) {
                ...
                var n, i, o = this.tbody.children(), r = /k-grouping-row|k-detail-row|k-group-footer/, a = t.sectionRowIndex;
            ...
            _createHeaderCells: function (e, n) {
                var o, r, a, s, l, c, d = this, h = "", u = O(d.columns);
                for (o = 0, s = e.length; s > o; o++)r = e[o].column || e[o], a = d._headerCellText(r), l = "", c = xt(r, u), r.command ? (h += "<th" + i(r.headerAttributes), n && !e[o].colSpan && (h += " rowspan='" + n + "'"), c > -1 && (h += dt.attr("index") + "='" + c + "'"), h += ">" + a + "</th>") : (r.field && (l = dt.attr("field") + "='" + r.field + "' "), h += "<th role='columnheader' " + l, n && !e[o].colSpan && (h += " rowspan='" + n + "'"), e[o].colSpan > 1 && (h += 'colspan="' + (e[o].colSpan - D(r.columns)) + '" ', h += dt.attr("colspan") + "='" + e[o].colSpan + "'"), r.title && (h += dt.attr("title") + '="' + r.title.replace('"', "&quot;").replace(/'/g, "'") + '" '), r.groupable !== t && (h += dt.attr("groupable") + "='" + r.groupable + "' "), r.aggregates && r.aggregates.length && (h += dt.attr("aggregates") + "='" + r.aggregates + "'"), c > -1 && (h += dt.attr("index") + "='" + c + "'"), h += i(r.headerAttributes), h += ">" + a + "</th>");
                return h
            },
            _appendLockedColumnContent: function () {
                var t, n, i, o, r, a = this.columns, s = this.table.find("colgroup"), l = s.find("col:not(.k-group-col,.k-hierarchy-col)"), c = e(), d = 0, h = 0;
                for (t = 0, n = a.length; n > t; t++)if (a[t].locked)if (f(a[t])) {
            ...
            _appendLockedColumnFooter: function () {
                var t, n, i = this, o = i.footer, r = o.find(".k-footer-template>td"), a = o.find(".k-grid-footer-wrap>table>colgroup>col"), s = e('<div class="k-grid-footer-locked"><table><colgroup /><tbody><tr class="k-footer-template"></tr></tbody></table></div>'), l = i._groups(), c = e(), d = e();
            ...
            _appendLockedColumnHeader: function (t) {
                var n, i, o, r, a, s, l, c, d, h, u, p = this, m = this.columns, v = [], _ = 0, w = e(), y = p._hasFilterRow(), b = 0, x = e(), k = 0, C = e(), S = p.thead.prev().find("col:not(.k-group-col,.k-hierarchy-col)"), T = p.thead.find("tr:first .k-header:not(.k-group-cell,.k-hierarchy-cell)"), A = p.thead.find(".k-filter-row").find("th:not(.k-group-cell,.k-hierarchy-cell)"), M = 0;
                for (n = 0, o = m.length; o > n; n++) {
                    if (m[n].locked) {
                        if (l = T.eq(n), k = O(m[n].columns || []).length, f(m[n])) {
                            for (m[n].columns && (c = k - D(m[n].columns)), c = c || 1, d = 0; c > d; d++)w = w.add(S.eq(n + M + d - _));
                            M += c - 1
                        }
                ...
                if (v.length) {
                    for (i = '<div class="k-grid-header-locked" style="width:1px"><table' + (bn ? ' cellspacing="0"' : "") + "><colgroup/><thead>", i += Array(v.length + 1).join("<tr></tr>"), i += (y ? '<tr class="k-filter-row" />' : "") + "</thead></table></div>", s = e(i), S = s.find("colgroup"), S.append(p.thead.prev().find("col.k-group-col").add(w)), r = s.find("thead tr:not(.k-filter-row)"), n = 0, o = v.length; o > n; n++)C = g(v[n]), r.eq(n).append(p.thead.find("tr:eq(" + n + ") .k-group-cell").add(C));
            ...
            _removeLockedContainers: function () {
                ...
                dt.destroy(e), e.off(Rt).remove(), this.lockedHeader = this.lockedContent = this.lockedFooter = null, this.selectable = null
            },
            _thead: function () {
                var t, n, i, o, r, a = this, s = a.columns, l = a._hasDetails() && s.length, c = a._hasFilterRow(), d = "", h = a.table.find(">thead"), u = a.element.find("thead:first").length > 0;
                ...
                c && (o = e("<tr/>"), o.addClass("k-filter-row"), (l || n.find(".k-hierarchy-cell").length) && o.prepend('<th class="k-hierarchy-cell">&nbsp;</th>'), r = (a.thead || h).find(".k-filter-row"), r.length && (dt.destroy(r), r.remove()), h.append(o)), n.children().length ? l && !n.find(".k-hierarchy-cell")[0] && n.prepend('<th class="k-hierarchy-cell">&nbsp;</th>') : (d = "", l && (d += '<th class="k-hierarchy-cell">&nbsp;</th>'), d += a._createHeaderCells(s), n.html(d)), n.attr("role", "row").find("th").addClass("k-header"), a.options.scrollable || h.addClass("k-grid-header"), n.find("script").remove().end().prependTo(h), a.thead && a._destroyColumnAttachments(), this.angular("cleanup", function () {
                    return {elements: h.find("th").get()}
                }), this.angular("compile", function () {
                    return {
                        elements: h.find("th").get(), data: wt(s, function (e) {
                            return {column: e}
                        })
                    }
            ...
            _updateFirstColumnClass: function () {
                var t, n, i = this, o = i.columns || [], r = i._hasDetails() && o.length;
            ...
            _prepareColumns: function (e, t, n, i) {
                var o, r, a = i || e[e.length - 1], s = e[a.index + 1], l = 0;
            ...
            _wheelScroll: function (t) {
                var n, i, o;
                t.ctrlKey || (n = this.content, this.options.scrollable.virtual && (n = this.virtualScrollable.verticalScrollbar), i = n.scrollTop(), o = dt.wheelDeltaY(t), o && (t.preventDefault(), e(t.currentTarget).one("wheel" + Rt, !1), n.scrollTop(i + -o)))
            },
            _isLocked: function () {
            ...
            _autoColumns: function (e) {
                if (e && e.toJSON) {
                    ...
                    for (t in e)i.columns.push({field: t, encoded: n, headerAttributes: {id: dt.guid()}});
                    i._thead(), i._templates()
                }
            },
            _rowsHtml: function (e, t) {
                var n, i, o = this, r = "", a = t.rowTemplate, s = t.altRowTemplate;
                for (n = 0, i = e.length; i > n; n++)r += n % 2 ? s(e[n]) : a(e[n]), o._data.push(e[n]);
                return r
            },
            _groupRowHtml: function (e, t, n, i, o, r) {
                var a, s, l = this, c = "", d = e.field, h = yt(O(l.columns), function (e) {
                        return e.field == d
                    })[0] || {}, u = h.groupHeaderTemplate, f = (h.title || d) + ": " + Y(e.value, h.format, h.values, h.encoded), p = l._groupAggregatesDefaultObject || {}, g = _t({}, p, e.aggregates), m = _t({}, {
                    field: e.field,
                    value: e.value,
                    aggregates: g
                }, e.aggregates[e.field]), v = o.groupFooterTemplate, _ = e.items;
                if (u && (f = typeof u === sn ? u(m) : dt.template(u)(m)), c += i(t, n, f), e.hasSubgroups)for (a = 0, s = _.length; s > a; a++)c += l._groupRowHtml(_[a], r ? t : t - 1, n + 1, i, o, r); else c += l._rowsHtml(_, o);
                return v && (c += v(g)), c
            },
            collapseGroup: function (t) {
                t = e(t);
                var n, i, o, r, a, s = this.options.groupable, l = s.showFooter, c = l ? 0 : 1, d = e();
            ...
            expandGroup: function (t) {
                t = e(t);
                var n, i, o, r, a, s = this, l = s.options.groupable.showFooter, c = e(), d = [], h = 1;
            ...
            _updateHeader: function (t) {
                var n = this, i = n._isLocked() ? n.lockedHeader.find("thead") : n.thead, o = i.find("tr.k-filter-row").find("th.k-group-cell").length, r = i.find("tr:first").find("th.k-group-cell").length, a = i.children("tr:not(:first)").filter(function () {
            ...
            hideColumn: function (n) {
                var i, o, r, s, l, c, d, g, m, v, _ = this, w = 0, y = _.footer || _.wrapper.find(".k-grid-footer"), b = _.columns, x = _.lockedHeader ? N(_.lockedHeader.find(">table>thead")).filter(u).length : 0;
                if (n = "number" == typeof n ? b[n] : vt(n) ? yt(T(b), function (e) {
                        return e === n
                    })[0] : yt(T(b), function (e) {
                        return e.field === n
                    })[0], n && f(n)) {
                    ...
                    if (m = xt(n, p(O(b))), h(n, !1), _._setParentsVisibility(n, !1), _._templates(), _._updateCols(), _._updateLockedCols(), v = _.thead, d = m, _.lockedHeader && x > m ? v = _.lockedHeader.find(">table>thead") : d -= x, i = N(v).filter(u).eq(d), i[0].style.display = "none", Q(a(e(">table>thead", _.lockedHeader), _.thead, ">tr.k-filter-row>th"), m, !1), y[0] && (_._updateCols(y.find(">.k-grid-footer-wrap>table")), _._updateLockedCols(y.find(">.k-grid-footer-locked>table")), Q(y.find(".k-footer-template>td"), m, !1)), _.lockedTable && x > m ? X(_.lockedTable.find(">tbody>tr"), m) : X(_.tbody.children(), m - x), _.lockedTable)_._updateTablesWidth(), _._applyLockedContainersWidth(), _._syncLockedContentHeight(), _._syncLockedHeaderHeight(), _._syncLockedFooterHeight(); else {
                        ...
                        }), _._footerWidth = w), yn.msie && 8 == yn.version && (o.css("display", "inline-table"), setTimeout(function () {
                            o.css("display", "table")
                        }, 1))
                    }
                    _._updateFirstColumnClass(), _.trigger(jt, {column: n})
                }
            },
            _setParentsVisibility: function (t, n) {
                var i, o, r, s, l, c = this.columns, u = [], f = n ? function (e) {
                    return p(e.columns).length && e.hidden
                } : function (e) {
                    return !p(e.columns).length && !e.hidden
                };
                if (d(t, c, u) && u.length)for (i = u.length - 1; i >= 0; i--)o = u[i], r = b(o, c), s = a(e(">table>thead", this.lockedHeader), this.thead, ">tr:eq(" + r.row + ")>th:not(.k-group-cell):not(.k-hierarchy-cell)").eq(r.cell), f(o) && (h(o, n), s[0].style.display = n ? "" : "none"), s.filter("[" + dt.attr("colspan") + "]").length && (l = parseInt(s.attr(dt.attr("colspan")), 10), s[0].colSpan = l - D(o.columns) || 1)
            },
            showColumn: function (n) {
                var i, o, r, s, l, c, d, u, p, g, m, v = this, _ = v.columns, w = v.footer || v.wrapper.find(".k-grid-footer"), y = v.lockedHeader ? N(v.lockedHeader.find(">table>thead")).length : 0;
                if (n = "number" == typeof n ? _[n] : vt(n) ? yt(T(_), function (e) {
                        return e === n
                    })[0] : yt(T(_), function (e) {
                        return e.field === n
                    })[0], n && !f(n)) {
                    ...
                    v._updateFirstColumnClass(), v.trigger(Gt, {column: n})
                }
            },
            ...
            refresh: function (t) {
                var n, i = this, o = i.dataSource.view(), r = i.options.navigatable, a = e(i.current()), s = !1, l = (i.dataSource.group() || []).length, c = i.content && i.content.scrollLeft(), d = l + F(p(i.columns)).length;
            ...
            _restoreCurrent: function (n, i) {
                var o, r, a;
                n === t || 0 > n || (this._removeCurrent(), i ? this.current(this.thead.find("th:not(.k-group-cell)").eq(n)) : (o = 0, this._rowVirtualIndex ? o = this.virtualScrollable.position(this._rowVirtualIndex) : n = 0, r = e(), this.lockedTable && (r = this.lockedTable.find(">tbody>tr").eq(o)), r = r.add(this.tbody.children().eq(o)), a = r.find(">td:not(.k-group-cell):not(.k-hierarchy-cell)").eq(n), this.current(a)), this._current && rt(this._current.closest("table")[0], !0))
            },
            ...
            _cleanupDetailItems: function () {
                ...
                e._hasDetails() && (e.angular("cleanup", function () {
                    return {elements: e.tbody.children(".k-detail-row")}
            ...
            _renderContent: function (e, t, n) {
                var i, o, r = this, a = "", s = null != r.lockedContent, l = {
                    rowTemplate: r.rowTemplate,
                    altRowTemplate: r.altRowTemplate,
                    groupFooterTemplate: r.groupFooterTemplate
                };
                if (t = s ? t - F(R(r.columns)).length : t, n > 0)for (t = s ? t - n : t, r.detailTemplate && t++, r.groupFooterTemplate && (r._groupAggregatesDefaultObject = r.dataSource.aggregates()), i = 0, o = e.length; o > i; i++)a += r._groupRowHtml(e[i], t, 0, s ? ct : lt, l, s); else a += r._rowsHtml(e, l);
            ...
            _renderLockedContent: function (e, t, n) {
                ...
                if (this.lockedContent) {
                    if (r = this.lockedTable, n > 0)for (t -= p(O(z(this.columns))).length, i = 0, o = e.length; o > i; i++)a += this._groupRowHtml(e[i], t, 0, lt, s); else a = this._rowsHtml(e, s);
                    U(r.children("tbody"), r, a, this.options.$angular), this._syncLockedContentHeight()
                }
            },
            _adjustRowsHeight: function (e, t) {
                var n, i, o, r, a = e[0].rows, s = a.length, l = t[0].rows, c = e.add(t), d = c.length, h = [];
        ...
        dt.ExcelMixin && dt.ExcelMixin.extend(Sn.prototype), dt.PDFMixin && (dt.PDFMixin.extend(Sn.prototype), Sn.prototype._drawPDF = function (n) {
            ...
            function o() {
                l._drawPDFShadow({width: l.wrapper.width()}).done(function (e) {
                    var t = c.page(), o = d ? c.totalPages() : 1, a = {
                        page: e,
                        pageNumber: t,
                        progress: t / o,
                        totalPages: o
            ...
            var r, a, s = new e.Deferred, l = this, c = l.dataSource, d = l.options.pdf.allPages;
            return this._initPDFProgress(n), r = new dt.drawing.Group, a = c.page(), d ? (c.bind("change", o), c.page(1)) : o(), s.promise()
