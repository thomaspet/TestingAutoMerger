...
!function (e, define) {
    ...
    return function (e) {
        kendo.ui.FilterCell && (kendo.ui.FilterCell.prototype.options.operators = e.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
            ...
            enums: {eq: "Er lik med", neq: "Er ikke lik med"}
            ...
            frequencies: {daily: "Daglig", monthly: "Månedlig", never: "Aldri", weekly: "Ukentlig", yearly: "Årlig"},
            monthly: {day: "Dag", interval: "måned(er)", repeatEvery: "Gjenta hver:", repeatOn: "Gjenta på:"},
            offsetPositions: {first: "første", fourth: "fjerde", last: "siste", second: "andre", third: "tredje"},
            weekly: {repeatEvery: "Gjenta hver:", repeatOn: "Gjenta på:", interval: "uke(r)"},
            yearly: {of: "av", repeatEvery: "Gjenta hver:", repeatOn: "Gjenta på:", interval: "år"},
            weekdays: {day: "dag", weekday: "ukedag", weekend: "helgedag"}
        ...
        })), kendo.ui.Groupable && (kendo.ui.Groupable.prototype.options.messages = e.extend(!0, kendo.ui.Groupable.prototype.options.messages, {empty: "Dra en kolonne hit for å sortere på den kolonnen"})), kendo.ui.Pager && (kendo.ui.Pager.prototype.options.messages = e.extend(!0, kendo.ui.Pager.prototype.options.messages, {
            ...
            allDay: "hele dagen",
            cancel: "Avbryt",
            editable: {confirmation: "Er du sikker på at du vil slette denne oppgaven?"},
            date: "Dato",
            destroy: "Slett",
            editor: {
            ...
            time: "Tid",
            today: "I dag",
            views: {agenda: "Agenda", day: "Dag", month: "Måned", week: "Uke", workWeek: "Arbeidsuke"},
