...
!function (e, define) {
    ...
    return function (e) {
        kendo.ui.Validator && (kendo.ui.Validator.prototype.options.messages = e.extend(!0, kendo.ui.Validator.prototype.options.messages, {
            ...
            save: "שמור",
            views: {day: "יום", end: "סוף", month: "חודש", start: "התחלה", week: "שבוע", year: "שנה"}
            ...
            frequencies: {daily: "יומי", monthly: "חודשי", never: "אף פעם", weekly: "שבועי", yearly: "שנתי"},
            monthly: {day: "יום ", interval: " מחזוריות", repeatEvery: "חזרה כל: ", repeatOn: "חזור ב: "},
            offsetPositions: {first: "ראשון", fourth: "רביעי", last: "אחרון", second: "שני", third: "שלישי"},
            weekly: {repeatEvery: "חזור כל: ", repeatOn: "חזור ב: ", interval: "מחזוריות"},
            yearly: {of: " ב ", repeatEvery: "חזור כל: ", repeatOn: "חזור ב: ", interval: "מחזוריות"},
            weekdays: {day: "יום", weekday: "בשבוע", weekend: "בסוף שבוע"}
            ...
            clear: "נקה",
            filter: "סנן"
        })), kendo.ui.Groupable && (kendo.ui.Groupable.prototype.options.messages = e.extend(!0, kendo.ui.Groupable.prototype.options.messages, {empty: "כדי לקבץ לפי העמודה גרור כותרת העמודה לכאן"})), kendo.ui.Editor && (kendo.ui.Editor.prototype.options.messages = e.extend(!0, kendo.ui.Editor.prototype.options.messages, {
            bold: "מודגש",
            ...
            date: "תאריך",
            destroy: "מחק",
            editable: {confirmation: "האם הנך בטוח כי ברצונך למחוק אירוע זה ?"},
            editor: {
            ...
            time: "שעה",
            today: "היום",
            views: {agenda: "סדר יום", day: "יום", month: "חודש", week: "שבוע", workWeek: "שבוע עבודה"},
