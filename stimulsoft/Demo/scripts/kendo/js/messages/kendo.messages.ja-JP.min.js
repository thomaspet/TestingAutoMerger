...
!function (e, define) {
    ...
    return kendo.ui.FlatColorPicker && (kendo.ui.FlatColorPicker.prototype.options.messages = $.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, {
        apply: "適用",
        cancel: "キャンセル"
        ...
        clear: "クリア",
        operator: "演算子"
    })), kendo.ui.FilterCell && (kendo.ui.FilterCell.prototype.options.operators = $.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
        string: {
            eq: "が次の値と同じ",
            neq: "が次の値と異なる",
            startswith: "が次で始まる",
        ...
        number: {eq: "が次の値と同じ", neq: "が次の値と異なる", gte: "が次の値以上", gt: "が次の値より大きい", lte: "が次の値以下", lt: "が次の値より小さい"},
        date: {eq: "が次の値と同じ", neq: "が次の値と異なる", gte: "次の値と同じかそれより後", gt: "次の値より後", lte: "次の値と同じかそれより前", lt: "次の値より前"},
        enums: {eq: "が次の値と同じ", neq: "が次の値と異なる"}
        ...
        save: "保存",
        views: {day: "日", end: "終点", month: "月", start: "始点", week: "週", year: "年"}
        ...
        commands: {
            ...
            select: "選択",
            update: "更新"
        }, editable: {cancelDelete: "キャンセル", confirmation: "このレコードを本当に削除しますか?", confirmDelete: "削除"}
    })), kendo.ui.Groupable && (kendo.ui.Groupable.prototype.options.messages = $.extend(!0, kendo.ui.Groupable.prototype.options.messages, {empty: "列ヘッダーをここにドラッグ アンド ドロップして、その列でグループ化"})), kendo.ui.NumericTextBox && (kendo.ui.NumericTextBox.prototype.options = $.extend(!0, kendo.ui.NumericTextBox.prototype.options, {
        upArrowText: "値を増やす",
        downArrowText: "値を減らす"
        ...
        hourly: {repeatEvery: "次の間隔で繰り返す: ", interval: " 時間"},
        daily: {repeatEvery: "次の間隔で繰り返す: ", interval: " 日"},
        weekly: {interval: " 週間", repeatEvery: "次の間隔で繰り返す: ", repeatOn: "次のときに繰り返す: "},
        monthly: {repeatEvery: "次の間隔で繰り返す: ", repeatOn: "次のときに繰り返す: ", interval: " か月", day: "日 "},
        yearly: {repeatEvery: "次の間隔で繰り返す: ", repeatOn: "次のときに繰り返す: ", interval: " 年", of: " の "},
        end: {label: "終了:", mobileLabel: "終了", never: "なし", after: "後 ", occurrence: " 回", on: "オン "},
        offsetPositions: {first: "最初", second: "2 番目", third: "3 番目", fourth: "4 番目", last: "最後"},
        weekdays: {day: "日", weekday: "平日", weekend: "週末"}
        ...
        views: {day: "日", week: "週", workWeek: "稼働日", agenda: "予定", month: "月"},
        recurrenceMessages: {
