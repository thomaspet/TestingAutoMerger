...
!function (e, define) {
    ...
    return function (e) {
        kendo.ui.FilterCell && (kendo.ui.FilterCell.prototype.options.operators = e.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
            ...
            enums: {eq: "Är lika med", neq: "Är inte lika med"}
            ...
            frequencies: {daily: "Daily", monthly: "Monthly", never: "Never", weekly: "Weekly", yearly: "Yearly"},
            monthly: {day: "Day", interval: "month(s)", repeatEvery: "Repeat every:", repeatOn: "Repeat on:"},
            offsetPositions: {first: "first", fourth: "fourth", last: "last", second: "second", third: "third"},
            weekly: {repeatEvery: "Repeat every:", repeatOn: "Repeat on:", interval: "week(s)"},
            yearly: {of: "of", repeatEvery: "Repeat every:", repeatOn: "Repeat on:", interval: "year(s)"},
        ...
        })), kendo.ui.Groupable && (kendo.ui.Groupable.prototype.options.messages = e.extend(!0, kendo.ui.Groupable.prototype.options.messages, {empty: "Dra en kolumnrubrik hit för att sortera på den kolumnen"})), kendo.ui.Pager && (kendo.ui.Pager.prototype.options.messages = e.extend(!0, kendo.ui.Pager.prototype.options.messages, {
            ...
            time: "Time",
            today: "Today",
            views: {agenda: "Agenda", day: "Day", month: "Month", week: "Week", workWeek: "Work Week"},
