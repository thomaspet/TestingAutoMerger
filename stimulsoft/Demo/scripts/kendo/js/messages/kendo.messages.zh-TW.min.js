...
!function (e, define) {
    ...
    return function (e) {
        kendo.ui.FlatColorPicker && (kendo.ui.FlatColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, {
            ...
            number: {eq: "等於", neq: "不等於", gte: "大於等於", gt: "大於", lte: "小於等於", lt: "小於"},
            date: {eq: "等於", neq: "不等於", gte: "大於等於", gt: "大於", lte: "小於等於", lt: "小於"},
            enums: {eq: "等於", neq: "不等於"}
            ...
            views: {
                ...
                week: "周",
                month: "月"
            }, actions: {append: "添加任務", addChild: "添加子任務", insertBefore: "添加到前面", insertAfter: "添加到後面"}
            ...
            commands: {
                ...
                select: "選擇",
                update: "更新"
            }, editable: {cancelDelete: "取消", confirmation: "確定要刪除嗎？", confirmDelete: "刪除"}
        })), kendo.ui.Groupable && (kendo.ui.Groupable.prototype.options.messages = e.extend(!0, kendo.ui.Groupable.prototype.options.messages, {empty: "拖拽列標題到此處按列組合顯示"})), kendo.ui.NumericTextBox && (kendo.ui.NumericTextBox.prototype.options = e.extend(!0, kendo.ui.NumericTextBox.prototype.options, {
            upArrowText: "增加",
            downArrowText: "減少"
            ...
            hourly: {repeatEvery: "重復周期: ", interval: " 小時"},
            daily: {repeatEvery: "重復周期: ", interval: " 天"},
            weekly: {interval: " 周", repeatEvery: "重復周期: ", repeatOn: "重復於:"},
            monthly: {repeatEvery: "重復周期: ", repeatOn: "重復於:", interval: " 月", day: "日期"},
            yearly: {repeatEvery: "重復周期: ", repeatOn: "重復於: ", interval: " 年", of: " 月份: "},
            end: {label: "截止時間:", mobileLabel: "截止時間", never: "從不", after: "重復 ", occurrence: " 次後", on: "止於 "},
            offsetPositions: {first: "第一", second: "第二", third: "第三", fourth: "第四", last: "最後"},
