...
!function (e, define) {
    ...
    return function (e, t) {
        ...
        function i(e) {
            var t = e[0];
            return t.files ? o(t.files) : [{name: s(t.value), extension: a(t.value), size: null}]
        }
        ...
        function r(e) {
            ...
            return {name: y.htmlEncode(t), extension: a(t), size: e.size || e.fileSize, rawFile: e}
        }
        ...
        function d(n, i, o) {
            var r, a;
            return i._supportsRemove() ? (r = n.data("fileNames"), a = e.map(r, function (e) {
                return e.name
            }), i._submitRemove(a, o, function (e, t, o) {
                i._removeFileEntry(n), i.trigger(A, {operation: "remove", files: r, response: e, XMLHttpRequest: o})
            }, function (e) {
                c(i) && i._removeFileEntry(n), i.trigger(D, {
                    operation: "remove",
                    files: r,
                    XMLHttpRequest: e
                }), x("Server response: " + e.responseText)
        ...
        function f(e, t, n, i) {
            ...
            e.on("dragenter" + t, function () {
                n(), r = new Date, o || (o = setInterval(function () {
                    var e = new Date - r;
                    e > 100 && (i(), clearInterval(o), o = null)
                }, 100))
        ...
        var v, _, y = window.kendo, w = y.ui.Widget, b = y.antiForgeryTokens, x = y.logToConsole, k = /\.([^\.]+)$/, C = ".kendoUpload", S = "select", T = "upload", A = "success", D = "error", M = "complete", E = "cancel", P = "progress", I = "remove", z = w.extend({
            ...
            options: {
                ...
                template: "",
                files: [],
                async: {removeVerb: "POST", autoUpload: !0, withCredentials: !0},
                localization: {
                    select: "Select files...",
                    cancel: "Cancel",
                    retry: "Retry",
            ...
            _onInputKeyDown: function (e) {
                var t = this, n = t.wrapper.find(".k-upload-action:first");
                e.keyCode === y.keys.TAB && n.length > 0 && (e.preventDefault(), n.focus())
            },
            _onInputChange: function (t) {
                var n = this, i = e(t.target), o = l(n._inputFiles(i), n._isAsyncNonBatch()), r = n.trigger(S, {files: o});
                r ? (n._addInput(i), i.remove()) : n._module.onSelect({target: i}, o)
            },
            _onDrop: function (t) {
                var n, i = t.originalEvent.dataTransfer, r = this, a = i.files, s = l(o(a), r._isAsyncNonBatch());
                p(t), a.length > 0 && (!r.multiple && s.length > 1 && s.splice(1, s.length - 1), n = r.trigger(S, {files: s}), n || r._module.onSelect({target: e(".k-dropzone", r.wrapper)}, s))
            },
            ...
            _renderInitialFiles: function (t) {
                var n, i, o = this, r = 0;
                for (t = l(t, !0), r = 0; t.length > r; r++)n = t[r], i = o._enqueueFile(n.name, {fileNames: [n]}), i.addClass("k-file-success").data("files", [t[r]]), e(".k-progress", i).width("100%"), o.options.template || e(".k-upload-status", i).prepend("<span class='k-upload-pct'>100%</span>"), o._supportsRemove() && o._fileAction(i, I)
            },
            _prepareTemplateData: function (e, t) {
                var n = t.fileNames, i = {}, o = 0, r = 0;
                for (r = 0; n.length > r; r++)o += n[r].size;
                return i.name = e, i.size = o, i.files = t.fileNames, i
            },
            _prepareDefaultFileEntryTemplate: function (t, n) {
                var i = "", o = e("<li class='k-file'><span class='k-progress'></span><span class='k-icon'></span><span class='k-filename' title='" + t + "'>" + t + "</span><strong class='k-upload-status'></strong></li>");
                return 1 == n.fileNames.length && n.fileNames[0].extension && (i = n.fileNames[0].extension.substring(1), e(".k-icon", o).addClass("k-i-" + i)), o
            },
            _enqueueFile: function (t, n) {
                var i, o, r, a, s = this, l = n.fileNames[0].uid, c = e(".k-upload-files", s.wrapper), d = s.options, u = d.template;
                return 0 === c.length && (c = e("<ul class='k-upload-files k-reset'></ul>").appendTo(s.wrapper), s.options.showFileList || c.hide(), s.wrapper.removeClass("k-upload-empty")), i = e(".k-file", c), u ? (r = s._prepareTemplateData(t, n), u = y.template(u), o = e("<li class='k-file'>" + u(r) + "</li>"), o.find(".k-upload-action").addClass("k-button k-button-bare"), s.angular("compile", function () {
                    return {elements: o, data: [r]}
                })) : o = s._prepareDefaultFileEntryTemplate(t, n), o.attr(y.attr("uid"), l).appendTo(c).data(n), s._async || e(".k-progress", o).width("100%"), !s.multiple && i.length > 0 && (a = {files: i.data("fileNames")}, s.trigger(I, a) || s._module.onRemove({target: e(i, s.wrapper)}, a.data)), o
            },
            _removeFileEntry: function (t) {
                var n, i, o = this, r = t.closest(".k-upload-files");
                t.remove(), n = e(".k-file", r), i = e(".k-file-success, .k-file-error", r), i.length === n.length && this._hideUploadButton(), 0 === n.length && (r.remove(), o.wrapper.addClass("k-upload-empty"), o._hideHeaderUploadstatus())
            },
            _fileAction: function (e, t) {
                var n = {remove: "k-delete", cancel: "k-cancel", retry: "k-retry"}, i = {
                    remove: "k-i-close",
                    cancel: "k-i-close",
                    retry: "k-i-refresh"
                };
            ...
            _fileState: function (t, n) {
                var i = this.localization, o = {
                    uploading: {text: i.statusUploading},
                    uploaded: {text: i.statusUploaded},
                    failed: {text: i.statusFailed}
                }, r = o[n];
            ...
            _onUploadSuccess: function (e, t, n) {
                var i = m(e);
                this._fileState(i, "uploaded"), i.removeClass("k-file-progress").addClass("k-file-success"), this._updateHeaderUploadStatus(), this.trigger(A, {
            ...
            _showHeaderUploadStatus: function () {
                var t = this.localization, n = e(".k-dropzone", this.wrapper), i = e(".k-upload-status-total", this.wrapper);
            ...
            _updateHeaderUploadStatus: function () {
                var t, n, i, o = this, r = o.localization, a = e(".k-file", o.wrapper).not(".k-file-success, .k-file-error");
                0 === a.length && (t = e(".k-file.k-file-error", o.wrapper), n = e(".k-upload-status-total", o.wrapper), i = e(".k-icon", n).removeClass("k-loading").addClass(0 !== t.length ? "k-warning" : "k-i-tick").text(0 !== t.length ? r.statusWarning : r.statusUploaded), n.text(o.localization.headerStatusUploaded).append(i))
            },
            _hideHeaderUploadstatus: function () {
                e(".k-upload-status-total", this.wrapper).remove()
            },
            _onParentFormSubmit: function () {
                var n, i = this, o = i.element;
                t !== this._module.onAbort && this._module.onAbort(), o.value || (n = e(o), n.attr("disabled", "disabled"), window.setTimeout(function () {
            ...
            _supportsMultiple: function () {
                ...
                return !(y.support.browser.opera || y.support.browser.safari && e)
            },
            ...
            _submitRemove: function (t, n, i, o) {
                var r = this, a = r.options.async.removeField || "fileNames", s = e.extend(n, b());
                s[a] = t, jQuery.ajax({
            ...
            _checkAllComplete: function () {
                0 === e(".k-file.k-file-progress", this.wrapper).length && this.trigger(M)
            },
        ...
        B.prototype = {
            onSelect: function (t, i) {
                var o, r = this.upload, a = e(t.target);
                r._addInput(a), o = r._enqueueFile(n(a), {relatedInput: a, fileNames: i}), r._fileAction(o, I)
            }, onRemove: function (e) {
                var t = m(e);
            ...
            onSelect: function (t, n) {
                var i = this.upload, o = e(t.target), r = this.prepareUpload(o, n);
                i.options.async.autoUpload ? this.performUpload(r) : (i._supportsRemove() && this.upload._fileAction(r, I), i._showUploadButton())
            }, prepareUpload: function (t, i) {
                var o, r, a, s = this.upload, l = e(s.element), c = s.options.async.saveField || t.attr("name");
                return s._addInput(t), t.attr("name", c), o = this.createFrame(s.name + "_" + z._frameId++), this.registerFrame(o), r = this.createForm(s.options.async.saveUrl, o.attr("name")).append(l), a = s._enqueueFile(n(t), {
                    frame: o,
                    relatedInput: l,
                    fileNames: i
                }), o.data({form: r, file: a}), a
            }, performUpload: function (t) {
                var n, i, o, r = {files: t.data("fileNames")}, a = t.data("frame"), s = this.upload;
                if (s.trigger(T, r))s._removeFileEntry(a.data("file")), this.cleanupFrame(a), this.unregisterFrame(a); else {
                    s._hideUploadButton(), s._showHeaderUploadStatus(), a.appendTo(document.body), n = a.data("form").attr("action", s.options.async.saveUrl).appendTo(document.body), r.data = e.extend({}, r.data, b());
                    for (i in r.data)o = n.find("input[name='" + i + "']"), 0 === o.length && (o = e("<input>", {
                        type: "hidden",
                        name: i
                    }).prependTo(n)), o.val(r.data[i]);
                    s._fileAction(t, E), s._fileState(t, "uploading"), e(t).removeClass("k-file-error").addClass("k-file-progress"), a.one("load", e.proxy(this.onIframeLoad, this)), n[0].submit()
                }
                ...
                try {
                    ...
                    n = "Error trying to get server response: " + o
                }
                this.processResponse(i, n)
            }, processResponse: function (t, n) {
                var i = t.data("file"), o = this, r = {responseText: n};
                u(n, function (n) {
                    e.extend(r, {
                        statusText: "OK",
                        status: "200"
                    }), o.upload._onFileProgress({target: e(i, o.upload.wrapper)}, 100), o.upload._onUploadSuccess({target: e(i, o.upload.wrapper)}, n, r), o.cleanupFrame(t), o.unregisterFrame(t)
                }, function () {
                    e.extend(r, {
                        statusText: "error",
                        status: "500"
                    }), o.upload._onUploadError({target: e(i, o.upload.wrapper)}, r)
                })
            }, onCancel: function (t) {
            ...
            onSelect: function (t, n) {
                var i = this.upload, o = this, r = e(t.target), a = this.prepareUpload(r, n);
                e.each(a, function () {
                ...
                var n, i, o, r, a = this.upload, s = t.length, l = [];
                if (a.options.async.batch === !0)n = e.map(t, function (e) {
                    return e.name
                }).join(", "), r = a._enqueueFile(n, {fileNames: t}), r.data("files", t), l.push(r); else for (i = 0; s > i; i++)o = t[i], n = o.name, r = a._enqueueFile(n, {fileNames: [o]}), r.data("files", [o]), l.push(r);
                return l
            }, performUpload: function (t) {
                var n, i = this.upload, o = this.createFormData(), r = this.createXHR(), a = {
                    files: t.data("fileNames"),
                    XMLHttpRequest: r
                };
                if (i.trigger(T, a))this.removeFileEntry(t); else {
                    if (i._fileAction(t, E), i._hideUploadButton(), i._showHeaderUploadStatus(), a.formData)o = a.formData; else {
                        a.data = e.extend({}, a.data, b());
                        for (n in a.data)o.append(n, a.data[n]);
                        this.populateFormData(o, t.data("files"))
                    }
                    i._fileState(t, "uploading"), e(t).removeClass("k-file-error").addClass("k-file-progress"), this.postFormData(i.options.async.saveUrl, o, t, r)
                }
            }, onSaveSelected: function () {
                var t = this;
                e(".k-file", this.element).each(function () {
                ...
                n.data("request", i), i.addEventListener("load", function (e) {
                    o.onRequestSuccess.call(o, e, n)
                }, !1), i.addEventListener(D, function (e) {
                    o.onRequestError.call(o, e, n)
                }, !1), i.upload.addEventListener("progress", function (e) {
                    o.onRequestProgress.call(o, e, n)
                }, !1), i.open("POST", e, !0), i.withCredentials = this.upload.options.async.withCredentials, i.send(t)
            }, createFormData: function () {
                return new FormData
            }, populateFormData: function (e, t) {
                var n, i = this.upload, o = t.length;
                for (n = 0; o > n; n++)e.append(i.options.async.saveField || i.name, t[n].rawFile);
                return e
            }, onRequestSuccess: function (t, n) {
                function i() {
                    r.upload._onUploadError({target: e(n, r.upload.wrapper)}, o)
                }

                var o = t.target, r = this;
                o.status >= 200 && 299 >= o.status ? u(o.responseText, function (t) {
                    r.upload._onFileProgress({target: e(n, r.upload.wrapper)}, 100), r.upload._onUploadSuccess({target: e(n, r.upload.wrapper)}, t, o), r.cleanupFileEntry(n)
                }, i) : i()
            }, onRequestError: function (t, n) {
                var i = t.target;
                this.upload._onUploadError({target: e(n, this.upload.wrapper)}, i)
                ...
                this.upload._onFileProgress({target: e(n, this.upload.wrapper)}, i)
