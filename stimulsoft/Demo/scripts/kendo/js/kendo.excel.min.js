 ...
 */
!function (e, define) {
    define(["./kendo.core.min", "./kendo.data.min", "./kendo.ooxml.min"], e)
}(function () {
    return function (e, t) {
        t.ExcelExporter = t.Class.extend({
            init: function (n) {
                ...
                })), o = i.data(), o.length > 0 && (this.dataSource._data = o, r = this.dataSource.transport, i._isServerGrouped() && r.options.data && (r.options.data = null))) : this.dataSource = t.data.DataSource.create(i)
                ...
                return this._hierarchical() && (u[0].colSpan = i - n + 1), [{type: "data", cells: o.concat(u)}]
            }, _dataRows: function (e, t) {
                var n, i = this._depth(), o = [];
                for (n = 0; e.length > n; n++)o.push.apply(o, this._dataRow(e[n], t, i));
                return o
            }, _footer: function (t) {
                var n = [], i = !1, o = e.map(this.columns, e.proxy(function (n) {
                ...
                return i && n.push({
                    type: "group-footer", cells: e.map(Array(this.dataSource.group().length), function () {
                        return {background: "#dfdfdf", color: "#333"}
                    }).concat(o)
                }), n
                ...
                return this._hierarchical() && (i[0].colSpan = this._depth() + 1), {
                    ...
                    cells: e.map(Array(n.length), function () {
                        return {background: "#7a7a7a", color: "#fff"}
                    }).concat(i)
                }
            }, _prependHeaderRows: function (e) {
                var t, n = this.dataSource.group(), i = [{rowSpan: 1, cells: [], index: 0}];
                ...
                var o, r, s, a = i || e[e.length - 1], l = e[a.index + 1], c = 0;
                ...
                var t, n, i = this.dataSource.group(), o = this._dataRows(this.dataSource.view(), 0);
                return this.columns.length && (this._prependHeaderRows(o), t = !1, n = e.map(this.columns, e.proxy(function (n) {
                    ...
                    type: "footer", cells: e.map(Array(i.length), function () {
                        return {background: "#dfdfdf", color: "#333"}
                    }).concat(n)
                })), o
                ...
                var t = this._visibleColumns(this.options.columns || []), n = this._visibleColumns(this._trimColumns(this._leafColumns(e.grep(t, function (e) {
                    return e.locked
                })))).length;
                return {rowSplit: this._headerDepth(t), colSplit: n ? n + this.dataSource.group().length : 0}
            }, _cell: function (e, t) {
                return {value: t.value(e)}
            }, _hierarchical: function () {
                return this.options.hierarchy && this.dataSource.level
            }, _depth: function () {
                var e, t, n, i = this.dataSource, o = 0;
                ...
                var t = this._depth(), n = e.map(Array(t), function () {
                    return {width: 20}
                });
                return n.concat(e.map(this.columns, function (e) {
                    return {width: parseInt(e.width, 10), autoWidth: e.width ? !1 : !0}
                }))
            }
        }), t.ExcelMixin = {
            extend: function (t) {
            ...
            options: {proxyURL: "", allPages: !1, filterable: !1, fileName: "Export.xlsx"},
            saveAsExcel: function () {
                var n = this.options.excel || {}, i = new t.ExcelExporter({
                ...
                i.workbook().then(e.proxy(function (e, i) {
                    if (!this.trigger("excelExport", {workbook: e, data: i})) {
